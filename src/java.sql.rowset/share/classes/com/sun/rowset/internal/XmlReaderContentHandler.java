...
public class XmlReaderContentHandler extends DefaultHandler {
    ...
    private final Vector<Object[]> updates;
    ...
    private final WebRowSetImpl rs;
     ...
     */
    private final String [] properties = {"command", "concurrency", "datasource",
     ...
     */
    private final String [] colDef = {"column-count", "column-definition", "column-index",
    ...
    private final String [] data = {"currentRow", "columnValue", "insertRow", "deleteRow", "insdel", "updateRow", "null" , "emptyString"};
    ...
    public void warning (SAXParseException err) throws SAXParseException {
        System.out.println (MessageFormat.format(resBundle.handleGetObject("xmlrch.warning").toString(), err.getMessage(), err.getLineNumber(), err.getSystemId()));
    }
