...
public class WebRowSetXmlReader implements XmlReader, Serializable {
    ...
    public void readXML(WebRowSet caller, java.io.Reader reader) throws SQLException {
        try {
            ...
            System.out.println (MessageFormat.format(resBundle.handleGetObject("wrsxmlreader.parseerr").toString(), err.getMessage (), err.getLineNumber(), err.getSystemId()));
            err.printStackTrace();
    ...
    public void readXML(WebRowSet caller, java.io.InputStream iStream) throws SQLException {
        try {
            ...
            System.out.println (MessageFormat.format(resBundle.handleGetObject("wrsxmlreader.parseerr").toString(), err.getLineNumber(), err.getSystemId()));
