...
public class CachedRowSetImpl extends BaseRowSet implements RowSet, RowSetInternal, Serializable, Cloneable, CachedRowSet {
     ...
     */
    private final String strMatchColumn ="";

    /**
     * Used to track match column for JoinRowSet consumption
     */
    private final int iMatchColumn = -1;
     ...
     */
    private final String DEFAULT_SYNC_PROVIDER = "com.sun.rowset.providers.RIOptimisticProvider";
    ...
    private void initProperties() throws SQLException {
        ...
        setReadOnly((rvh.size() <= 0) || (isReadOnly()));
    ...
    public void insertRow() throws SQLException {
        ...
        if (!onInsertRow ||
                !insertRow.isCompleteRow(RowSetMD)) {
    ...
    private String buildTableName(String command) throws SQLException {
        ...
        if(command.toLowerCase().startsWith("select")) {
            ...
            if(indexComma == -1) {
                ...
                strTablename = (command.substring(indexFrom+"from".length())).trim();
