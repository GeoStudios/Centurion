...
public class XMBeanAttributes extends XTable {
    ...
    private final WeakHashMap<XMBean, HashMap<String, ZoomedCell>> viewersCache =
    ...
    private final TableCellEditor valueCellEditor = new ValueCellEditor();
    private int rowMinHeight = -1;
    private final AttributesMouseListener mouseListener = new AttributesMouseListener();
    ...
    public synchronized TableCellRenderer getCellRenderer(int row,
        ...
        if (row >= getRowCount()) {
            ...
            if (column == VALUE_COLUMN) {
                ...
                if (obj instanceof ZoomedCell cell) {
                    if (cell.isInited()) {
        ...
        public Component getTableCellEditorComponent(JTable table,
            ...
            if(column == VALUE_COLUMN) {
                Object obj = getModel().getValueAt(row,
                                                   column);
                if(obj instanceof ZoomedCell cell) {
                    if(cell.getRenderer() instanceof MaximizedCellRenderer zr) {
