...
public class XMBeanNotifications extends JTable implements NotificationListener {
    ...
    private final HashMap<ObjectName, XMBeanNotificationsListener> listeners =
    ...
    private final List<NotificationListener> notificationListenersList;
    private volatile boolean enabled;
    private Font normalFont,  boldFont;
    private int rowMinHeight = -1;
    private final TableCellEditor userDataEditor = new UserDataCellEditor();
    private final NotifMouseListener mouseListener = new NotifMouseListener();
    private final SimpleDateFormat timeFormater = new SimpleDateFormat("HH:mm:ss:SSS");
    private static final TableCellEditor editor =
    ...
    synchronized void updateUserDataCell(int row, int col) {
        ...
        if (obj instanceof UserDataCell cell) {
            if (!cell.isInited()) {
                if (rowMinHeight == -1) {
    ...
    class UserDataCellEditor extends XTextFieldEditor {
        ...
        public Component getTableCellEditorComponent(
            ...
            if (column == 2) {
                Object obj = getModel().getValueAt(row, column);
                if (obj instanceof UserDataCell cell) {
                    if (cell.getRenderer() instanceof UserDataCellRenderer zr) {
    ...
    class XMBeanNotificationsListener implements NotificationListener {
        ...
        private final XMBean xmbean;
        private DefaultMutableTreeNode node;
        private volatile long received;
        private final XMBeanNotifications notifications;
