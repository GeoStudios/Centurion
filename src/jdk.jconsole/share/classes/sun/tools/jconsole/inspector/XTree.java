...
public class XTree extends JTree {
    ...
    private synchronized void addChildNode(
        ...
        if (child instanceof ComparableDefaultMutableTreeNode comparableChild) {
    ...
    //
    private final boolean keyValueView = Boolean.getBoolean("keyValueView");
    ...
    private static class Dn implements Comparable<Dn> {
        ...
        private final String keyPropertyList;
