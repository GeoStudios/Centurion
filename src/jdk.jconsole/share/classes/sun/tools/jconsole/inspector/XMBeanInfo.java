...
public class XMBeanInfo extends JPanel {
    ...
    private final JTable descTable = new JTable();
    private final JPanel infoBorderPanel = new JPanel(new BorderLayout());
    private final JPanel descBorderPanel = new JPanel(new BorderLayout());
    ...
    private static class TableRowDivider {
        ...
        private final String tableRowDividerText;
    ...
    private static final MBeanInfoTableCellRenderer renderer =
