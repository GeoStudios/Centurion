...
public class VMPanel extends JTabbedPane implements PropertyChangeListener {
    ...
    private static final ArrayList<TabInfo> tabInfos = new ArrayList<TabInfo>();
