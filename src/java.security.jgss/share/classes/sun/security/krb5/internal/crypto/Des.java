...
public final class Des {
    ...
    public static byte[] set_parity(byte[] key) {
        for (int i=0; i < 8; i++) {
    ...
    public static long set_parity(long key) {
        return octet2long(set_parity(long2octet(key)));
    }

    public static boolean bad_key(long key) {
    ...
    public static boolean bad_key(byte[] key) {
