...
public class ASReq extends KDCReq {
    ...
    public ASReq(byte[] data) throws KrbException, IOException {
        init(new DerValue(data));
    }

    public ASReq(DerValue encoding) throws KrbException, IOException {
        init(encoding);
    }

    private void init(DerValue encoding) throws IOException, KrbException {
