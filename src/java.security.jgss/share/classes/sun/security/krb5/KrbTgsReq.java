...
public class KrbTgsReq {
    ...
    private final PrincipalName princName;
    private final PrincipalName clientAlias;
    private final PrincipalName servName;
    private final PrincipalName serverAlias;
    private final TGSReq tgsReqMessg;
    private final KerberosTime ctime;
