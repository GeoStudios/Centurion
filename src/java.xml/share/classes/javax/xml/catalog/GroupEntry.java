        ...
        for (BaseEntry entry : entries) {
            switch (entry.type) {
                case SYSTEM:
                    ...
                    break;
                case REWRITESYSTEM:
                    match = entry.match(systemId, longestRewriteMatch);
                    if (match != null) {
                        rewriteMatch = match;
                    ...
                    break;
                case SYSTEMSUFFIX:
                    match = entry.match(systemId, longestSuffixMatch);
                    if (match != null) {
                        suffixMatch = match;
        ...
        for (BaseEntry entry : entries) {
            switch (entry.type) {
                case URI:
                    ...
                    break;
                case REWRITEURI:
                    match = entry.match(uri, longestRewriteMatch);
                    if (match != null) {
                        rewriteMatch = match;
                    ...
                    break;
                case URISUFFIX:
                    match = entry.match(uri, longestSuffixMatch);
                    if (match != null) {
                        suffixMatch = match;
