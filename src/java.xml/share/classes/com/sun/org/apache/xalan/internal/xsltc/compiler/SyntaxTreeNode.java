...
import java.xml.share.classes.com.sun.org.apache.bcel.internal.generic.DUP_X1;
...
public abstract class SyntaxTreeNode implements Constants {
    ...
    protected void translateContents(ClassGenerator classGen,
        ...
        for (int i = 0; i < n; i++) {
            if (_contents.get(i) instanceof VariableBase var) {
    ...
    private boolean isSimpleRTF(SyntaxTreeNode node) {
        ...
        return contents.stream().noneMatch((item) -> (!isTextElement(item, false)));
    }
