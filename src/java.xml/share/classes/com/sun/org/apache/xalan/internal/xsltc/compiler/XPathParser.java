...
public class XPathParser extends lr_parser {
    ...
    public RelativeLocationPath insertStep(Step step, RelativeLocationPath rlp) {
        if (rlp instanceof Step) {
            return new ParentLocationPath(step, rlp);
        } else if (rlp instanceof ParentLocationPath plp) {
...
class parser_actions {
    ...
    public final Symbol parser_do_action(
        ...
        switch (parser_act_num) {
            ...
            case 0: // $START ::= TopLevel EOF
            {
                ...
                parser_result = new Symbol(0, (parser_stack.get(parser_top - 1)).left,
                        (parser_stack.get(parser_top)).right, start_val);
            }
            /* ACCEPT */
            ...
            {
                Pattern pattern = (Pattern) (parser_stack.get(parser_top)).value;
                parser_result = new Symbol(1, (parser_stack.get(parser_top - 1)).left,
                        (parser_stack.get(parser_top)).right, pattern);
            }
            return parser_result;
            ...
            {
                Expression expr = (Expression) (parser_stack.get(parser_top)).value;
                parser_result = new Symbol(1, (parser_stack.get(parser_top - 1)).left,
                        (parser_stack.get(parser_top)).right, expr);
            }
            return parser_result;
            ...
            {
                Pattern lpp = (Pattern) (parser_stack.get(parser_top)).value;
                parser_result = new Symbol(28, (parser_stack.get(parser_top)).left,
                        (parser_stack.get(parser_top)).right, lpp);
            }
            return parser_result;
            ...
            case 5: // LocationPathPattern ::= SLASH
            {
                ...
                parser_result = new Symbol(29, (parser_stack.get(parser_top)).left,
                        (parser_stack.get(parser_top)).right, result);
            }
            return parser_result;
            ...
            {
                RelativePathPattern rpp = (RelativePathPattern) (parser_stack.get(parser_top)).value;
            ...
            {
                IdKeyPattern ikp = (IdKeyPattern) (parser_stack.get(parser_top)).value;
                parser_result = new Symbol(29, (parser_stack.get(parser_top)).left,
                        (parser_stack.get(parser_top)).right, ikp);
            }
            return parser_result;
            ...
            case 11: // LocationPathPattern ::= RelativePathPattern
            {
                RelativePathPattern rpp = (RelativePathPattern) (parser_stack.get(parser_top)).value;
                parser_result = new Symbol(29, (parser_stack.get(parser_top)).left,
                        (parser_stack.get(parser_top)).right, rpp);
            }
            return parser_result;
            ...
            {
                StepPattern sp = (StepPattern) (parser_stack.get(parser_top)).value;
                parser_result = new Symbol(31, (parser_stack.get(parser_top)).left,
                        (parser_stack.get(parser_top)).right, sp);
            }
            return parser_result;
            ...
            {
                Object nt = parser_stack.get(parser_top).value;
                StepPattern result = parser.createStepPattern(Axis.CHILD, nt, null);
                parser_result = new Symbol(32, (parser_stack.get(parser_top)).left,
                        (parser_stack.get(parser_top)).right, result);
            }
            return parser_result;
            ...
            case 19: // StepPattern ::= NodeTestPattern Predicates
            {
                ...
                List<Predicate> pp = (ArrayList<Predicate>) (parser_stack.get(parser_top)).value;
            ...
            {
                StepPattern pip = (StepPattern) (parser_stack.get(parser_top)).value;
                parser_result = new Symbol(32, (parser_stack.get(parser_top)).left,
                        (parser_stack.get(parser_top)).right, pip);
            }
            return parser_result;
            ...
            case 21: // StepPattern ::= ProcessingInstructionPattern Predicates
            {
                ...
                @SuppressWarnings("unchecked")
                List<Predicate> pp = (ArrayList<Predicate>) (parser_stack.get(parser_top)).value;
                StepPattern result = pip.setPredicates(pp);
                parser_result = new Symbol(32, (parser_stack.get(parser_top - 1)).left,
                        (parser_stack.get(parser_top)).right, result);
            }
            return parser_result;
            ...
            {
                Object nt = parser_stack.get(parser_top).value;
                parser_result = new Symbol(33, (parser_stack.get(parser_top)).left,
                        (parser_stack.get(parser_top)).right, nt);
            }
            return parser_result;
            ...
            {
                Object result = null;
                parser_result = new Symbol(34, (parser_stack.get(parser_top)).left,
                        (parser_stack.get(parser_top)).right, result);
            }
            return parser_result;
            ...
            {
                QName qn = (QName) (parser_stack.get(parser_top)).value;
                parser_result = new Symbol(34, (parser_stack.get(parser_top)).left,
                        (parser_stack.get(parser_top)).right, qn);
            }
            return parser_result;
            ...
            case 33: // ChildOrAttributeAxisSpecifier ::= ATSIGN
            {
                ...
                parser_result = new Symbol(42, (parser_stack.get(parser_top)).left,
                        (parser_stack.get(parser_top)).right, result);
            }
            return parser_result;
            ...
            {
                Expression p = (Expression) (parser_stack.get(parser_top)).value;
                List<Expression> temp = new ArrayList<>();
                temp.add(p);
                parser_result = new Symbol(35, (parser_stack.get(parser_top)).left,
                        (parser_stack.get(parser_top)).right, temp);
            }
            return parser_result;
            ...
            case 37: // Predicates ::= Predicate Predicates
            {
                ...
                @SuppressWarnings("unchecked")
                List<Expression> pp = (ArrayList<Expression>) (parser_stack.get(parser_top)).value;
                pp.add(0, p);
                parser_result = new Symbol(35, (parser_stack.get(parser_top - 1)).left,
                        (parser_stack.get(parser_top)).right, pp);
            }
            return parser_result;
            ...
            case 39: // Expr ::= OrExpr
            {
                Expression ex = (Expression) (parser_stack.get(parser_top)).value;
                parser_result = new Symbol(2, (parser_stack.get(parser_top)).left,
                        (parser_stack.get(parser_top)).right, ex);
            }
            return parser_result;
            ...
            {
                Expression ae = (Expression) (parser_stack.get(parser_top)).value;
                parser_result = new Symbol(8, (parser_stack.get(parser_top)).left,
                        (parser_stack.get(parser_top)).right, ae);
            }
            return parser_result;
            ...
            {
                Expression e = (Expression) (parser_stack.get(parser_top)).value;
                parser_result = new Symbol(9, (parser_stack.get(parser_top)).left,
                        (parser_stack.get(parser_top)).right, e);
            }
            return parser_result;
            ...
            case 43: // AndExpr ::= AndExpr AND EqualityExpr
            {
                ...
                Expression ee = (Expression) (parser_stack.get(parser_top)).value;
            ...
            {
                Expression re = (Expression) (parser_stack.get(parser_top)).value;
                parser_result = new Symbol(10, (parser_stack.get(parser_top)).left,
                        (parser_stack.get(parser_top)).right, re);
            }
            return parser_result;
            ...
            {
                Expression ae = (Expression) (parser_stack.get(parser_top)).value;
                parser_result = new Symbol(11, (parser_stack.get(parser_top)).left,
                        (parser_stack.get(parser_top)).right, ae);
            }
            return parser_result;
            ...
            {
                Expression me = (Expression) (parser_stack.get(parser_top)).value;
                parser_result = new Symbol(12, (parser_stack.get(parser_top)).left,
                        (parser_stack.get(parser_top)).right, me);
            }
            return parser_result;
            ...
            {
                Expression ue = (Expression) (parser_stack.get(parser_top)).value;
                parser_result = new Symbol(13, (parser_stack.get(parser_top)).left,
                        (parser_stack.get(parser_top)).right, ue);
            }
            return parser_result;
            ...
            {
                Expression ue = (Expression) (parser_stack.get(parser_top)).value;
                parser_result = new Symbol(14, (parser_stack.get(parser_top)).left,
                        (parser_stack.get(parser_top)).right, ue);
            }
            return parser_result;
            ...
            {
                Expression pe = (Expression) (parser_stack.get(parser_top)).value;
                parser_result = new Symbol(18, (parser_stack.get(parser_top)).left,
                        (parser_stack.get(parser_top)).right, pe);
            }
            return parser_result;
            ...
            case 62: // UnionExpr ::= PathExpr VBAR UnionExpr
            {
                ...
                Expression rest = (Expression) (parser_stack.get(parser_top)).value;
            ...
            {
                Expression lp = (Expression) (parser_stack.get(parser_top)).value;
                parser_result = new Symbol(19, (parser_stack.get(parser_top)).left,
                        (parser_stack.get(parser_top)).right, lp);
            }
            return parser_result;
            ...
            {
                Expression fexp = (Expression) (parser_stack.get(parser_top)).value;
                parser_result = new Symbol(19, (parser_stack.get(parser_top)).left,
                        (parser_stack.get(parser_top)).right, fexp);
            }
            return parser_result;
            ...
            case 65: // PathExpr ::= FilterExpr SLASH RelativeLocationPath
            {
                ...
                Expression rlp = (Expression) (parser_stack.get(parser_top)).value;
            ...
            case 66: // PathExpr ::= FilterExpr DSLASH RelativeLocationPath
            {
                ...
                parser_result = new Symbol(19, (parser_stack.get(parser_top - 2)).left,
                        (parser_stack.get(parser_top)).right, fpp);
            }
            return parser_result;
            ...
            {
                Expression rlp = (Expression) (parser_stack.get(parser_top)).value;
                parser_result = new Symbol(4, (parser_stack.get(parser_top)).left,
                        (parser_stack.get(parser_top)).right, rlp);
            }
            return parser_result;
            ...
            {
                Expression alp = (Expression) (parser_stack.get(parser_top)).value;
                parser_result = new Symbol(4, (parser_stack.get(parser_top)).left,
                        (parser_stack.get(parser_top)).right, alp);
            }
            return parser_result;
            ...
            {
                Expression step = (Expression) (parser_stack.get(parser_top)).value;
                parser_result = new Symbol(21, (parser_stack.get(parser_top)).left,
                        (parser_stack.get(parser_top)).right, step);
            }
            return parser_result;
            ...
            {
                Expression arlp = (Expression) (parser_stack.get(parser_top)).value;
                parser_result = new Symbol(21, (parser_stack.get(parser_top)).left,
                        (parser_stack.get(parser_top)).right, arlp);
            }
            return parser_result;
            ...
            case 72: // AbsoluteLocationPath ::= SLASH
            {
                ...
                parser_result = new Symbol(23, (parser_stack.get(parser_top)).left,
                        (parser_stack.get(parser_top)).right, result);
            }
            return parser_result;
            ...
            {
                Expression aalp = (Expression) (parser_stack.get(parser_top)).value;
                parser_result = new Symbol(23, (parser_stack.get(parser_top)).left,
                        (parser_stack.get(parser_top)).right, aalp);
            }
            return parser_result;
            ...
            {
                Expression result = null;
                Object ntest = parser_stack.get(parser_top).value;
                ...
                parser_result = new Symbol(7, (parser_stack.get(parser_top)).left,
                        (parser_stack.get(parser_top)).right, result);
            }
            return parser_result;
            ...
            {
                Expression abbrev = (Expression) (parser_stack.get(parser_top)).value;
                parser_result = new Symbol(7, (parser_stack.get(parser_top)).left,
                        (parser_stack.get(parser_top)).right, abbrev);
            }
            return parser_result;
            ...
            case 82: // AxisSpecifier ::= AxisName DCOLON
            {
                ...
                parser_result = new Symbol(41, (parser_stack.get(parser_top - 1)).left,
                        (parser_stack.get(parser_top)).right, an);
            }
            return parser_result;
            ...
            {
                Integer result = Axis.ATTRIBUTE;
                parser_result = new Symbol(41, (parser_stack.get(parser_top)).left,
                        (parser_stack.get(parser_top)).right, result);
            }
            return parser_result;
            ...
            case 84: // AxisName ::= ANCESTOR
            {
                ...
                parser_result = new Symbol(40, (parser_stack.get(parser_top)).left,
                        (parser_stack.get(parser_top)).right, result);
            }
            return parser_result;
            ...
            case 97: // AbbreviatedStep ::= DOT
            {
                ...
                parser_result = new Symbol(20, (parser_stack.get(parser_top)).left,
                        (parser_stack.get(parser_top)).right, result);
            }
            return parser_result;
            ...
            {
                Expression primary = (Expression) (parser_stack.get(parser_top)).value;
                parser_result = new Symbol(6, (parser_stack.get(parser_top)).left,
                        (parser_stack.get(parser_top)).right, primary);
            }
            return parser_result;
            ...
            {
                Expression vr = (Expression) (parser_stack.get(parser_top)).value;
                parser_result = new Symbol(17, (parser_stack.get(parser_top)).left,
                        (parser_stack.get(parser_top)).right, vr);
            }
            return parser_result;
            ...
            {
                String string = (String) (parser_stack.get(parser_top)).value;
                /*
        ...
        * others. Also, the default namespace must be ignored.
            ...
            {
                Expression result = null;
                Long num = (Long) (parser_stack.get(parser_top)).value;
            ...
            {
                Double num = (Double) (parser_stack.get(parser_top)).value;
            ...
            {
                Expression fc = (Expression) (parser_stack.get(parser_top)).value;
                parser_result = new Symbol(17, (parser_stack.get(parser_top)).left,
                        (parser_stack.get(parser_top)).right, fc);
            }
            return parser_result;
            ...
            {
                Expression result = null;
                QName varName = (QName) (parser_stack.get(parser_top)).value;
            ...
            {
                Expression arg = (Expression) (parser_stack.get(parser_top)).value;
                List<Expression> temp = new ArrayList<>();
                temp.add(arg);
                parser_result = new Symbol(36, (parser_stack.get(parser_top)).left,
                        (parser_stack.get(parser_top)).right, temp);
            }
            return parser_result;
            ...
            case 111: // NonemptyArgumentList ::= Argument COMMA NonemptyArgumentList
            {
                ...
                @SuppressWarnings("unchecked")
                List<Expression> argl = (ArrayList<Expression>) (parser_stack.get(parser_top)).value;
                argl.add(0, arg);
                parser_result = new Symbol(36, (parser_stack.get(parser_top - 2)).left,
                        (parser_stack.get(parser_top)).right, argl);
            }
            return parser_result;
            ...
            {
                QName fname = (QName) (parser_stack.get(parser_top)).value;
                parser_result = new Symbol(38, (parser_stack.get(parser_top)).left,
                        (parser_stack.get(parser_top)).right, fname);
            }
            return parser_result;
            ...
            {
                QName vname = (QName) (parser_stack.get(parser_top)).value;
                parser_result = new Symbol(39, (parser_stack.get(parser_top)).left,
                        (parser_stack.get(parser_top)).right, vname);
            }
            return parser_result;
            ...
            {
                Expression ex = (Expression) (parser_stack.get(parser_top)).value;
                parser_result = new Symbol(3, (parser_stack.get(parser_top)).left,
                        (parser_stack.get(parser_top)).right, ex);
            }
            return parser_result;
            ...
            {
                Object nt = parser_stack.get(parser_top).value;
                parser_result = new Symbol(25, (parser_stack.get(parser_top)).left,
                        (parser_stack.get(parser_top)).right, nt);
            }
            return parser_result;
            ...
            {
                Object result = null;
                parser_result = new Symbol(26, (parser_stack.get(parser_top)).left,
                        (parser_stack.get(parser_top)).right, result);
            }
            return parser_result;
            ...
            {
                String qname = (String) (parser_stack.get(parser_top)).value;
                QName result = parser.getQNameIgnoreDefaultNs(qname);
                parser_result = new Symbol(37, (parser_stack.get(parser_top)).left,
                        (parser_stack.get(parser_top)).right, result);
            }
            return parser_result;
