...
final class DOM3TreeWalker {
    ...
    public void traverse(Node pos) throws org.xml.sax.SAXException {
        ...
        if (fSerializer instanceof LexicalHandler) {
            fLexicalHandler = this.fSerializer;
        }
     ...
     * @throws org.xml.sax.SAXException
     */
    private void startNode(Node node) throws org.xml.sax.SAXException {
     ...
     */
    private boolean applyFilter(Node node, int nodeType) {
     ...
     */
    private void serializeDocType(DocumentType node, boolean bStart)
        throws SAXException {
     ...
     */
    private void serializeComment(Comment node) throws SAXException {
        // comments=true
     ...
     */
    private void serializeElement(Element node, boolean bStart)
        throws SAXException {
        if (bStart) {
            fElementDepth++;
     ...
     */
    private void serializeAttList(Element node) throws SAXException {
     ...
     */
    private void serializePI(ProcessingInstruction node)
        throws SAXException {
     ...
     */
    private void serializeCDATASection(CDATASection node)
        throws SAXException {
        // well-formed=true
        if ((fFeatures & WELLFORMED) != 0) {
     ...
     */
    private void serializeText(Text node) throws SAXException {
        if (fNextIsRaw) {
            fNextIsRaw = false;
     ...
     */
    private void serializeEntityReference(
     ...
     */
    private boolean isWFXMLChar(String chardata, Character refInvalidChar) {
     ...
     */
    private Character isWFXMLChar(String chardata) {
     ...
     * @param data The contents of the comment node
     */
    private void isPIWellFormed(ProcessingInstruction node) {
     ...
     */
    private void isEntityReferneceWellFormed(EntityReference node) {
     ...
     */
    private void checkUnboundPrefixInEntRef(Node node) {
        Node child, next;
     ...
     */
    private void recordLocalNSDecl(Node node) {
        NamedNodeMap atts = node.getAttributes();
     ...
     */
    private void fixupElementNS(Node node) throws SAXException {
        ...
        for(String key : properties.stringPropertyNames()) {
            ...
            if (bitFlag != null) {
                ...
                if ((DOMConstants.S_DOM3_PROPERTIES_NS
                    ...
                    fSerializer.setOmitXMLDeclaration(properties.getProperty(key).endsWith("yes"));
