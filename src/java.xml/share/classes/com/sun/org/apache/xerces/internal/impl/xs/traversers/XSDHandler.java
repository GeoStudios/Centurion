...
import java.xml.share.classes.com.sun.org.apache.xerces.internal.impl.xs.XSDDescription;
...
import java.xml.share.classes.com.sun.org.apache.xerces.internal.impl.xs.opti.SchemaParsingConfig;
import java.xml.share.classes.com.sun.org.apache.xerces.internal.impl.xs.util.SimpleLocator;
import java.xml.share.classes.com.sun.org.apache.xerces.internal.impl.xs.util.XSInputSource;
...
import java.xml.share.classes.com.sun.org.apache.xerces.internal.util.DOMInputSource;
...
import java.xml.share.classes.com.sun.org.apache.xerces.internal.util.SAXInputSource;
import java.xml.share.classes.com.sun.org.apache.xerces.internal.util.StAXInputSource;
...
public class XSDHandler {
    ...
    private final Map<String, Element> fUnparsedAttributeRegistry = new HashMap<>();
    private final Map<String, Element> fUnparsedAttributeGroupRegistry =  new HashMap<>();
    private final Map<String, Element> fUnparsedElementRegistry =  new HashMap<>();
    private final Map<String, Element> fUnparsedGroupRegistry =  new HashMap<>();
    private final Map<String, Element> fUnparsedIdentityConstraintRegistry =  new HashMap<>();
    private final Map<String, Element> fUnparsedNotationRegistry =  new HashMap<>();
    private final Map<String, Element> fUnparsedTypeRegistry =  new HashMap<>();
    ...
    private final Map<String, XSDocumentInfo> fUnparsedAttributeRegistrySub =  new HashMap<>();
    private final Map<String, XSDocumentInfo> fUnparsedAttributeGroupRegistrySub =  new HashMap<>();
    private final Map<String, XSDocumentInfo> fUnparsedElementRegistrySub =  new HashMap<>();
    private final Map<String, XSDocumentInfo> fUnparsedGroupRegistrySub =  new HashMap<>();
    private final Map<String, XSDocumentInfo> fUnparsedIdentityConstraintRegistrySub =  new HashMap<>();
    private final Map<String, XSDocumentInfo> fUnparsedNotationRegistrySub =  new HashMap<>();
    private final Map<String, XSDocumentInfo> fUnparsedTypeRegistrySub =  new HashMap<>();
    ...
    private final Map<String, XSDocumentInfo>[] fUnparsedRegistriesExt = new HashMap[] {
        null,
        null, // ATTRIBUTE_TYPE
    ...
    private final Map<XSDocumentInfo, List<XSDocumentInfo>> fDependencyMap = new HashMap<>();
    ...
    private final Map<String, List<String>> fImportMap = new HashMap<> ();
    ...
    private final List<String> fAllTNSs = new ArrayList<>();
    ...
    private final Map<XSDKey, Element> fTraversed = new HashMap<>();

    // this map contains a mapping from Schema Element to its systemId
    // this is useful to resolve a uri relative to the referring document
    private final Map<Element, String> fDoc2SystemId = new HashMap<>();
    ...
    // XSDocumentInfo object.
    private final Map<Element, XSDocumentInfo> fDoc2XSDocumentMap = new HashMap<>();
    ...
    throws IOException {
        ...
        if (schemaRoot == null) {
            if (is instanceof XSInputSource xsinput) {
    ...
    private XSDocumentInfo findXSDocumentForDecl(XSDocumentInfo currSchema,
        ...
        if (DEBUG_NODE_POOL) {
            System.out.println("DOCUMENT NS:" + currSchema.fTargetNamespace + " hashcode:" +
                    currSchema.fSchemaElement.hashCode());
        }
    ...
    public boolean element2Locator(Element e, SimpleLocator l) {
        if (l == null)
            return false;
        if (e instanceof ElementImpl ele) {
