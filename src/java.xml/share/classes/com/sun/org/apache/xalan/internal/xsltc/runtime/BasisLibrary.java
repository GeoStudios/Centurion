...
public final class BasisLibrary {
    ...
    public static double numberF(Object obj, DOM dom) {
        ...
        else if (obj instanceof DTMAxisIterator iter) {
    ...
    private static final DecimalFormat xpathFormatter;
                                        ...
                                        Translet translet, DOM dom)
    {
        ...
        for (int i = 0; i < nodeList.getLength(); ++i) {
            org.w3c.dom.Node node = nodeList.item(i);
            if (node instanceof DTMNodeProxy proxy) {
    ...
    public static void copy(Object obj,
                            ...
                            DOM dom) {
        try {
            if (obj instanceof DTMAxisIterator iter)
      {
          dom.copy(iter.reset(), handler);
            ...
            else if (obj instanceof DOM newDom) {
