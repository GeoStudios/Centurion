...
abstract class XSDAbstractTraverser {
    ...
    XSAnnotationImpl traverseAnnotationDecl(Element annotationDecl, Object[] parentAttrs,
        ...
        if(annotationLocalAttrs != null && !annotationLocalAttrs.isEmpty()) {
            ...
            contentBuffer.append(localStrBuffer);
    ...
    private final StringBuilder fPattern = new StringBuilder();
    ...
    protected XSParticleDecl checkOccurrences(XSParticleDecl particle,
        ...
        boolean defaultMin = (defaultVals & (1L << XSAttributeChecker.ATTIDX_MINOCCURS)) != 0;
        boolean defaultMax = (defaultVals & (1L << XSAttributeChecker.ATTIDX_MAXOCCURS)) != 0;
