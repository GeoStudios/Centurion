...
public class XSSimpleTypeDecl implements XSSimpleType, TypeInfo {
    ...
    protected String normalize(Object content, short ws) {
        ...
        if (!(content instanceof StringBuffer sb)) {
    ...
    private void setBounded(){
        if(fVariety == VARIETY_ATOMIC){
            this.fBounded = (((this.fFacetsDefined & FACET_MININCLUSIVE) != 0) || ((this.fFacetsDefined & FACET_MINEXCLUSIVE) != 0))
                    && (((this.fFacetsDefined & FACET_MAXINCLUSIVE) != 0) || ((this.fFacetsDefined & FACET_MAXEXCLUSIVE) != 0));
        }
        else if(fVariety == VARIETY_LIST){
            this.fBounded = ((this.fFacetsDefined & FACET_LENGTH) != 0) || (((this.fFacetsDefined & FACET_MINLENGTH) != 0)
    ...
    private boolean specialCardinalityCheck(){
        return (fBase.fValidationDV == XSSimpleTypeDecl.DV_DATE) || (fBase.fValidationDV == XSSimpleTypeDecl.DV_GYEARMONTH)
    ...
    private void setCardinality(){
        if(fVariety == VARIETY_ATOMIC){
            if(fBase.fFinite){
                ...
                if ( ((this.fFacetsDefined & FACET_LENGTH) != 0 ) || ((this.fFacetsDefined & FACET_MAXLENGTH) != 0 )
                    ...
                    this.fFinite = true;
                        ...
                        && (((this.fFacetsDefined & FACET_MAXINCLUSIVE) != 0 ) || ((this.fFacetsDefined & FACET_MAXEXCLUSIVE) != 0 )) ){
                    this.fFinite = ((this.fFacetsDefined & FACET_FRACTIONDIGITS) != 0) || specialCardinalityCheck();
                }
                else{
                    this.fFinite = false;
                }
            ...
            this.fFinite = ((this.fFacetsDefined & FACET_LENGTH) != 0) || (((this.fFacetsDefined & FACET_MINLENGTH) != 0)
                    && ((this.fFacetsDefined & FACET_MAXLENGTH) != 0));
