...
public final class REUtil {
    ...
    static int composeFromSurrogates(int high, int low) {
    ...
    static String decomposeToSurrogates(int ch) {
        char[] chs = new char[2];
        ch -= 0x10000;
    ...
    static String substring(CharacterIterator iterator, int begin, int end) {
    ...
    static int getOptionValue(int ch) {
        int ret = 0;
        switch (ch) {
          case 'i':
    ...
    static int parseOptions(String opts) throws ParseException {
    ...
    static String createOptionString(int options) {
