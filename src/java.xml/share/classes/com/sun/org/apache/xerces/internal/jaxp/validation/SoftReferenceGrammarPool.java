...
final class SoftReferenceGrammarPool implements XMLGrammarPool {
    ...
    public boolean equals(XMLGrammarDescription desc1, XMLGrammarDescription desc2) {
        if (desc1 instanceof XMLSchemaDescription sd1) {
            if (!(desc2 instanceof XMLSchemaDescription sd2)) {
                return false;
            }
            ...
            else return sd2.getExpandedSystemId() == null;
        }
    ...
    public int hashCode(XMLGrammarDescription desc) {
        if (desc instanceof XMLSchemaDescription sd) {
