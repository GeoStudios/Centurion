...
public class XMLStreamReaderImpl implements javax.xml.stream.XMLStreamReader {
    ...
    public Location getLocation() {
        return new Location() {
            final String _systemId = fEntityScanner.getExpandedSystemId();
            final String _publicId = fEntityScanner.getPublicId();
            final int _offset = fEntityScanner.getCharacterOffset();
            final int _columnNumber = fEntityScanner.getColumnNumber();
            final int _lineNumber = fEntityScanner.getLineNumber();
