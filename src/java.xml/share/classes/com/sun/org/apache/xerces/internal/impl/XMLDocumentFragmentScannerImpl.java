...
import java.xml.share.classes.com.sun.org.apache.xerces.internal.util.XMLAttributesIteratorImpl;
...
import java.xml.share.classes.com.sun.xml.internal.stream.dtd.DTDGrammarUtil;
...
public class XMLDocumentFragmentScannerImpl
    ...
    public void reset(PropertyManager propertyManager){
        ...
        fReportCdataEvent = !fIsCoalesce && (fReportCdataEvent);
    ...
    void addElement(String rawname){
        if(fElementPointer < ELEMENT_ARRAY_LENGTH){
            ...
            if(DEBUG_SKIP_ALGORITHM){
                String sb = " Storing element information " +
                        " fElementPointer = " + fElementPointer +
                        " fElementRawname = " + fElementQName.rawname +
                        " fElementStack.fDepth = " + fElementStack.fDepth;
    ...
    throws IOException, XNIException {
        ...
        if (DEBUG_START_END_ELEMENT) System.out.println(this.getClass() +"<<< scanAttribute()");
    ...
    protected int scanEndElement() throws IOException, XNIException {
        ...
        if(DEBUG)System.out.println("endElementName = " + endElementName);
