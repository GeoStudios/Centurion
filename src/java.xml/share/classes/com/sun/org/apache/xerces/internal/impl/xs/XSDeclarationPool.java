...
public final class XSDeclarationPool {
    ...
    public XSAttributeUseImpl getAttributeUse(){
    ...
    public XSComplexTypeDecl getComplexTypeDecl(){
    ...
    public XSSimpleTypeDecl getSimpleTypeDecl(){
    ...
    public XSParticleDecl getParticleDecl(){
    ...
    public XSModelGroupImpl getModelGroup(){
