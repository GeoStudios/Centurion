...
import java.xml.share.classes.com.sun.org.apache.xml.internal.utils.LocaleUtility;
...
public class NodeSortRecordFactory {
    ...
    private static final int DESCENDING = "descending".length();
    private static final int NUMBER     = "number".length();

    private final DOM      _dom;
    private final String   _className;
    private Class<?> _class;
    private final SortSettings _sortSettings;
