...
public class ConstantPoolGen {
    ...
    public int lookupInteger( final int n ) {
        for (int i = 1; i < index; i++) {
            if (constants[i] instanceof ConstantInteger c) {
                if (c.getBytes() == n) {
                    return i;
                }
            }
    ...
    public int lookupFloat( final float n ) {
        ...
        for (int i = 1; i < index; i++) {
            if (constants[i] instanceof ConstantFloat c) {
    ...
    public int lookupLong( final long n ) {
        for (int i = 1; i < index; i++) {
            if (constants[i] instanceof ConstantLong c) {
                if (c.getBytes() == n) {
                    return i;
                }
            }
    ...
    public int lookupDouble( final double n ) {
        ...
        for (int i = 1; i < index; i++) {
            if (constants[i] instanceof ConstantDouble c) {
