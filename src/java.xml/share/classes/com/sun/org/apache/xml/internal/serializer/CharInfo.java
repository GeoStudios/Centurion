...
final class CharInfo
{
    ...
    private final Map<CharKey, String> m_charToString = new HashMap<>();
     ...
     */
    private final boolean[] isSpecialAttrASCII = new boolean[ASCII_MAX];

    /** Array of values is faster access than a set of bits
     * to quickly check ASCII characters in text nodes.
     */
    private final boolean[] isSpecialTextASCII = new boolean[ASCII_MAX];

    private final boolean[] isCleanTextASCII = new boolean[ASCII_MAX];
     ...
     * @xsl.usage internal
     */
    boolean isSpecialAttrChar(int value)
    {
     ...
     * @xsl.usage internal
     */
    boolean isSpecialTextChar(int value)
    {
        // for performance try the values in the boolean array first,
        // this is faster access than the BitSet for common ASCII values
     ...
     * @xsl.usage internal
     */
    boolean isTextASCIIClean(int value)
    {
    ...
    private static final Map<String, CharInfo> m_getCharInfoCache = new HashMap<>();
