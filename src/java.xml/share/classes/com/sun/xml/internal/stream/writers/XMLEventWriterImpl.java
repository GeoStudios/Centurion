    ...
    public void add(XMLEvent xMLEvent) throws XMLStreamException {
        ...
        switch (type) {
            case XMLEvent.DTD: {
                ...
                if (DEBUG) {
                    System.out.println("Adding DTD = " + dtd);
                }
            ...
            case XMLEvent.START_DOCUMENT: {
                ...
                if (DEBUG) {
                    System.out.println("Adding StartDocument = " + startDocument);
                }
                try {
            ...
            case XMLEvent.PROCESSING_INSTRUCTION: {
                ...
                if (DEBUG) {
                    System.out.println("Adding processing instruction = " + processingInstruction);
                }
            ...
            case XMLEvent.ENTITY_REFERENCE: {
                ...
                if (DEBUG) {
                    System.out.println("Adding Entity Reference = " + entityReference);
                }
            ...
            case XMLEvent.CDATA: {
                ...
                if (DEBUG) {
                    System.out.println("Adding characters = " + characters);
                }
                if (characters.isCData()) {
                    fStreamWriter.writeCData(characters.getData());
                }
