...
final class DesktopIntegration {
    ...
    Map<String, String> create() throws IOException {
        ...
        List<String> installShellCmds = new ArrayList<>(Collections.singletonList(
                data.get(DESKTOP_COMMANDS_INSTALL)));
        List<String> uninstallShellCmds = new ArrayList<>(Collections.singletonList(
    ...
    private class ShellCommands {
        ...
        private final String registerDesktopFileCmd;
        private final String unregisterDesktopFileCmd;

        private String registerFileAssociationsCmd;
        private String unregisterFileAssociationsCmd;

        private final List<String> registerIconCmds;
        private final List<String> unregisterIconCmds;
    }
    ...
    private static final StandardBundlerParam<Boolean> SHORTCUT_HINT =
        new StandardBundlerParam<>(
                ...
                Boolean.class,
                params -> false,
                (s, p) -> s != null && !"null".equalsIgnoreCase(s) && Boolean.valueOf(s)
        );
}
