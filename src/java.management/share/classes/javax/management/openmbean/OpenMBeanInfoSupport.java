...
public class OpenMBeanInfoSupport
    ...
    public String toString() {
        ...
        //
        if (myToString == null) {
            myToString = this.getClass().getName() +
                    "(mbean_class_name=" +
                    this.getClassName() +
                    ",attributes=" +
                    Arrays.asList(this.getAttributes()) +
                    ",constructors=" +
                    Arrays.asList(this.getConstructors()) +
                    ",operations=" +
                    Arrays.asList(this.getOperations()) +
                    ",notifications=" +
                    Arrays.asList(this.getNotifications()) +
                    ",descriptor=" +
                    this.getDescriptor() +
                    ")";
        }
