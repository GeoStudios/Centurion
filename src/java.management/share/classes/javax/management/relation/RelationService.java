...
public class RelationService extends NotificationBroadcasterSupport
    ...
    // user
    private final Map<String,Object> myRelId2ObjMap = new HashMap<String,Object>();

    // Map associating:
    //      <relation id> -> <relation type name>
    private final Map<String,String> myRelId2RelTypeMap = new HashMap<String,String>();
    ...
    private final Map<String,List<String>> myRelType2RelIdsMap =
    ...
    public Integer checkRoleWriting(Role role,
        ...
        boolean writeChkFlag = !initFlag.booleanValue();
    ...
    public void sendRelationCreationNotification(String relationId)
        ...
        sendNotificationInt(1,
                "Creation of relation " + relationId
                // Can throw RelationNotFoundException
                ,
                            relationId,
                            null,
    ...
    public void sendRoleUpdateNotification(String relationId,
        ...
        String ntfMsg = "Value of role " + roleName +
                " has changed\nOld value:\n" +
                oldRoleValString +
                "\nNew value:\n" +
                newRoleValString;
    ...
    public void handleNotification(Notification notif,
        ...
        if (notif instanceof MBeanServerNotification mbsNtf) {
    ...
    private void addRelationTypeInt(RelationType relationTypeObj)
        ...
        try {
            ...
            if (relType != null) {
                ...
                throw new InvalidRelationTypeException(excMsg + relTypeName);
            }
    ...
    RelationType getRelationType(String relationTypeName)
        ...
        if (relType == null) {
            ...
            throw new RelationTypeNotFoundException(excMsg + relationTypeName);
        }
...
//              }
    ...
    private void addRelationInt(boolean relationBaseFlag,
        ...
        try {
            ...
            if (rel != null) {
                ...
                throw new InvalidRelationIdException(excMsg + relationId);
            }
        } catch (RelationNotFoundException exc) {
    ...
    static void throwRoleProblemException(int pbType,
        ...
        String excMsg = roleName + excMsgPart;
        if (excType == 1) {
