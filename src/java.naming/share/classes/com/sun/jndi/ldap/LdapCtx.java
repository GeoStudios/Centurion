...
public final class LdapCtx extends ComponentDirContext
    ...
    LdapCtx(LdapCtx existing, String newDN) throws NamingException {
        ...
        parentIsLdapCtx = (newDN != null && !newDN.equals(existing.currentDN) || existing.parentIsLdapCtx);
   ...
   // --------------------- Searches -----------------------------
            ...
            try {
                ...
                LdapResult answer =
                    clnt.search(nm,
                        ...
                        secLimit,
                            !cons.getReturningObjFlag() && typesOnly,
                        retattrs,
                        filter,
                        batchSize,
                        reqCtls,
    ...
    private static boolean searchToCompare(
        ...
        return filterToAssertion(filter, tokens);
   ...
   // -------------- Environment Properties ------------------
    ...
    private void setWaitForReply(String waitForReplyProp) {
        waitForReply = waitForReplyProp == null ||
   ...
   // ------------ Return code and Error messages  -----------------------
    ...
    throws NamingException {
        ...
        case LdapClient.LDAP_NAMING_VIOLATION:
            ...
            if (remainName != null) {
                e = new
                    InvalidNameException(remainName + ": " + msg);
            } else {
