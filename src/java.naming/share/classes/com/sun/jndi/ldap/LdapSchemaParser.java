...
final class LdapSchemaParser {
    ...
    private final boolean netscapeBug;

    LdapSchemaParser(boolean netscapeBug) {
        this.netscapeBug = netscapeBug;
    }

    static void LDAP2JNDISchema(Attributes schemaAttrs,
    ...
    private static DirContext objectDescs2ClassDefs(Attribute objDescsAttr,
    ...
    private static DirContext attrDescs2AttrDefs(Attribute attributeDescAttr,
                                                 LdapSchemaCtx schemaRoot)
        throws NamingException {
    ...
    private static DirContext syntaxDescs2SyntaxDefs(
    ...
    private static DirContext matchRuleDescs2MatchRuleDefs(
    ...
    private static Object[] desc2Def(String desc)
        throws NamingException {
    ...
    private static int findTrailingWhitespace(String string, int pos) {
        for(int i = pos; i > 0; i--) {
    ...
    private static void skipWhitespace(String string, int[] pos) {
    ...
    private static Attribute readNumericOID(String string, int[] pos)
        throws NamingException {
    ...
    private static Attribute readNextTag(String string, int[] pos)
        throws NamingException {
    ...
    private static String[] readTag(String tag, String string, int[] pos)
        throws NamingException {
    ...
    private static String[] readQDString(String string, int[] pos)
        throws NamingException {
    ...
    */
    private static String[] readQDStrings(String string, int[] pos)
        throws NamingException {
     ...
     * descr           = keystring
     */
    private static String[] readQDescrs(String string, int[] pos)
        throws NamingException {
     ...
     * descr           = keystring
     */
    private static String[] readQDescrList(String string, int[] pos)
        throws NamingException {
    ...
    private static String[] readWOID(String string, int[] pos)
        throws NamingException {
     ...
     * oidlist         = woid *( "$" woid )
     */
    private static String[] readOIDs(String string, int[] pos)
        throws NamingException {
...
*/
    ...
    /**
      ...
      */
    private String classDef2ObjectDesc(Attributes attrs)
        throws NamingException {
    ...
    /**
      ...
      * string description as defined in RFC 2252.
      */
    private String attrDef2AttrDesc(Attributes attrs)
        throws NamingException {
    ...
    /**
      ...
      * string description as defined in RFC 2252.
      */
    private String syntaxDef2SyntaxDesc(Attributes attrs)
        throws NamingException {
    ...
    /**
      ...
      */
    private String matchRuleDef2MatchRuleDesc(Attributes attrs)
        throws NamingException {
    ...
    private String writeNumericOID(Attribute nOIDAttr)
        throws NamingException {
        if(nOIDAttr.size() != 1) {
    ...
    private String writeWOID(Attribute attr) throws NamingException {
        if (netscapeBug)
    ...
    /*  qdescr          = whsp "'" descr "'" whsp */
    private String writeQDString(Attribute qdStringAttr)
        throws NamingException {
    ...
    * qdstrings       = qdstring / ( whsp "(" qdstringlist ")" whsp )
    */
    private String writeQDStrings(Attribute attr) throws NamingException {
     ...
     * descr           = keystring
     */
    private String writeQDescrs(Attribute attr) throws NamingException {
        switch(attr.size()) {
        case 0:
            throw new InvalidAttributeValueException(
    ...
    private String writeOIDs(Attribute oidsAttr)
        throws NamingException {
    ...
    private String writeBoolean(Attribute booleanAttr)
        throws NamingException {
     ...
     * attribute
     */
    Attribute stringifyObjDesc(Attributes classDefAttrs)
        throws NamingException {
        Attribute objDescAttr = new BasicAttribute(OBJECTCLASSDESC_ATTR_ID);
        objDescAttr.add(classDef2ObjectDesc(classDefAttrs));
        return objDescAttr;
     ...
     */
    Attribute stringifyAttrDesc(Attributes attrDefAttrs)
        throws NamingException {
        Attribute attrDescAttr = new BasicAttribute(ATTRIBUTEDESC_ATTR_ID);
        attrDescAttr.add(attrDef2AttrDesc(attrDefAttrs));
        return attrDescAttr;
     ...
     */
    Attribute stringifySyntaxDesc(Attributes syntaxDefAttrs)
    throws NamingException {
        Attribute syntaxDescAttr = new BasicAttribute(SYNTAXDESC_ATTR_ID);
        syntaxDescAttr.add(syntaxDef2SyntaxDesc(syntaxDefAttrs));
     ...
     */
    Attribute stringifyMatchRuleDesc(Attributes matchRuleDefAttrs)
    throws NamingException {
