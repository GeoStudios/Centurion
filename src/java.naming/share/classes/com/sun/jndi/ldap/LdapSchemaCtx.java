...
final class LdapSchemaCtx extends HierMemDirCtx {
    ...
    LdapSchemaCtx setup(int objectType, String name, Attributes attrs)
        throws NamingException{
            try {
                setupMode = true;
    ...
    private static Attributes deepClone(Attributes orig)
        throws NamingException {
    ...
    /**
      ...
      * or parens.
      */
    private void deleteServerSchema(Attributes origAttrs)
        throws NamingException {
    ...
    /**
      ...
      */
    private void modifyServerSchema(Attributes origAttrs,
    ...
    private static final class SchemaInfo {
        ...
        private final String schemaEntryName;
        LdapSchemaParser parser;
        private final String host;
        private final int port;
        private final boolean hasLdapsScheme;
