...
public final class LdapName implements Name {
    ...
    public Name addAll(int pos, Name suffix) throws InvalidNameException {
        if (suffix instanceof LdapName s) {
    ...
    static class DnParser {
        ...
        private final boolean valuesCaseSensitive;
    ...
    static class TypeAndValue {
        ...
        public boolean equals(Object obj) {
            ...
            if (!(obj instanceof TypeAndValue that)) {
                return false;
            }
            ...
            for (int i = beg; i < end; i++) {
                if ((chars[i] == '\\') && (i + 1 < end)) {
                    if (!Character.isLetterOrDigit(chars[i + 1])) {
                        ...
                        if (utf8.length > 0) {
                            buf.append(new String(utf8, StandardCharsets.UTF_8));
                            i += utf8.length * 3 - 1;
                        } else {
