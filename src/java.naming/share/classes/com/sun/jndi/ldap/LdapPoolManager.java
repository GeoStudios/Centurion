...
public final class LdapPoolManager {
    ...
    private static String getProperty(final String propName, final String defVal) {
        PrivilegedAction<String> pa = () -> System.getProperty(propName, defVal);
        return AccessController.doPrivileged(pa);
    }

    private static int getInteger(final String propName, final int defVal) {
        PrivilegedAction<Integer> pa = () -> Integer.getInteger(propName, defVal);
        return AccessController.doPrivileged(pa);
    }

    private static long getLong(final String propName, final long defVal) {
