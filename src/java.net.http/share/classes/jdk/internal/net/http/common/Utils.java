...
//    }
    ...
    private static boolean hostnameVerificationDisabledValue() {
        ...
        if (prop == null)
            return false;
        return prop.isEmpty() || Boolean.parseBoolean(prop);
    }
    ...
    public static BiPredicate<String, String> CONTEXT_RESTRICTED(HttpClient client) {
    ...
    public static BiPredicate<String, String> PROXY_TUNNEL_RESTRICTED(HttpClient client)  {
    ...
    private static boolean isAllowedForProxy(String name,
                                             String value,
    ...
    public static void setWebSocketUpgradeHeaders(HttpRequestImpl request) {
    ...
    public static URLPermission permissionForServer(URI uri,
        ...
        String urlString = uri.getScheme() + "://" +
                uri.getRawAuthority() +
                uri.getRawPath();
