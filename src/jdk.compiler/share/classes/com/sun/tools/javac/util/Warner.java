...
public class Warner {
    ...
    private final EnumSet<LintCategory> nonSilentLintSet = EnumSet.noneOf(LintCategory.class);
    private final EnumSet<LintCategory> silentLintSet = EnumSet.noneOf(LintCategory.class);
