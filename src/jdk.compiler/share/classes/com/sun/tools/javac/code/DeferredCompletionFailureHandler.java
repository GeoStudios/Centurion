...
public class DeferredCompletionFailureHandler {
    ...
    public interface Handler {
        void install();
        void handleAPICompletionFailure(CompletionFailure cf);
        void classSymbolCompleteFailed(ClassSymbol sym, Completer origCompleter);
        void classSymbolRemoved(ClassSymbol sym);
        void uninstall();
    }
