...
public class JavacFiler implements Filer, Closeable {
    ...
    private class FilerOutputFileObject extends ForwardingFileObject<FileObject> {
        ...
        private final ModuleSymbol mod;
     ...
     */
    private final Set<String> generatedSourceNames;
     ...
     * insertion order.
     */
    private final Set<JavaFileObject> generatedSourceFileObjects;
    ...
    private boolean containedInInitialInputs(String typename) {
        ...
        return sourceFile != null && initialInputs.contains(sourceFile);
    }
