...
import jdk.compiler.share.classes.com.sun.tools.javac.jvm.ByteCodes;
...
public class Operators {
    ...
    /** Unary operators map. */
    private final Map<Name, List<UnaryOperatorHelper>> unaryOperators = new HashMap<>(Tag.getNumberOfOperators());

    /** Binary operators map. */
    private final Map<Name, List<BinaryOperatorHelper>> binaryOperators = new HashMap<>(Tag.getNumberOfOperators());

    /** The names of all operators. */
    private final Name[] opname = new Name[Tag.getNumberOfOperators()];
