...
public class Log {
    ...
    private static final Log stdOutErr = new Log(new PrintWriter(System.out), new PrintWriter(System.err));
    private static final ThreadLocal<Log> loggers = new ThreadLocal<>();
