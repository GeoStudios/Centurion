...
public class Options {
    ...
    // Input directories
    private final List<SourceLocation> sources = new ArrayList<>();
    private final List<SourceLocation> sourceSearchPaths = new ArrayList<>();
    private final List<SourceLocation> classSearchPaths = new ArrayList<>();
    private final List<SourceLocation> moduleSearchPaths = new ArrayList<>();

    private String logLevel = "info";

    private final Set<String> permitted_artifacts = new HashSet<>();
    ...
    private final List<String> javacArgs = new ArrayList<>();

    private final Map<String, Transformer> trRules = new HashMap<>();
