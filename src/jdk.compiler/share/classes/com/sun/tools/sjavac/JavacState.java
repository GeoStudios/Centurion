...
public class JavacState {
    ...
    private final Set<String> recompiledPackages;
    ...
    private final CompileJavaPackages compileJavaPackages = new CompileJavaPackages();
