...
public final class Tools extends JPanel implements ActionListener,
    ...
    private final Font font = new Font(Font.SERIF, Font.PLAIN, 10);
    private final Color roColor = new Color(187, 213, 238);
    private final Surface surface;
    private Thread thread;
    private final JPanel toolbarPanel;
    private JPanel sliderPanel;
    private JLabel label;
    private final ToggleIcon bumpyIcon;
    private final ToggleIcon rolloverIcon;
    ...
    public JButton addTool(Image img,
        ...
        JButton b = new JButton(new ImageIcon(img)) {
            ...
            final Dimension prefSize = new Dimension(25, 22);
    ...
    public JToggleButton addTool(String name,
        ...
        toolbar.add(b);
        b.setFocusPainted(false);
        b.setSelected(toolTip.equals("Rendering Quality") || toolTip.equals(
    ...
    static class ToggleIcon implements Icon, Runnable {
        ...
        private final Color shadowColor = new Color(102, 102, 153);
