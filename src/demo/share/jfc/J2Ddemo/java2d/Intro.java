...
public class Intro extends JPanel {
    ...
    static class ScenesTable extends JPanel implements ActionListener,
        ...
        public ScenesTable(final Intro intro) {
            ...
            tb.setTitle("Anim delay = " + intro.surface.sleepAmt
                    + " ms");
            slider.setBorder(tb);
    ...
    static class Surface extends JPanel implements Runnable {
        ...
        static class GpE implements Part {
            ...
            private final List<Rectangle2D> rect = new ArrayList<Rectangle2D>();
            private final List<GradientPaint> grad = new ArrayList<GradientPaint>();
            private final int type;
        ...
        static class SiE implements Part {
            ...
            private final int ending;
            private BufferedImage bimg;
            private final double rIncr;
            private final double sIncr;
            private double scale, rotate;
            private final int siw;
            private final int sih;
            private final List<BufferedImage> subs = new ArrayList<BufferedImage>(20);
            private final List<Point> pts = new ArrayList<Point>(20);
