...
public class FileChooserDemo extends JPanel implements ActionListener {
    ...
    private final JCheckBox showAllFilesFilterCheckBox;
    private final JCheckBox showImageFilesFilterCheckBox;
    private final JCheckBox showFullDescriptionCheckBox;
    private final JCheckBox useFileViewCheckBox;
    private final JCheckBox useFileSystemViewCheckBox;
    private final JCheckBox accessoryCheckBox;
    private final JCheckBox setHiddenCheckBox;
    private final JCheckBox useEmbedInWizardCheckBox;
    private final JCheckBox useControlsCheckBox;
    private final JCheckBox enableDragCheckBox;
    private final JRadioButton singleSelectionRadioButton;
    private final JRadioButton multiSelectionRadioButton;
    private final JRadioButton openRadioButton;
    private final JRadioButton saveRadioButton;
    private final JRadioButton customButton;
    private final JComboBox<SupportedLaF> lafComboBox;
    private final JRadioButton justFilesRadioButton;
    private final JRadioButton justDirectoriesRadioButton;
    private final JRadioButton bothFilesAndDirectoriesRadioButton;
