...
public final class Font2DTest extends JPanel
    ...
    private final LabelV2[] fontInfos = new LabelV2[2];
    private JFileChooser filePromptDialog = null;

    private ButtonGroup printCBGroup;
    private final JRadioButton[] printModeCBs = new JRadioButton[3];

    /// Status bar
    private final LabelV2 statusBar;

    private final int[] fontStyles  = {Font.PLAIN, Font.BOLD, Font.ITALIC, Font.BOLD | Font.ITALIC};
    ...
    private void setupFontList(int rangeStart, int rangeEnd) {
        ...
        for (int i = 0; i < listCount; i++) {
            ...
            fontMenu.setBit(i, (rm.getSelectedIndex() != RangeMenu.SURROGATES_AREA_INDEX) &&
            ...
            do {
                ...
                if ( nextEscape != -1 ) {
                    if ( prevEscapeEnd < nextEscape )
                        converted.append(oneLine, prevEscapeEnd, nextEscape);
                    ...
                    try {
                        ...
                        converted.append(oneLine, nextEscape, copyLimit);
                    }
                }
            } while (nextEscape != -1);
            if ( prevEscapeEnd < lineLength )
              converted.append(oneLine, prevEscapeEnd, lineLength);
    ...
    private void readTextFile( String fileName ) {
        try {
            ...
            if (numBytes >= 2 &&
              ...
              fileText = new String( byteData, StandardCharsets.UTF_16);
    ...
    private void updateGUI() {
        ...
        userTextDialog.setVisible(selectedText == fp.USER_TEXT);
    ...
    public void actionPerformed( ActionEvent e ) {
        ...
        if (source instanceof JMenuItem mi) {
        ...
        else if (source instanceof JTextField tf) {
            float sz = 12f;
            try {
        ...
        else if (source instanceof JComboBox<?> c) {
    ...
    public void itemStateChanged( ItemEvent e ) {
        ...
        if (source instanceof JCheckBoxMenuItem cbmi) {
    ...
    private final class ChoiceV2Renderer extends DefaultListCellRenderer {
        ...
        private final ImageIcon yesImage;
