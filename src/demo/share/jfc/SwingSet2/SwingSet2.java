...
public class SwingSet2 extends JPanel {
    ...
    // List of demos
    private final ArrayList<DemoModule> demosList = new ArrayList<DemoModule>();
    ...
    // Box spacers
    private final Dimension HGAP = new Dimension(1,5);
    private final Dimension VGAP = new Dimension(5,1);
    ...
    private final ButtonGroup audioMenuGroup = new ButtonGroup();
    ...
    private static final Vector<SwingSet2> swingSets = new Vector<SwingSet2>();
    ...
    void loadDemo(String classname) {
        ...
        try {
            ...
            Constructor<?> demoConstructor = demoClass.getConstructor(SwingSet2.class);
