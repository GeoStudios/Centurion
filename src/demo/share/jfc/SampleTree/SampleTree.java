...
/*
    ...
    class AddAction implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            if (parent == null) {
                // new root
                treeModel.setRoot(createNewNode("Added " + addCount++));
            } else {
                int newIndex;
                if (lastItem == null) {
                ...
                treeModel.insertNodeInto(createNewNode("Added " + addCount++),
                        parent, newIndex);
            }
        }
    ...
    class InsertAction implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            if (parent == null) {
                // new root
                treeModel.setRoot(createNewNode("Inserted " + insertCount++));
            } else {
                int newIndex;
                ...
                /* Let the treemodel know. */
                treeModel.insertNodeInto(createNewNode("Inserted " + insertCount++),
                        parent, newIndex);
            }
        }
