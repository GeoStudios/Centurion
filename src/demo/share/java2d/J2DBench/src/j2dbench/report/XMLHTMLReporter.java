...
public class XMLHTMLReporter {
                                                        ...
                                                        double targetScore)
    {
        ...
        String buffer = "<TR BGCOLOR=\"" + color[selColorIndex] + "\">" +
                "<TD><P><A HREF=\"testcases/" + fileName +
                "\">" + testName + "</A></P></TD>" +
        ...
        int nSame, int nWorse)
    {
        ...
        String buffer = "<TR>" +
                "<TD><P><A HREF=\"#test_result_" + curGroupName +
                "\">" + testName + "</A></P></TD>" +
                "<TD BGCOLOR=\"#99FF99\" align=\"center\"><P>" +
                "<A HREF=\"#test_result_" + curGroupName +
                "\"><B>" + nBetter + "</A></B>&nbsp;&nbsp;&nbsp;&nbsp;(" +
                (nBetter * 100) / totalTests + "%)</P></TD>" +
                "<TD BGCOLOR=\"#CCFFFF\" align=\"center\"><P>" +
                "<A HREF=\"#test_result_" + curGroupName +
                "\"><B>" + nSame + "</A></B>&nbsp;&nbsp;&nbsp;&nbsp;(" +
                (nSame * 100) / totalTests + "%)</P></TD>" +
                "<TD BGCOLOR=\"#FFCC00\" align=\"center\"><P>" +
                "<A HREF=\"#test_result_" + curGroupName +
                "\"><B>" + nWorse + "</A></B>&nbsp;&nbsp;&nbsp;&nbsp;(" +
    ...
    private static String getPerformanceTableForTestcase(
        ...
        String buffer = "<hr size=\"1\">" +
                ...
                nBetter + "</B></A></P></TD>" +
                "<TD align=\"center\"><P>" + (nBetter * 100 / totalTests) +
                "</P></TD>" +
                "</TR>" +
                "<TR BGCOLOR=\"#CCFFFF\">" +
                "<TD><P><A HREF=\"#same\">" +
                ...
                nSame + "</B></A></P></TD>" +
                "<TD align=\"center\"><P>" + (nSame * 100 / totalTests) +
                "</P></TD>" +
                "</TR>" +
                "<TR BGCOLOR=\"#FFCC00\">" +
                "<TD><P><A HREF=\"#worse\">" +
                ...
                nWorse + "</B></A></P></TD>" +
                "<TD align=\"center\"><P>" + (nWorse * 100 / totalTests) +
                "</P></TD>" +
                "</TR>" +
                "</TABLE>";
