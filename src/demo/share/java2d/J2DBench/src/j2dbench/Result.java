...
public class Result {
    ...
    public static void init() {
        ...
        Integer[] workObjects = {
                Integer.valueOf(WORK_UNITS),
                Integer.valueOf(WORK_THOUSANDS),
                Integer.valueOf(WORK_MILLIONS),
                Integer.valueOf(WORK_AUTO),
                Integer.valueOf(WORK_OPS | WORK_UNITS),
                Integer.valueOf(WORK_OPS | WORK_THOUSANDS),
                Integer.valueOf(WORK_OPS | WORK_MILLIONS),
                Integer.valueOf(WORK_OPS | WORK_AUTO),
        };
        ...
        Integer[] timeObjects = {
                Integer.valueOf(TIME_SECONDS),
                Integer.valueOf(TIME_MILLIS),
                Integer.valueOf(TIME_MICROS),
                Integer.valueOf(TIME_NANOS),
                Integer.valueOf(TIME_AUTO),
        };
    ...
    static {
        unitMap = new HashMap();
        unitMap.put("U", Integer.valueOf(WORK_UNITS));
        unitMap.put("M", Integer.valueOf(WORK_MILLIONS));
        unitMap.put("K", Integer.valueOf(WORK_THOUSANDS));
        unitMap.put("A", Integer.valueOf(WORK_AUTO));
        unitMap.put("MU", Integer.valueOf(WORK_MILLIONS));
        unitMap.put("KU", Integer.valueOf(WORK_THOUSANDS));
        unitMap.put("AU", Integer.valueOf(WORK_AUTO));

        unitMap.put("O", Integer.valueOf(WORK_UNITS | WORK_OPS));
        unitMap.put("NO", Integer.valueOf(WORK_UNITS | WORK_OPS));
        unitMap.put("MO", Integer.valueOf(WORK_MILLIONS | WORK_OPS));
        unitMap.put("KO", Integer.valueOf(WORK_THOUSANDS | WORK_OPS));
        unitMap.put("AO", Integer.valueOf(WORK_AUTO | WORK_OPS));

        unitMap.put("s", Integer.valueOf(TIME_SECONDS));
        unitMap.put("m", Integer.valueOf(TIME_MILLIS));
        unitMap.put("u", Integer.valueOf(TIME_MICROS));
        unitMap.put("n", Integer.valueOf(TIME_NANOS));
        unitMap.put("a", Integer.valueOf(TIME_AUTO));
    }
    ...
    public void addTime(long time) {
        ...
        times.addElement(Long.valueOf(time));
    }
