...
public class HotSpotNmethod extends HotSpotInstalledCode {
    ...
    private boolean checkArgs(Object... args) {
        ...
        for (int i = 0; i < sig.length; i++) {
            ...
            } else assert sig[i].getJavaKind() == JavaKind.Object || sig[i].getJavaKind().toBoxedJavaClass() == arg.getClass() : method.format("%H.%n(%p): expected arg ") + i + " to be " + sig[i] + ", not " + arg.getClass();
        }
        return true;
    }
