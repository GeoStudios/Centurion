...
public class FontEditor extends Panel implements java.beans.PropertyEditor {
    ...
    public FontEditor() {
        ...
        for (int i = 0; i < pointSizes.length; i++) {
            sizeChoser.addItem(String.valueOf(pointSizes[i]));
        }
        add(sizeChoser);
    ...
    private final String sampleText = "Abcde...";

    private Label sample;
    private final Choice familyChoser;
    private final Choice styleChoser;
    private final Choice sizeChoser;

    private final String[] fonts;
    private final String[] styleNames = { "plain", "bold", "italic" };
    private final int[] styles = { Font.PLAIN, Font.BOLD, Font.ITALIC };
    private final int[] pointSizes = { 3, 5, 8, 10, 12, 14, 18, 24, 36, 48 };
