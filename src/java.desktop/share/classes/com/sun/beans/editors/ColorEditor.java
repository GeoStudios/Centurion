...
public class ColorEditor extends Panel implements PropertyEditor {
    ...
    private final String[] colorNames = { " ", "white", "lightGray", "gray", "darkGray",
                        ...
                        "blue"};
    private final Color[] colors = { null, Color.white, Color.lightGray, Color.gray, Color.darkGray,
                        Color.black, Color.red, Color.pink, Color.orange,
                        Color.yellow, Color.green, Color.magenta, Color.cyan,
                        Color.blue};

    private final Canvas sample;
    private final int sampleHeight = 20;
    private final int sampleWidth = 40;
    private final int hPad = 5;
    private int ourWidth;

    private Color color;
    private final TextField text;
    private final Choice choser;
