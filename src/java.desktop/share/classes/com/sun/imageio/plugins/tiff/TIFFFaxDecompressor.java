...
class TIFFFaxDecompressor extends TIFFDecompressor {
    ...
    private static final short[] additionalMakeup = {
    ...
    private static final short[] initBlack = {
        // 0 - 7
    ...
    //
    private static final short[] twoBitBlack = {292, 260, 226, 226};   // 0 - 3
    ...
    private static final byte[] twoDCodes = {
        // 0 - 7
