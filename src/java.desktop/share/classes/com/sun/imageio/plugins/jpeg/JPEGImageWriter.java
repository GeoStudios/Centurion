...
public class JPEGImageWriter extends ImageWriter {
    ...
    private final ColorConvertOp convertOp = null;
    ...
    private void writeOnThread(IIOMetadata streamMetadata,
        ...
        if (sof != null) {
            for (int i = 0; i < numBandsUsed; i++) {
                if (!forceJFIF) {  // else use JFIF-compatible default
    ...
    private final CallBackLock cbLock = new CallBackLock();
