...
public class TIFFRenderedImage implements RenderedImage {
    ...
    private final ImageReadParam tileParam;

    private final int subsampleX;
    private final int subsampleY;

    private final boolean isSubsampling;
    ...
    private final ImageTypeSpecifier its;
