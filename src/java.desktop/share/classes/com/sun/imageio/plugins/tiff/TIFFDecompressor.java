...
public abstract class TIFFDecompressor {
    ...
    private static boolean isDataBufferBitContiguous(SampleModel sm,
        ...
        if(sm instanceof ComponentSampleModel) {
            ...
            return dataTypeSize % mppsm.getPixelBitStride() == 0;
    ...
    public static ImageTypeSpecifier
        ...
        if (samplesPerPixel == 2 &&
            ...
            boolean alphaPremultiplied = extraSamples != null &&
                    extraSamples[0] ==
                ...
                if(isDataTypeSet) {
                    ...
                    if(samplesPerPixel >= 1 && samplesPerPixel <= 4 &&
                       (dataType == DataBuffer.TYPE_INT ||
                        ...
                        boolean alphaPremultiplied = hasAlpha && extraSamples != null &&
                                extraSamples[0] ==
                                        BaselineTIFFTagSet.EXTRA_SAMPLES_ASSOCIATED_ALPHA;
    ...
    public void beginDecoding() {
        ...
        this.isContiguous = this.isBilevel || ImageUtil.imageIsContiguous(this.image);
                   ...
                   BaselineTIFFTagSet.SAMPLE_FORMAT_SIGNED_INTEGER) {
                    for (int j = 0; j < dstHeight; j++) {
                        ...
                        for (int i = 0; i < dstWidth; i++) {
                            ...
                            float x1 = shortData[idx + 1];
                            float x2 = shortData[idx + 2];
