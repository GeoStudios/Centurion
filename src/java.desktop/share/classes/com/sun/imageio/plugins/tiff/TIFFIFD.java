...
public class TIFFIFD extends TIFFDirectory {
    ...
    private boolean calculateByteCounts(int expectedSize,
        ...
        if (tw <= w && h % th != 0) {
            ...
            packetByteCounts[numPackets - 1] = (long) numRowsInLastStrip *bytesPerRow;
        }
        ...
        for (int i = 0; i < numEntries; i++) {
            ...
            if (tag == null) {
                ...
                if (expectedCount > 0) {
                    ...
                    if ((long) count *asciiSize > MAX_ASCII_SIZE) {
    ...
    public void writeToStream(ImageOutputStream stream)
        ...
        long nextSpace = stream.getStreamPosition() + 12L *numFields + 4;
