...
public class TIFFYCbCrDecompressor extends TIFFDecompressor {
    ...
    private final float codingRangeY = 255.0f;

    private final int[] iYTab = new int[256];
    private final int[] iCbTab = new int[256];
    private final int[] iCrTab = new int[256];

    private final int[] iGYTab = new int[256];
    private final int[] iGCbTab = new int[256];
    private final int[] iGCrTab = new int[256];
    ...
    private final TIFFDecompressor decompressor;
