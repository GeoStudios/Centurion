        ...
        while (!done) {
            ...
            case JPEG.APP0:
                ...
                if ((buf[ptr+3] == 'J')
                    ...
                    } else if (!markerSequence.isEmpty()) {
                        throw new IIOException
            ...
            if (sof != null) {
                ...
                if (hadAlpha != wantAlpha) {
                    if (wantAlpha) {  // Adding alpha
                        ...
                        System.arraycopy(sof.componentSpecs, 0, newSpecs, 0, sof.componentSpecs.length);
                        ...
                        System.arraycopy(sos.componentSpecs, 0, newScanSpecs, 0, sos.componentSpecs.length);
                        ...
                        SOFMarkerSegment.ComponentSpec [] newSpecs =
                            new SOFMarkerSegment.ComponentSpec[numChannels];
                        System.arraycopy(sof.componentSpecs, 0, newSpecs, 0, numChannels);
                        sof.componentSpecs = newSpecs;

                        // Remove a component spec from SOS
                        SOSMarkerSegment.ScanComponentSpec [] newScanSpecs =
                            new SOSMarkerSegment.ScanComponentSpec [numChannels];
                        System.arraycopy(sos.componentSpecs, 0, newScanSpecs, 0, numChannels);
                        sos.componentSpecs = newScanSpecs;
                    }
                }
            }
