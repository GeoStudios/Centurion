...
public class BMPMetadata extends IIOMetadata implements BMPConstants {
    ...
    protected IIOMetadataNode getStandardChromaNode() {
        ...
        if ((palette != null) && (paletteSize > 0)) {
            ...
            int numComps = palette.length / paletteSize;
            subNode.setAttribute("value", String.valueOf(numComps));

            for (int i = 0, j = 0; i < paletteSize; i++) {
                IIOMetadataNode subNode1 = new IIOMetadataNode("PaletteEntry");
                subNode1.setAttribute("index", String.valueOf(i));
                subNode1.setAttribute("red", String.valueOf(palette[j++]));
                subNode1.setAttribute("green", String.valueOf(palette[j++]));
                subNode1.setAttribute("blue", String.valueOf(palette[j++]));
                if (numComps == 4 && palette[j] != 0)
                    subNode1.setAttribute("alpha", String.valueOf(palette[j++]));
    ...
    protected IIOMetadataNode getStandardDimensionNode() {
        if (yPixelsPerMeter > 0.0F && xPixelsPerMeter > 0.0F) {
            ...
            subNode.setAttribute("value", String.valueOf(ratio));
            node.appendChild(subNode);

            subNode = new IIOMetadataNode("HorizontalPhysicalPixelSpacing");
            subNode.setAttribute("value", String.valueOf(1000.0F / xPixelsPerMeter));
            node.appendChild(subNode);

            subNode = new IIOMetadataNode("VerticalPhysicalPixelSpacing");
            subNode.setAttribute("value", String.valueOf(1000.0F / yPixelsPerMeter));
            node.appendChild(subNode);
