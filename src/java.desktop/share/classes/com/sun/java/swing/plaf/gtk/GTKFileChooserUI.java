...
class GTKFileChooserUI extends SynthFileChooserUI {
    ...
    private static final Dimension PREF_SIZE = new Dimension(435, 360);
    ...
    private final GTKFileView fileView = new GTKFileView();
    private PropertyChangeListener gtkFCPropertyChangeListener;
    private final Action approveSelectionAction = new GTKApproveSelectionAction();
