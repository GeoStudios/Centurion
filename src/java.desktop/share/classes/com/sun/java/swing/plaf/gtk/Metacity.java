...
class Metacity implements SynthConstants {
    ...
    private final Map<String, Map<String, Object>> frameGeometries;

    private final LayoutManager titlePaneLayout = new TitlePaneLayout();

    private final ColorizeImageFilter imageFilter = new ColorizeImageFilter();
    private URL themeDir = null;
    private SynthContext context;
    private final String themeName;

    private final ArithmeticExpressionEvaluator aee = new ArithmeticExpressionEvaluator();
    ...
    private static class Privileged implements PrivilegedAction<Object> {
        ...
        private static final int GET_USER_THEME = 1;
        ...
        public Object run() {
            if (type == GET_THEME_DIR) {
                ...
                try {
                    ...
                    Reader reader = new InputStreamReader(url.openStream(), StandardCharsets.ISO_8859_1);
