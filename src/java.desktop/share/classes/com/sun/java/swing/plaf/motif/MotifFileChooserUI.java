...
public class MotifFileChooserUI extends BasicFileChooserUI {
    ...
    private static final Dimension prefListSize = new Dimension(75, 150);

    private static final Dimension WITH_ACCELERATOR_PREF_SIZE = new Dimension(650, 450);
    private static final Dimension PREF_SIZE = new Dimension(350, 450);
    private static final int MIN_WIDTH = 200;
    private static final int MIN_HEIGHT = 300;
    private static final Dimension PREF_ACC_SIZE = new Dimension(10, 10);
    private static final Dimension ZERO_ACC_SIZE = new Dimension(1, 1);
