...
public class TIFFTagSet {
    ...
    private final SortedMap<Integer,TIFFTag> allowedTagsByNumber = new TreeMap<Integer,TIFFTag>();

    private final SortedMap<String,TIFFTag> allowedTagsByName = new TreeMap<String,TIFFTag>();
