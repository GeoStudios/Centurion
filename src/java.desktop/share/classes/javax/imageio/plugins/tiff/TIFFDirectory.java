...
public class TIFFDirectory implements Cloneable {
     ...
     */
    private final TIFFField[] lowFields = new TIFFField[MAX_LOW_FIELD_TAG_NUM + 1];
     ...
     */
    private final Map<Integer,TIFFField> highFields = new TreeMap<Integer,TIFFField>();
    ...
    public TIFFDirectory(TIFFTagSet[] tagSets, TIFFTag parentTag) {
        ...
        this.tagSets.addAll(Arrays.asList(tagSets).subList(0, numTagSets));
