                                              ...
                                              TransferHandler.HasGetTransferHandler
{
     ...
     */
    private static final java.util.List<Rectangle> tempRectangles = new java.util.ArrayList<Rectangle>(11);
    ...
    private static final Object componentObtainingGraphicsFromLock = new
    ...
    static final sun.awt.RequestFocusController focusController =
        new sun.awt.RequestFocusController() {
            ...
            {
                if ((to == null) || !(to instanceof JComponent target)) {
                    return true;
                }

                if ((from == null) || !(from instanceof JComponent jFocusOwner)) {
                    return true;
                }
       ...
       implements AccessibleExtendedComponent
    {
         ...
         */
        private final transient int propertyListenersCount = 0;
