...
public class BasicDesktopPaneUI extends DesktopPaneUI {
    ...
    private static class Actions extends UIAction {
        ...
        private static final String SHRINK_LEFT = "shrinkLeft";
        private static final String SHRINK_RIGHT = "shrinkRight";
        private static final String SHRINK_UP = "shrinkUp";
        private static final String SHRINK_DOWN = "shrinkDown";
        private static final String NEXT_FRAME = "selectNextFrame";
        private static final String PREVIOUS_FRAME = "selectPreviousFrame";
        private static final String NAVIGATE_NEXT = "navigateNext";
        private static final String NAVIGATE_PREVIOUS = "navigatePrevious";
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            if (CLOSE == key || MAXIMIZE == key || MINIMIZE == key ||
                ...
                boolean moveForward = NAVIGATE_PREVIOUS != key;
                Container cycleRoot = dp.getFocusCycleRootAncestor();

                if (cycleRoot != null) {
                    FocusTraversalPolicy policy =
                        cycleRoot.getFocusTraversalPolicy();
                    if (policy != null && policy instanceof SortingFocusTraversalPolicy sPolicy) {
