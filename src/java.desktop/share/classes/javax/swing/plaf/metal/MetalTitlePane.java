...
class MetalTitlePane extends JComponent {
    ...
    private final Color activeBumpsHighlight = MetalLookAndFeel.getPrimaryControlHighlight();
    private final Color activeBumpsShadow = MetalLookAndFeel.getPrimaryControlDarkShadow();
    private Color activeBackground = null;
    private Color activeForeground = null;
    private Color activeShadow = null;

    // Bumps
    private final MetalBumps activeBumps
        = new MetalBumps( 0, 0,
                          activeBumpsHighlight,
                          activeBumpsShadow,
                          MetalLookAndFeel.getPrimaryControl() );
    private final MetalBumps inactiveBumps
        = new MetalBumps( 0, 0,
