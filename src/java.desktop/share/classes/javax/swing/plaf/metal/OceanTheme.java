...
public class OceanTheme extends DefaultMetalTheme {
    ...
    public void addCustomEntriesToTable(UIDefaults table) {
        ...
        java.util.List<?> buttonGradient = Arrays.asList(
                Float.valueOf(.3f), Float.valueOf(0f),
        ...
        java.util.List<?> sliderGradient = Arrays.asList(Float.valueOf(.3f), Float.valueOf(.2f),
        ...
        Object[] defaults = new Object[] {
            ...
            "MenuBar.gradient", Arrays.asList(Float.valueOf(1f), Float.valueOf(0f),
                getWhite(), dadada,
