...
class SynthMenuItemLayoutHelper extends MenuItemLayoutHelper {
    ...
    private final SynthContext context;
    private final SynthContext accContext;
    private final SynthStyle style;
    private final SynthStyle accStyle;
    private final SynthGraphicsUtils gu;
    private final SynthGraphicsUtils accGu;
    private final boolean alignAcceleratorText;
