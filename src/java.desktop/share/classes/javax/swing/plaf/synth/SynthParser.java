...
class SynthParser extends DefaultHandler {
     ...
     */
    private final List<ParsedSynthStyle.StateInfo> _stateInfos;
     ...
     */
    private final List<String> _inputMapBindings;
     ...
     */
    private final Map<String,Object> _mapping;
     ...
     */
    private final List<ColorType> _colorTypes;
     ...
     */
    private final List<ParsedSynthStyle.PainterInfo> _stylePainters;

    /**
     * List of SynthStyle.Painters that will be applied to the current state.
     */
    private final List<ParsedSynthStyle.PainterInfo> _statePainters;
        ...
        if (_style != null) {
            ...
            for(int i = attributes.getLength() - 1; i >= 0; i--) {
                ...
                if (key.equals(ATTRIBUTE_VALUE)) {
                    _style.setOpaque("true".equalsIgnoreCase(attributes.getValue(i)));
                }
            }
        }
    }
