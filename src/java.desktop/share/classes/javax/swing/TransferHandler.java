...
public class TransferHandler implements Serializable {
    ...
    public boolean importData(TransferSupport support) {
        return support.getComponent() instanceof JComponent && importData((JComponent) support.getComponent(), support.getTransferable());
    }
    ...
    public boolean canImport(TransferSupport support) {
        return support.getComponent() instanceof JComponent && canImport((JComponent) support.getComponent(), support.getDataFlavors());
    }
    ...
    static class TransferAction extends UIAction implements UIResource {
         ...
         */
        private static final Object SandboxClipboardKey = new Object();
