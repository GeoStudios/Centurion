...
class WaitDispatchSupport implements SecondaryLoop {
    ...
    private final Conditional extCondition;
    ...
    private final AtomicBoolean keepBlockingEDT = new AtomicBoolean(false);
    private final AtomicBoolean keepBlockingCT = new AtomicBoolean(false);
    private final AtomicBoolean afterExit = new AtomicBoolean(false);
