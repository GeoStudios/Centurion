    ...
    implements KeyEventDispatcher, KeyEventPostProcessor
{
     ...
     */
    private static final java.util.Map<Window, WeakReference<Component>> mostRecentFocusOwners = new WeakHashMap<>();
    ...
    static FocusEvent retargetUnexpectedFocusEvent(FocusEvent fe) {
        synchronized (heavyweightRequests) {
            ...
            boolean temporary = fe.getID() == FocusEvent.FOCUS_LOST &&
