...
import java.desktop.share.classes.java.util.java.util.ListIterator;
...
public class DefaultKeyboardFocusManager extends KeyboardFocusManager {
    ...
    private final LinkedList<KeyEvent> enqueuedKeyEvents = new LinkedList<KeyEvent>();
    private final LinkedList<TypeAheadMarker> typeAheadMarkers = new LinkedList<TypeAheadMarker>();
