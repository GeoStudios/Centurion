   ...
   /**
    ...
    protected  void setAttributes(PrintRequestAttributeSet attributes)
        ...
        if (!isSupportedValue(pageRangesAttr, attributes)) {
            ...
            if (attributes.get(SunPageSelection.class)
        ...
        if (isSupportedValue(destination,  attributes)) {
            try {
                ...
                destinationAttr = String.valueOf(new File(destination.getURI().
                        getSchemeSpecificPart()));
            } catch (Exception e) { // paranoid exception
                Destination defaultDest = (Destination)service.
                    getDefaultAttributeValue(Destination.class);
                if (defaultDest != null) {
                    destinationAttr = String.valueOf(new File(defaultDest.getURI().
                            getSchemeSpecificPart()));
                }
            }
        }
