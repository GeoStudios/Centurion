...
public interface DrawImagePipe {
    ...
    boolean copyImage(SunGraphics2D sg, Image img,
                             int x, int y,
                             Color bgColor,
    ...
    boolean scaleImage(SunGraphics2D sg, Image img, int x, int y,
                              int width, int height,
                              Color bgColor,
                              ImageObserver observer);

    boolean scaleImage(SunGraphics2D sg, Image img,
                              int dx1, int dy1, int dx2, int dy2,
                              int sx1, int sy1, int sx2, int sy2,
                              Color bgColor,
                              ImageObserver observer);

    boolean transformImage(SunGraphics2D sg, Image img,
