...
public abstract class SunFontManager implements FontSupport, FontManagerForSGE {
    ...
    private static final Font2DHandle FONT_HANDLE_NULL = new Font2DHandle(null);
    ...
    private final CompositeFont [] compFonts = new CompositeFont[20];
    private final ConcurrentHashMap<String, CompositeFont>
        compositeFonts = new ConcurrentHashMap<>();
    private final ConcurrentHashMap<String, PhysicalFont>
    ...
    private final boolean loaded1dot0Fonts = false;
    ...
    public PhysicalFont registerFontFile(String fileName,
        ...
        try {
            ...
            if (FontUtilities.isLogging()) {
                FontUtilities.logInfo("Unusable font: " + fileName + " " + ffe);
            }
        }
        if (physicalFont != null &&
    ...
    private final ConcurrentHashMap<String, Font2D> fontNameCache =
...
//      REMIND: case compare depends on platform
    ...
    public String[] getInstalledFontFamilyNames(Locale requestedLocale) {
        ...
        if (allFamilies != null && requestedLocale.equals(lastDefaultLocale)) {
