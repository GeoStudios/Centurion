...
public interface FontManager {
     ...
     */
    Font2D findFont2D(String name, int style, int fallback);
     ...
     */
    Font2D[] createFont2D(File fontFile, int fontFormat, boolean all,
     ...
     */
    Font2DHandle getNewComposite(String family, int style,
                                        Font2DHandle handle);
