...
public class CompositeFontDescriptor {
    ...
    private final int coreComponentCount;
    private final String[] componentFaceNames;
    private final String[] componentFileNames;
    private final int[] exclusionRanges;
    private final int[] exclusionRangeLimits;
