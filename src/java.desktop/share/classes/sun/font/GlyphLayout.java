...
public final class GlyphLayout {
    ...
    public interface LayoutEngineFactory {
         ...
         */
        LayoutEngine getEngine(Font2D font, int script, int lang);

        /**
         * Given a key, determine a layout engine to use.
         */
        LayoutEngine getEngine(LayoutEngineKey key);
    }
    ...
    public interface LayoutEngine {
         ...
         */
        void layout(FontStrikeDesc sd, float[] mat, float ptSize, int gmask,
