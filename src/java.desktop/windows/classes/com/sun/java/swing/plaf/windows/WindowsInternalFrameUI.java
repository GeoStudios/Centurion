...
public class WindowsInternalFrameUI extends BasicInternalFrameUI
{
    ...
    private class XPBorder extends AbstractBorder {
        private final Skin leftSkin   = xp.getSkin(frame, Part.WP_FRAMELEFT);
        private final Skin rightSkin  = xp.getSkin(frame, Part.WP_FRAMERIGHT);
        private final Skin bottomSkin = xp.getSkin(frame, Part.WP_FRAMEBOTTOM);
