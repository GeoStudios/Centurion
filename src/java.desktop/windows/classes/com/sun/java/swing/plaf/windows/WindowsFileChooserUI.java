...
public class WindowsFileChooserUI extends BasicFileChooserUI {
    ...
    private static final int PREF_WIDTH = 425;
    private static final int PREF_HEIGHT = 245;
    private static final Dimension PREF_SIZE = new Dimension(PREF_WIDTH, PREF_HEIGHT);

    private static final int MIN_WIDTH = 425;
    private static final int MIN_HEIGHT = 245;

    private static final int LIST_PREF_WIDTH = 444;
    private static final int LIST_PREF_HEIGHT = 138;
    ...
    private final BasicFileView fileView = new WindowsFileView();
