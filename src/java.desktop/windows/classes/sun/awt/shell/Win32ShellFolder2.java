...
final class Win32ShellFolder2 extends ShellFolder {
    ...
    private final Image smallIcon = null;
    private final Image largeIcon = null;
    ...
    public boolean equals(Object o) {
        if (o == null || !(o instanceof Win32ShellFolder2 rhs)) {
    ...
    private static final Map<Integer, Image> largeSystemImages = new HashMap<>();
    private static final Map<Integer, Image> smallLinkedSystemImages = new HashMap<>();
    private static final Map<Integer, Image> largeLinkedSystemImages = new HashMap<>();
