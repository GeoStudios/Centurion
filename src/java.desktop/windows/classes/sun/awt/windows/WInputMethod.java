...
final class WInputMethod extends InputMethodAdapter
{
    ...
    private int context;
    private final boolean open; //default open status;
    private final int cmode;    //default conversion mode;
    ...
    private static final Map<TextAttribute,Object> [] highlightStyles;
