...
public final class WFontConfiguration extends FontConfiguration {
    ...
    private final boolean useCompatibilityFallbacks;
...
//      reorderMap.put("windows-1252", "alphabetic");
    ...
    private static final HashMap<String, String> subsetCharsetMap = new HashMap<>();
    private static final HashMap<String, String> subsetEncodingMap = new HashMap<>();
