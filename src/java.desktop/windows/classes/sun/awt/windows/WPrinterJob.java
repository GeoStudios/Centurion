...
/* Instance Variables */
    ...
    // tells GDI that we can handle our own collation and multiple copies
     ...
     private final boolean userRequestedCollation = false;
     private final boolean noDefaultPrinter = false;
    ...
    private final java.awt.peer.ComponentPeer dialogOwnerPeer = null;

    private int graphicsMode;
    private final double[] worldTransform = new double[6];
...
/* Instance Methods */
    ...
    protected void setTextColor(Color color) {
        ...
        /* We only need to select a brush if the color has changed.
        */
        if (!color.equals(mLastTextColor)) {
    ...
    protected void drawDIBImage(byte[] image,
        ...
        if (icm != null) {
            ...
            for (int i=0;i<icm.getMapSize(); i++) {
                bmiColors[i * 4]=(byte)(icm.getBlue(i)&0xff);
