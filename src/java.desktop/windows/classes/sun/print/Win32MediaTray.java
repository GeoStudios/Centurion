...
public class Win32MediaTray extends MediaTray {
    ...
    private static final ArrayList<Win32MediaTray> winEnumTable = new ArrayList<>();
    public int winID;
    ...
    protected String[] getStringTable() {
      ArrayList<String> completeList = new ArrayList<>();
        Collections.addAll(completeList, myStringTable);
    ...
    protected EnumSyntax[] getEnumValueTable() {
      ArrayList<MediaTray> completeList = new ArrayList<>();
        Collections.addAll(completeList, myEnumValueTable);
