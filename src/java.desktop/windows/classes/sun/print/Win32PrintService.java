...
public class Win32PrintService implements PrintService, AttributeUpdater,
    ...
    // from wingdi.h
    private static final int DM_PAPERSIZE = 0x2;
    private static final int DM_PRINTQUALITY = 0x400;
    private static final int DM_YRESOLUTION = 0x2000;
    ...
    public MediaTray findMediaTray(int dmBin) {
        ...
        if (trays != null) {
            for (int i=0;i<trays.length;i++) {
                if(trays[i] instanceof Win32MediaTray win32Tray) {
    ...
    */
    ...
    public Class<?>[] getSupportedAttributeCategories() {
        ...
        Collections.addAll(categList, otherAttrCats);
    ...
    private boolean isPostScriptFlavor(DocFlavor flavor) {
        return flavor.equals(DocFlavor.BYTE_ARRAY.POSTSCRIPT) ||
    ...
    public boolean isAttributeValueSupported(Attribute attr,
        ...
        if (!isAttributeCategorySupported(category)) {
            ...
            return attr != OrientationRequested.REVERSE_PORTRAIT &&
                    ((flavor == null) ||
                            (flavor.equals(DocFlavor.SERVICE_FORMATTED.PAGEABLE) ||
                                    flavor.equals(DocFlavor.SERVICE_FORMATTED.PRINTABLE) ||
                                    flavor.equals(DocFlavor.INPUT_STREAM.GIF) ||
            ...
            return (isColorSup || (attr != ColorSupported.SUPPORTED)) &&
    ...
    private final Win32DocumentPropertiesUI docPropertiesUI = null;
    ...
    private static class Win32DocumentPropertiesUI
        ...
        public PrintRequestAttributeSet
            ...
            if (!(job instanceof WPrinterJob wJob)) {
                return null;
            }
...
class Win32MediaSize extends MediaSizeName {
    private static final ArrayList<String> winStringTable = new ArrayList<>();
    private static final ArrayList<Win32MediaSize> winEnumTable = new ArrayList<>();
