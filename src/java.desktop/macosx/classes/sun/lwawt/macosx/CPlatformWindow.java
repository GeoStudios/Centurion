...
public class CPlatformWindow extends CFRetainedResource implements PlatformWindow {
    ...
    static ClientPropertyApplicator<JRootPane, CPlatformWindow> CLIENT_PROPERTY_APPLICATOR = new ClientPropertyApplicator<JRootPane, CPlatformWindow>(new Property<CPlatformWindow>(WINDOW_DOCUMENT_MODIFIED) { public void applyProperty(final CPlatformWindow c, final Object value) {
        c.setStyleBits(DOCUMENT_MODIFIED, value != null && Boolean.parseBoolean(value.toString()));
    }},
            ...
            new Property<CPlatformWindow>(WINDOW_SHADOW) { public void applyProperty(final CPlatformWindow c, final Object value) {
                c.setStyleBits(HAS_SHADOW, value == null || Boolean.parseBoolean(value.toString()));
            }},
            ...
            new Property<CPlatformWindow>(WINDOW_TITLE_VISIBLE) {
                public void applyProperty(final CPlatformWindow c, final Object value) {
                    c.setStyleBits(TITLE_VISIBLE, value == null || Boolean.parseBoolean(value.toString()));
                }
            }) {
    ...
    protected int getInitialStyleBits() {
        ...
        {
            this.undecorated = isFrame ? ((Frame)target).isUndecorated() : (!isDialog || ((Dialog) target).isUndecorated());
        ...
        {
            final boolean resizable = isFrame ? ((Frame)target).isResizable() : (isDialog && ((Dialog) target).isResizable());
    ...
    public void setVisible(boolean visible) {
        ...
        if (visible) {
            ...
            **/
            ...
            (target instanceof Dialog && ((Dialog) target).isResizable());
            if (resizable) {
    ...
    public void setOpaque(boolean isOpaque) {
        ...
        boolean isTextured = peer != null && peer.isTextured();
        if (!isTextured) {
            if (!isOpaque) {
