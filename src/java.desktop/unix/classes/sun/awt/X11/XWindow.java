...
class XWindow extends XBaseWindow implements X11ComponentPeer {
    ...
    private static final PlatformLogger insLog = PlatformLogger.getLogger("sun.awt.X11.insets.XWindow");
    private static final PlatformLogger eventLog = PlatformLogger.getLogger("sun.awt.X11.event.XWindow");
    private static final PlatformLogger focusLog = PlatformLogger.getLogger("sun.awt.X11.focus.XWindow");
    private static final PlatformLogger keyEventLog = PlatformLogger.getLogger("sun.awt.X11.kye.XWindow");
   ...
   */
    ...
    private static final int JAWT_LOCK_ERROR=0x00000001;
    private static final int JAWT_LOCK_CLIP_CHANGED=0x00000002;
    private static final int JAWT_LOCK_BOUNDS_CHANGED=0x00000004;
    private static final int JAWT_LOCK_SURFACE_CHANGED=0x00000008;
    private final int drawState = JAWT_LOCK_CLIP_CHANGED |
...
//  }
    ...
    */
...

    {
        ...
        kea.setPrimaryLevelUnicode(ke, unicodeFromPrimaryKeysym);
        kea.setExtendedKeyCode(ke, extendedKeyCode);
