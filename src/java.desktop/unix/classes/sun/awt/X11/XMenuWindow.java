...
public class XMenuWindow extends XBaseMenuWindow {
    ...
    private static final PlatformLogger log = PlatformLogger.getLogger("sun.awt.X11.XMenuWindow");
    ...
    static class MappingData extends XBaseMenuWindow.MappingData {
         ...
         * of all item's text
         */
        private final int leftMarkWidth;

        /**
         * Left origin of all shortcut labels
         */
        private final int shortcutOrigin;

        /**
         * The origin of right mark
         * (submenu's arrow)
         */
        private final int rightMarkOrigin;
