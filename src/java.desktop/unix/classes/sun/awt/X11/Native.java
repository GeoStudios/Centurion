...
class Native {
    ...
    static void putShort(long ptr, int index, short data) {
        putShort(ptr + (long) index *getShortSize(), data);
    }
    ...
    static void putUShort(long ptr, int index, int data) {
        putUShort(ptr + (long) index *getShortSize(), data);
    }
    ...
    static int getInt(long ptr, int index) { return getInt(ptr + (long) getIntSize() *index); }
    /**
    ...
    static void putInt(long ptr, int index, int data) {
        putInt(ptr + (long) index *getIntSize(), data);
    }
    ...
    static long getUInt(long ptr, int index) { return getUInt(ptr + (long) getIntSize() *index); }
    /**
    ...
    static void putUInt(long ptr, int index, long data) {
        putUInt(ptr + (long) index *getIntSize(), data);
    }
    ...
    static void putLong(long ptr, int index, long data) {
        putLong(ptr+ (long) index *getLongSize(), data);
    }
    ...
    static long getLong(long ptr, int index) {
        return getLong(ptr + (long) index *getLongSize());
    }
    /**
    ...
    static long getWindow(long ptr, int index) {
        return getLong(ptr + (long) getWindowSize() *index);
    }
