...
/* EWMH */
    ...
    static void initAtoms() {
        ...
        long atoms = unsafe.allocateMemory((long) names.length *atomSize);
        XToolkit.awtLock();
        try {
...
//                            getIntProperty(XToolkit.getDefaultRootWindow(), XAtom.XA_CARDINAL)) == 0);
    ...
    private static final XErrorHandler detectWMHandler = new XErrorHandler.XBaseErrorHandler() {
        @Override
 ...
 * Protocols support
 */
    private final HashMap<Class<?>, Collection<?>> protocolsMap = new HashMap<Class<?>, Collection<?>>();
    /**
...
\*****************************************************************************/
    ...
    boolean isStateChange(XDecoratedPeer window, XPropertyEvent e) {
        ...
        boolean is_state_change = e.get_atom() == XA_WM_STATE.getAtom();
