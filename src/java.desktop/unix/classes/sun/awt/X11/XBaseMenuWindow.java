...
public abstract class XBaseMenuWindow extends XWindow {
    ...
    private static final PlatformLogger log = PlatformLogger.getLogger("sun.awt.X11.XBaseMenuWindow");
     ...
     */
    private static final Object menuTreeLock = new Object();
    ...
    private final AppContext disposeAppContext;
    ...
    static class MappingData implements Cloneable {
         ...
         */
        private final XMenuItemPeer[] items;
