...
final class ListHelper implements XScrollbarClient {
    ...
    private final java.util.List<String> items;        // List of items

    // TODO: maybe this would be better as a simple int[]
    private final java.util.List<Integer> selected;     // List of selected items
    private boolean multiSelect;         // Can multiple items be selected
                                         // at once?
    private int focusedIndex;

    private final int maxVisItems;             // # items visible without a vsb
    ...
    private final XWindow peer;   // So far, only needed for painting
                            // on notifyValue()
    ...
    */
    ...
    int lastDisplayedIndex() {
        ...
        assert !hsbVis : "Implement for horiz scroll bar";
