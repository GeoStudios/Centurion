...
//          }
    ...
    final class XAWTScrollBarButton extends BasicArrowButton {
        ...
        private final UIDefaults uidefaults = XToolkit.getUIDefaults();
        private final Color darkShadow = SystemColor.controlShadow;
        private final Color lightShadow = SystemColor.controlLtHighlight;
        private final Color buttonBack = uidefaults.getColor("ScrollBar.track");
    ...
    static class BevelBorder extends AbstractBorder implements UIResource {
        ...
        private final Color control = SystemColor.controlShadow;
