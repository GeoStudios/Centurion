...
public abstract class XErrorHandler {
    ...
    public static class IgnoreBadWindowHandler extends XBaseErrorHandler {
        ...
        // Shared instance
        private static final IgnoreBadWindowHandler theInstance = new IgnoreBadWindowHandler();
    ...
    public static class VerifyChangePropertyHandler extends XBaseErrorHandler {
        ...
        // Shared instance
        private static final VerifyChangePropertyHandler theInstance = new VerifyChangePropertyHandler();
