...
public interface  XMSelectionListener {
    ...
    */
   void ownerChanged(int screen, XMSelection sel, long newOwner, long data, long timestamp);
   ...
   void selectionChanged(int screen, XMSelection sel, long owner, XPropertyEvent event);
