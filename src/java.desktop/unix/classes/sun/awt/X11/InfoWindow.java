...
public abstract class InfoWindow extends Window {
    ...
    public static class Balloon extends InfoWindow {
        ...
        private final Panel captionPanel = new Panel();
        private final Label captionLabel = new Label("");
        private final Button closeButton = new Button("X");
        private final Panel textPanel = new Panel();
        private final XTrayIconPeer.IconCanvas iconCanvas = new XTrayIconPeer.IconCanvas(BALLOON_ICON_WIDTH, BALLOON_ICON_HEIGHT);
        private final Label[] lineLabels = new Label[BALLOON_WORD_LINE_MAX_COUNT];
