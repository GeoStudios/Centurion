...
abstract class XScrollbar {
    ...
    private static final PlatformLogger log = PlatformLogger.getLogger("sun.awt.X11.XScrollbar");
    /**
     ...
     */
    private final XScrollRepeater i_scroller = new XScrollRepeater(null);
    ...
    private int line;
    private int page;
    private final boolean needsRepaint = true;
...
//              }
    ...
    boolean isInArrow(int x, int y) {
        ...
        return coord < arrAreaH || coord > barLength - arrAreaH + 1;
    }
