...
class XFramePeer extends XDecoratedPeer implements FramePeer {
    ...
    private static final PlatformLogger stateLog = PlatformLogger.getLogger("sun.awt.X11.states");
    private static final PlatformLogger insLog = PlatformLogger.getLogger("sun.awt.X11.insets.XFramePeer");
