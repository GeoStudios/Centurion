...
public class UnixPrintJob implements CancelablePrintJob {
    ...
    public void print(Doc doc, PrintRequestAttributeSet attributes)
        ...
        try {
            ...
            throw new PrintException("can't get print data: " + e);
        }
    ...
    private void getAttributeValues(DocFlavor flavor) throws PrintException {
        ...
        fidelity = reqAttrSet.get(Fidelity.class) == Fidelity.FIDELITY_TRUE;
    ...
    private static final int DESTPRINTER = 1;
