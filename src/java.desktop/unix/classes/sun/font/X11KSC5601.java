...
public class X11KSC5601 extends Charset {
    ...
    private class Encoder extends CharsetEncoder {
        private final DoubleByte.Encoder enc = (DoubleByte.Encoder)new EUC_KR().newEncoder();
    ...
    private class Decoder extends  CharsetDecoder {
        private final DoubleByte.Decoder dec = (DoubleByte.Decoder)new EUC_KR().newDecoder();
