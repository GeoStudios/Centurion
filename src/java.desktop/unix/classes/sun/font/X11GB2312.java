...
public class X11GB2312 extends Charset {
    ...
    private class Encoder extends CharsetEncoder {
        private final DoubleByte.Encoder enc = (DoubleByte.Encoder)new EUC_CN().newEncoder();
    ...
    private class Decoder extends  CharsetDecoder {
        private final DoubleByte.Decoder dec = (DoubleByte.Decoder)new EUC_CN().newDecoder();
