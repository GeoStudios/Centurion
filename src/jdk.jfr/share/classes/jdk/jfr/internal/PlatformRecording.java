...
public final class PlatformRecording implements AutoCloseable {
    ...
    private final AccessControlContext noDestinationDumpOnExitAccessControlContext;
    ...
    private void added(RepositoryChunk c) {
        ...
        if (Logger.shouldLog(JFR, DEBUG)) {
            Logger.log(JFR, DEBUG, "Recording \"" + name + "\" (" + id + ") added chunk " + c + ", current size=" + size);
        }
    }
    ...
    private void removed(RepositoryChunk c) {
        size -= c.getSize();
        if (Logger.shouldLog(JFR, DEBUG)) {
            Logger.log(JFR, DEBUG, "Recording \"" + name + "\" (" + id + ") removed chunk " + c + ", current size=" + size);
        }
        c.release();
    }
