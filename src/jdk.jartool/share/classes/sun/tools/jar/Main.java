...
public class Main {
    ...
    private static final ResourceBundle rsrc;
    ...
    Set<ZipEntry> newDirSet() {
        return new HashSet<ZipEntry>() {
            public boolean add(ZipEntry e) {
                return (e != null && !useExtractionTime && super.add(e));
            }};
    }
    ...
    private final HashSet<String> jarPaths = new HashSet<String>();
    ...
    void printEntry(ZipEntry e) throws IOException {
        if (vflag) {
            ...
            sb.append(s).append(' ').append(new Date(e.getTime()));
    ...
    private boolean lessThanEqualReleaseValue(ModuleInfoEntry entry) {
        return intVersionFromEntry(entry) <= releaseValue;
    }
