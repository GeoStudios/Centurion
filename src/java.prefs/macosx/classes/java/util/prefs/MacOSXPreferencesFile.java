...
class MacOSXPreferencesFile {
    ...
    private static final long cfCurrentUser = currentUser();
    private static final long cfAnyUser = anyUser();
    private static final long cfCurrentHost = currentHost();
    private static final long cfAnyHost = anyHost();
