...
import jdk.hotspot.agent.share.classes.sun.jvm.hotspot.c1.*;
import jdk.hotspot.agent.share.classes.sun.jvm.hotspot.code.*;
...
public class VM {
  ...
  private static final List<Observer> vmInitializedObservers = new ArrayList<>();
  private final List<Observer> vmResumedObservers   = new ArrayList<>();
  private final List<Observer> vmSuspendedObservers = new ArrayList<>();
  private final TypeDataBase db;
  private final boolean      isBigEndian;
  /** This is only present if in a debugging system */
  private final JVMDebugger  debugger;
  private final long         logAddressSize;
  ...
  private final boolean      isJvmtiSupported;
  ...
  private final int          minObjAlignmentInBytes;
  private final int          logMinObjAlignmentInBytes;
  private final int          heapWordSize;
  private final int          heapOopSize;
  ...
  private final int          reserveForAllocationPrefetch;
  ...
  private final String       vmInternalInfo;
  ...
  private VM(TypeDataBase db, JVMDebugger debugger, boolean isBigEndian) {
    ...
    // We infer the presence of JVMTI from the presence of the InstanceKlass::_breakpoints field.
    {
      Type type = db.lookupType("InstanceKlass");
        isJvmtiSupported = type.getField("_breakpoints", false, false) != null;
    }
  ...
  private void readSystemProperties() {
    ...
    systemKls.iterateStaticFields(new DefaultOopVisitor() {
        final ObjectReader objReader = new ObjectReader();
