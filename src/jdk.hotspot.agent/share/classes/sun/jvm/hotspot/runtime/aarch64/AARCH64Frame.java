...
public class AARCH64Frame extends Frame {
  ...
  // Entry frames
  private static final int ENTRY_FRAME_CALL_WRAPPER_OFFSET = -8;

  // Native frames
  private static final int NATIVE_FRAME_INITIAL_PARAM_OFFSET =  2;

  private static final VMReg fp = new VMReg(29);
  ...
  public boolean equals(Object arg) {
    ...
    if (!(arg instanceof AARCH64Frame other)) {
      return false;
    }
  ...
  public boolean isInterpretedFrameValid() {
    ...
    return getFP().minus(getSP()) <= 4096 * VM.getVM().getAddressSize();
  }
