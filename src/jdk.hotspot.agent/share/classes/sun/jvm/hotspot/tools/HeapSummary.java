...
public class HeapSummary extends Tool {
   ...
   public void run() {
      ...
      if (heap instanceof GenCollectedHeap genHeap) {
      ...
      } else if (heap instanceof ParallelScavengeHeap psh) {
      ...
      } else if (heap instanceof ShenandoahHeap sh) {
      ...
      } else if (heap instanceof EpsilonHeap eh) {
         printSpace(eh.space());
      } else if (heap instanceof ZCollectedHeap zheap) {
