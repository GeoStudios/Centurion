...
public interface DebugVC50TypeIterator {
  ...
  int getNumericLengthAt(int byteOffset)
  ...
  int getNumericIntAt(int byteOffset)
    throws DebugVC50WrongNumericTypeException;
  ...
  long getNumericLongAt(int byteOffset)
    throws DebugVC50WrongNumericTypeException;
  ...
  float getNumericFloatAt(int byteOffset)
    throws DebugVC50WrongNumericTypeException;
  ...
  double getNumericDoubleAt(int byteOffset)
    throws DebugVC50WrongNumericTypeException;
