...
public class BsdDebuggerLocal extends DebuggerBase implements BsdDebugger {
    ...
    private final boolean isDarwin;             // variant for bsd
    ...
    interface WorkerThreadTask {
       void doit(BsdDebuggerLocal debugger) throws DebuggerException;
    }
    ...
    private void findABIVersion() throws DebuggerException {
        ...
        // old C++ ABI
        // new C++ ABI
        useGCC32ABI = lookupByName0(libjvmName, javaThreadVt) == 0;
    }
