...
public interface BsdDebugger extends JVMDebugger {
  ...
  BsdAddress readAddress(long address) throws DebuggerException;
  BsdAddress readCompOopAddress(long address) throws DebuggerException;
  BsdAddress readCompKlassAddress(long address) throws DebuggerException;
  BsdOopHandle readOopHandle(long address) throws DebuggerException;
  BsdOopHandle readCompOopHandle(long address) throws DebuggerException;
