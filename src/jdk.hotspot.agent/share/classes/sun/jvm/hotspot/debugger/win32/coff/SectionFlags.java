...
public interface SectionFlags {
  ...
  /** Reserved for future use. */
  int IMAGE_SCN_TYPE_DSECT = 0x00000001;

  /** Reserved for future use. */
  int IMAGE_SCN_TYPE_NOLOAD = 0x00000002;

  /** Reserved for future use. */
  int IMAGE_SCN_TYPE_GROUP = 0x00000004;
  ...
  /** Reserved for future use. */
  int IMAGE_SCN_TYPE_COPY = 0x00000010;
  ...
  /** Reserved for future use. */
  int IMAGE_SCN_TYPE_OVER = 0x00000400;
  ...
  /** Reserved for future use. */
  int IMAGE_SCN_MEM_FARDATA = 0x00008000;
