...
public class ELFFileParser {
    ...
    class ELFFileImpl implements ELFFile {
        ...
        private final byte[] ident = new byte[16];
...
//            }
        ...
        class ELFSectionHeaderImpl implements ELFSectionHeader {
            ...
            private final int type;                         // Elf32_Word
            /** Flags. */
            private final long flags;                        // Elf32_Word
            ...
            private final int link;                         // Elf32_Word
            /** Extra information determined by the section type. */
            private final int info;                         // Elf32_Word
...
//        }
        ...
        class ELFSymbolImpl implements ELFSymbol {
            ...
            private final byte other;                         // unsigned char
...
//                return symbol;
        ...
        int unsignedByte(short arg) {
            ...
            if (arg >= 0) {
                ...
                val = ((int)unsignedByte((byte)(arg >>> 8)) << 8) |
                            ((byte)arg);
            }
            return val;
        }
        ...
        long unsignedByte(int arg) {
            ...
            if (arg >= 0) {
                ...
                val = ((long)unsignedByte((short)(arg >>> 16)) << 16) |
                             ((short)arg);
            }
            return val;
        }
        ...
        int unsignedByteSwap(short arg) {
            return (((int)unsignedByte((byte)arg)) << 8) |
                         ((int)unsignedByte((byte)(arg >>> 8)));
        }

        long unsignedByteSwap(int arg) {
            return (((long)unsignedByteSwap((short)arg)) << 16) |
