...
public interface TypeIndicators {
  ...
  short IMAGE_REL_I386_ABSOLUTE = 0x0000;
  /** Not supported. */
  short IMAGE_REL_I386_DIR16 = (short) 0x0001;
  /** Not supported. */
  short IMAGE_REL_I386_REL16 = (short) 0x0002;
  /** The target?s 32-bit virtual address. */
  short IMAGE_REL_I386_DIR32 = (short) 0x0006;
  /** The target?s 32-bit relative virtual address. */
  short IMAGE_REL_I386_DIR32NB = (short) 0x0007;
  /** Not supported. */
  short IMAGE_REL_I386_SEG12 = (short) 0x0009;
  /** The 16-bit-section index of the section containing the
      target. This is used to support debugging information. */
  short IMAGE_REL_I386_SECTION = (short) 0x000A;
  ...
  /** This relocation is ignored. */
  short IMAGE_REL_MIPS_ABSOLUTE = (short) 0x0000;
  /** The high 16 bits of the target's 32-bit virtual address. */
  short IMAGE_REL_MIPS_REFHALF = (short) 0x0001;
  /** The target's 32-bit virtual address. */
  short IMAGE_REL_MIPS_REFWORD = (short) 0x0002;
  /** The low 26 bits of the target's virtual address. This
      supports the MIPS J and JAL instructions. */
  short IMAGE_REL_MIPS_JMPADDR = (short) 0x0003;
  ...
  short IMAGE_REL_MIPS_SECRELHI = (short) 0x000D;
  /** The low 26 bits of the target's virtual address. This supports
      the MIPS16 JAL instruction. */
  short IMAGE_REL_MIPS_JMPADDR16 = (short) 0x0010;
  /** The target's 32-bit relative virtual address. */
  short IMAGE_REL_MIPS_REFWORDNB = (short) 0x0022;
  ...
  short IMAGE_REL_MIPS_PAIR = (short) 0x0025;
  ...
  /** This relocation is ignored. */
  short IMAGE_REL_ALPHA_ABSOLUTE = (short) 0x0000;
  ...
  short IMAGE_REL_ALPHA_REFLONG = (short) 0x0001;
  /** The target's 64-bit virtual address. */
  short IMAGE_REL_ALPHA_REFQUAD = (short) 0x0002;
  /** 32-bit signed displacement of the target relative to the Global
      Pointer (GP) register. */
  short IMAGE_REL_ALPHA_GPREL32 = (short) 0x0003;
  /** 16-bit signed displacement of the target relative to the Global
      Pointer (GP) register. */
  short IMAGE_REL_ALPHA_LITERAL = (short) 0x0004;
  /** Reserved for future use. */
  short IMAGE_REL_ALPHA_LITUSE = (short) 0x0005;
  /** Reserved for future use. */
  short IMAGE_REL_ALPHA_GPDISP = (short) 0x0006;
  /** The 21-bit relative displacement to the target. This supports
      the Alpha relative branch instructions. */
  short IMAGE_REL_ALPHA_BRADDR = (short) 0x0007;
  /** 14-bit hints to the processor for the target of an Alpha jump
      instruction. */
  short IMAGE_REL_ALPHA_HINT = (short) 0x0008;
  ...
  short IMAGE_REL_ALPHA_INLINE_REFLONG = (short) 0x0009;
  /** The high 16 bits of the target's 32-bit virtual address. Used
      for the first instruction in a two-instruction sequence that
      loads a full address. This relocation must be immediately
      followed by a PAIR relocations whose SymbolTableIndex contains a
      signed 16-bit displacement which is added to the upper 16 bits
      taken from the location being relocated. */
  short IMAGE_REL_ALPHA_REFHI = (short) 0x000A;
  /** The low 16 bits of the target's virtual address. */
  short IMAGE_REL_ALPHA_REFLO = (short) 0x000B;
  /** This relocation is only valid when it immediately follows a
      REFHI , REFQ3, REFQ2, or SECRELHI relocation. Its
      SymbolTableIndex contains a displacement and not an index into
      the symbol table. */
  short IMAGE_REL_ALPHA_PAIR = (short) 0x000C;
  ...
  short IMAGE_REL_ALPHA_MATCH = (short) 0x000D;
  /** The 16-bit section index of the section containing the target.
      This is used to support debugging information. */
  short IMAGE_REL_ALPHA_SECTION = (short) 0x000E;
  /** The 32-bit offset of the target from the beginning of its
      section. This is used to support debugging information as well
      as static thread local storage. */
  short IMAGE_REL_ALPHA_SECREL = (short) 0x000F;
  /** The target's 32-bit relative virtual address. */
  short IMAGE_REL_ALPHA_REFLONGNB = (short) 0x0010;
  /** The low 16 bits of the 32-bit offset of the target from the
      beginning of its section. */
  short IMAGE_REL_ALPHA_SECRELLO = (short) 0x0011;
  /** The high 16 bits of the 32-bit offset of the target from the
      beginning of its section. A PAIR relocation must immediately
      follow this on. The SymbolTableIndex of the PAIR relocation
      contains a signed 16-bit displacement which is added to the
      upper 16 bits taken from the location being relocated. */
  short IMAGE_REL_ALPHA_SECRELHI = (short) 0x0012;
  ...
  short IMAGE_REL_ALPHA_REFQ3 = (short) 0x0013;
  ...
  /** This relocation is ignored. */
  short IMAGE_REL_PPC_ABSOLUTE = (short) 0x0000;
  /** The target's 64-bit virtual address. */
  short IMAGE_REL_PPC_ADDR64 = (short) 0x0001;
  /** The target's 32-bit virtual address. */
  short IMAGE_REL_PPC_ADDR32 = (short) 0x0002;
  ...
  short IMAGE_REL_PPC_ADDR24 = (short) 0x0003;
  /** The low 16 bits of the target's virtual address. */
  short IMAGE_REL_PPC_ADDR16 = (short) 0x0004;
  /** The low 14 bits of the target's virtual address. This is only
      valid when the target symbol is absolute and can be sign
      extended to its original value. */
  short IMAGE_REL_PPC_ADDR14 = (short) 0x0005;
  /** A 24-bit PC-relative offset to the symbol's location. */
  short IMAGE_REL_PPC_REL24 = (short) 0x0006;
  /** A 14-bit PC-relative offset to the symbol's location. */
  short IMAGE_REL_PPC_REL14 = (short) 0x0007;
  /** The target's 32-bit relative virtual address. */
  short IMAGE_REL_PPC_ADDR32NB = (short) 0x000A;
  /** The 32-bit offset of the target from the beginning of its
      section. This is used to support debugging information as well
      as static thread local storage. */
  short IMAGE_REL_PPC_SECREL = (short) 0x000B;
  /** The 16-bit section index of the section containing the target.
      This is used to support debugging information. */
  short IMAGE_REL_PPC_SECTION = (short) 0x000C;
  /** The 16-bit offset of the target from the beginning of its
      section. This is used to support debugging information as well
      as static thread local storage. */
  short IMAGE_REL_PPC_SECREL16 = (short) 0x000F;
  /** The high 16 bits of the target's 32-bit virtual address. Used
      for the first instruction in a two-instruction sequence that
      loads a full address. This relocation must be immediately
      followed by a PAIR relocations whose SymbolTableIndex contains a
      signed 16-bit displacement which is added to the upper 16 bits
      taken from the location being relocated. */
  short IMAGE_REL_PPC_REFHI = (short) 0x0010;
  /** The low 16 bits of the target's virtual address. */
  short IMAGE_REL_PPC_REFLO = (short) 0x0011;
  /** This relocation is only valid when it immediately follows a
      REFHI or SECRELHI relocation. Its SymbolTableIndex contains a
      displacement and not an index into the symbol table. */
  short IMAGE_REL_PPC_PAIR = (short) 0x0012;
  /** The low 16 bits of the 32-bit offset of the target from the
      beginning of its section. */
  short IMAGE_REL_PPC_SECRELLO = (short) 0x0013;
  /** The high 16 bits of the 32-bit offset of the target from the
      beginning of its section. A PAIR relocation must immediately
      follow this on. The SymbolTableIndex of the PAIR relocation
      contains a signed 16-bit displacement which is added to the
      upper 16 bits taken from the location being relocated. */
  short IMAGE_REL_PPC_SECRELHI = (short) 0x0014;
  /** 16-bit signed displacement of the target relative to the Global
      Pointer (GP) register. */
  short IMAGE_REL_PPC_GPREL = (short) 0x0015;
  ...
  /** This relocation is ignored. */
  short IMAGE_REL_ARM_ABSOLUTE = (short) 0x0000;
  /** The target's 32-bit virtual address. */
  short IMAGE_REL_ARM_ADDR32 = (short) 0x0001;
  /** The target's 32-bit relative virtual address. */
  short IMAGE_REL_ARM_ADDR32NB = (short) 0x0002;
  /** The 24-bit relative displacement to the target.  */
  short IMAGE_REL_ARM_BRANCH24 = (short) 0x0003;
  /** Reference to a subroutine call, consisting of two 16-bit
      instructions with 11-bit offsets. */
  short IMAGE_REL_ARM_BRANCH11 = (short) 0x0004;
  /** The 16-bit section index of the section containing the target.
      This is used to support debugging information. */
  short IMAGE_REL_ARM_SECTION = (short) 0x000E;
  /** The 32-bit offset of the target from the beginning of its
      section. This is used to support debugging information as well
      as static thread local storage. */
  short IMAGE_REL_ARM_SECREL = (short) 0x000F;
}
