...
public interface Address {
  ...
  long       getCIntegerAt      (long offset, long numBytes, boolean isUnsigned)
  ...
  /** This returns null if the address at the given offset is NULL. */
  OopHandle  getOopHandleAt     (long offset)
    throws UnmappedAddressException, UnalignedAddressException, NotInHeapException;
  OopHandle  getCompOopHandleAt (long offset)
    throws UnmappedAddressException, UnalignedAddressException, NotInHeapException;
  ...
  void       setJBooleanAt      (long offset, boolean value)
    throws UnmappedAddressException, UnalignedAddressException;
  void       setJByteAt         (long offset, byte value)
    throws UnmappedAddressException, UnalignedAddressException;
  void       setJCharAt         (long offset, char value)
    throws UnmappedAddressException, UnalignedAddressException;
  void       setJDoubleAt       (long offset, double value)
    throws UnmappedAddressException, UnalignedAddressException;
  void       setJFloatAt        (long offset, float value)
    throws UnmappedAddressException, UnalignedAddressException;
  void       setJIntAt          (long offset, int value)
    throws UnmappedAddressException, UnalignedAddressException;
  void       setJLongAt         (long offset, long value)
    throws UnmappedAddressException, UnalignedAddressException;
  void       setJShortAt        (long offset, short value)
    throws UnmappedAddressException, UnalignedAddressException;
  void       setOopHandleAt     (long offset, OopHandle value)
    throws UnmappedAddressException, UnalignedAddressException;
  ...
  /** This throws an UnsupportedOperationException if this address happens
      ...
      subtraction case. */
  Address    addOffsetTo        (long offset) throws UnsupportedOperationException;
  ...
  OopHandle  addOffsetToAsOopHandle(long offset) throws UnsupportedOperationException;
  ...
  Address    andWithMask(long mask) throws UnsupportedOperationException;
  ...
  /** This throws an UnsupportedOperationException if this address happens
      ...
      of the Address and the mask are aligned) and returns the result
      as an Address. Returns null if the result was zero. */
  Address    orWithMask(long mask) throws UnsupportedOperationException;
  ...
  /** This throws an UnsupportedOperationException if this address happens
      ...
      zero. */
  Address    xorWithMask(long mask) throws UnsupportedOperationException;
