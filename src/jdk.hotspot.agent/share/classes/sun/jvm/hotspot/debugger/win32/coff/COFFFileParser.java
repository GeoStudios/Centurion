...
public class COFFFileParser {
  ...
  class COFFFileImpl implements COFFFile {
    ...
    private final MemoizedObject header = new MemoizedObject() {
    ...
    class COFFHeaderImpl implements COFFHeader {
      ...
      private final MemoizedObject[] sectionHeaders;
      private final MemoizedObject[] symbols;

      // Init stringTable at decl time since other fields init'ed in the
      // constructor need the String Table.
      private final MemoizedObject stringTable = new MemoizedObject() {
          public Object computeValue() {
      ...
      class OptionalHeaderImpl implements OptionalHeader {
        ...
        private final MemoizedObject standardFields;
        private final MemoizedObject windowsSpecificFields;
        private final MemoizedObject dataDirectories;
      ...
      class OptionalHeaderDataDirectoriesImpl implements OptionalHeaderDataDirectories {
        private final int numberOfRvaAndSizes;
        private final MemoizedObject[] dataDirectories;
        private final MemoizedObject   exportDirectoryTable;
        private final MemoizedObject   debugDirectory;
      ...
      class ExportDirectoryTableImpl implements ExportDirectoryTable {
        private final int exportDataDirRVA;
        private final int offset;
        private final int size;

        private final int exportFlags;
        private final int timeDateStamp;
        private final short majorVersion;
        private final short minorVersion;
        private final int nameRVA;
        private final int ordinalBase;
        private final int addressTableEntries;
        private final int numberOfNamePointers;
        private final int exportAddressTableRVA;
        private final int namePointerTableRVA;
        private final int ordinalTableRVA;

        private final MemoizedObject dllName;

        private final MemoizedObject exportNameTable;
        private final MemoizedObject exportNamePointerTable;
        private final MemoizedObject exportOrdinalTable;
        private final MemoizedObject exportAddressTable;
      ...
      class ExportNameTable {
        private final MemoizedObject[] names;
      ...
      class DebugDirectoryEntryImpl implements DebugDirectoryEntry, DebugTypes {
        ...
        private final int addressOfRawData;
      ...
      class DebugVC50Impl implements DebugVC50, DebugVC50TypeLeafIndices {
        private final int lfaBase;

        private final int subsectionDirectoryOffset;
        private final MemoizedObject subsectionDirectory;
        ...
        class DebugVC50SubsectionDirectoryImpl
          ...
          private final int   offset;
          private final short dirHeaderLength;
          private final short dirEntryLength;
          private final int   numEntries;
        ...
        class DebugVC50SubsectionImpl implements DebugVC50Subsection {
          private final short ssType;
          private final short iMod;
        ...
        class DebugVC50SSModuleImpl extends DebugVC50SubsectionImpl implements DebugVC50SSModule {
          private final int offset;
          private final short ovlNumber;
          private final short iLib;
          private final short cSeg;
          private final short style;
          private final MemoizedObject segInfo;
          private final MemoizedObject name;
        ...
        class DebugVC50SSSrcModuleImpl extends DebugVC50SubsectionImpl implements DebugVC50SSSrcModule {
          private final int offset;
          private final short cFile;
          private final short cSeg;
          private final MemoizedObject baseSrcFiles;
          private final MemoizedObject segOffsets;
          private final MemoizedObject segs;
        ...
        class DebugVC50SrcModFileDescImpl implements DebugVC50SrcModFileDesc {
          private final short cSeg;
          private final MemoizedObject baseSrcLn;
          private final MemoizedObject segOffsets;
          private final MemoizedObject name;
        ...
        class DebugVC50SrcModLineNumberMapImpl implements DebugVC50SrcModLineNumberMap {
          private final short seg;
          private final short cPair;
          private final MemoizedObject offsets;
          private final MemoizedObject lineNumbers;
        ...
        class DebugVC50SSSymbolBaseImpl extends DebugVC50SubsectionImpl implements DebugVC50SSSymbolBase {
          private final int   offset;
          private final short symHash;
          private final short addrHash;
          private final int   cbSymbol;
          private final int   cbSymHash;
          private final int   cbAddrHash;
        ...
        class DebugVC50SSSegMapImpl extends DebugVC50SubsectionImpl implements DebugVC50SSSegMap {
          private final short cSeg;
          private final short cSegLog;
          private final MemoizedObject segDescs;
        ...
        class DebugVC50SegDescImpl implements DebugVC50SegDesc {
          ...
          private final short ovl;
          private final short group;
          private final short frame;
          private final short iSegName;
          private final short iClassName;
          private int   offset;
          private final int   cbSeg;
        ...
        class DebugVC50SSFileIndexImpl extends DebugVC50SubsectionImpl implements DebugVC50SSFileIndex {
          private final int offset;
          private final short cMod; // Number of modules in the executable
          private final short cRef; // Total number of file name references
          private final MemoizedObject modStart;
          private final MemoizedObject cRefCnt;
          // FIXME: probably useless; needs fixup to be converted into
          // indices rather than offsets
          private final MemoizedObject nameRef;
          private final MemoizedObject names;
        ...
        class DebugVC50TypeIteratorImpl implements DebugVC50TypeIterator,
          ...
          private final DebugVC50SSGlobalTypes parent;
          private final int   base;
      ...
      class SectionHeaderImpl implements SectionHeader {
        ...
        private final int    characteristics;
        private final MemoizedObject[] relocations;
        private final MemoizedObject[] lineNumbers;
      ...
      class COFFSymbolImpl implements COFFSymbol, COFFSymbolConstants {
        ...
        private final byte   numberOfAuxSymbols;
        private final MemoizedObject auxFunctionDefinitionRecord = new MemoizedObject() {
            public Object computeValue() {
              return new AuxFunctionDefinitionRecordImpl(offset + SYMBOL_SIZE);
            }
          };
        private final MemoizedObject auxBfEfRecord = new MemoizedObject() {
            public Object computeValue() {
              return new AuxBfEfRecordImpl(offset + SYMBOL_SIZE);
            }
          };
        private final MemoizedObject auxWeakExternalRecord = new MemoizedObject() {
            public Object computeValue() {
              return new AuxWeakExternalRecordImpl(offset + SYMBOL_SIZE);
            }
          };
        private final MemoizedObject auxFileRecord = new MemoizedObject() {
            public Object computeValue() {
              return new AuxFileRecordImpl(offset + SYMBOL_SIZE);
            }
          };
        private final MemoizedObject auxSectionDefinitionsRecord = new MemoizedObject() {
            public Object computeValue() {
      ...
      class AuxFunctionDefinitionRecordImpl implements AuxFunctionDefinitionRecord {
        ...
        private final int pointerToLineNumber;
        private final int pointerToNextFunction;
