...
public interface TypeDataBase {
  ...
  Type lookupType(String cTypeName);
  ...
  /** For simplicity of the initial implementation, this is not
      ...
      not found. */
  Type lookupType(String cTypeName, boolean throwException);

  /** Equivalent to lookupIntConstant(constantName, true) */
  Integer lookupIntConstant(String constantName);
  ...
  /* For convenience, this interface also encapsulates the fetching of
     ...
     returns null. */
  Integer lookupIntConstant(String constantName, boolean throwException);

  /** Equivalent to lookupLongConstant(constantName, true) */
  Long lookupLongConstant(String constantName);
  ...
  Long lookupLongConstant(String constantName, boolean throwException);
