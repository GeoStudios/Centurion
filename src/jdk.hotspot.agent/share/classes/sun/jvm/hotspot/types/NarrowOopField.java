...
public interface NarrowOopField extends OopField {
  ...
  OopHandle getValue(Address addr)     throws UnmappedAddressException, UnalignedAddressException, WrongTypeException;

  /** The field must be static and the type of the field must be an
      oop type, or a WrongTypeException will be thrown. */
  OopHandle getValue()                 throws UnmappedAddressException, UnalignedAddressException, WrongTypeException;
}
