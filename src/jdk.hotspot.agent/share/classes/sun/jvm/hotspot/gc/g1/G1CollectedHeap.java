...
import jdk.hotspot.agent.share.classes.sun.jvm.hotspot.gc.g1.HeapRegionClosure;
import jdk.hotspot.agent.share.classes.sun.jvm.hotspot.gc.g1.PrintRegionClosure;
...
public class G1CollectedHeap extends CollectedHeap {
    ...
    public HeapRegionManager hrm() {
        ...
        return VMObjectFactory.newObject(HeapRegionManager.class,
                                                             hrmAddr);
    }

    public G1MonitoringSupport g1mm() {
        Address g1mmAddr = g1mmField.getValue(addr);
        return VMObjectFactory.newObject(G1MonitoringSupport.class, g1mmAddr);
    }

    public HeapRegionSetBase oldSet() {
        Address oldSetAddr = addr.addOffsetTo(oldSetFieldOffset);
        return VMObjectFactory.newObject(HeapRegionSetBase.class,
                                                             oldSetAddr);
    }
