...
public class Bytecodes {
    ...
    case _tableswitch:
      {
        ...
        int lo = method.getBytecodeIntArg(alignedBCI + jintSize);
  ...
  private static final String[]    _wide_format;
  private static final int[]       _result_type;
  private static final byte[]      _depth;
  private static final byte[]      _lengths;
  private static final int[]       _java_code;
  private static final char[]      _flags;
