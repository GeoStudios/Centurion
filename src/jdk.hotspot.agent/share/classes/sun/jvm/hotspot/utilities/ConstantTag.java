...
public class ConstantTag {
  ...
  private static final int JVM_REF_getField                = 1;
  private static final int JVM_REF_getStatic               = 2;
  private static final int JVM_REF_putField                = 3;
  private static final int JVM_REF_putStatic               = 4;
  private static final int JVM_REF_invokeVirtual           = 5;
  private static final int JVM_REF_invokeStatic            = 6;
  private static final int JVM_REF_invokeSpecial           = 7;
  private static final int JVM_REF_newInvokeSpecial        = 8;
  private static final int JVM_REF_invokeInterface         = 9;
