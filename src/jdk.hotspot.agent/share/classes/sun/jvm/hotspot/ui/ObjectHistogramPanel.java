...
public class ObjectHistogramPanel extends JPanel implements ActionListener {
    private final ObjectHistogramTableModel dataModel;
    private final ObjectHistogramToolBar toolbar;
    ...
    private class ObjectHistogramTableModel extends SortableTableModel<ObjectHistogramElement> {
        private final String[] columnNames = { "Size", "Count", "Class Description" };
        private final Class[] columnClasses = { Long.class, Long.class, String.class };
    ...
    public interface Listener {
        void showObjectsOfType(Klass type);
    }
