...
public class HTMLGenerator implements /* imports */ ClassConstants {
      ...
      try {
         ...
         disasm.decode(new BytecodeVisitor() {
                          ...
                          public void visit(Bytecode instr) {
                             ...
                             if (instr instanceof BytecodeNew newBytecode) {
                             ...
                             } else if (instr instanceof BytecodeInvoke invokeBytecode) {
                             ...
                             } else if (instr instanceof BytecodeGetPut getPut) {
                             ...
                             } else if (instr instanceof BytecodeLoadConstant ldc) {
   ...
   class HTMLDisassembler implements InstructionVisitor {
      ...
      private final Formatter buf;
      private final SymbolFinder symFinder = createSymbolFinder();
      private long pc;
      private ImmutableOopMapSet oms;
      private final CodeBlob blob;
        ...
        for (int i = 0; i < length; i++) {
            ...
            if (klass instanceof InstanceKlass) {
                ...
                if (klass instanceof TypeArrayKlass) {
                    ...
                    } else if (elobj instanceof TypeArrayKlass elkls) {
   ...
   protected String genHTMLForOopMap(ImmutableOopMap map) {
      ...
      final class OopMapValueIterator {
         Formatter iterate(OopMapStream oms, String type, boolean printContentReg) {
            Formatter tmpBuf = new Formatter(genHTML);
            boolean found = false;
            tmpBuf.beginTag("tr");
            tmpBuf.beginTag("td");
   ...
   protected String genHTMLListForFields(InstanceKlass klass) {
      ...
      if (numFields != 0) {
         ...
         for (int f = 0; f < numFields; f++) {
           ...
           String f_name = field.getID().getName();
