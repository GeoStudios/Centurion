...
public class ScopeDesc {
  ...
  private final int     senderDecodeOffset;
  private final int     localsDecodeOffset;
  private final int     expressionsDecodeOffset;
  private final int     monitorsDecodeOffset;
  ...
  public boolean equals(Object arg) {
    ...
    if (!(arg instanceof ScopeDesc sd)) {
      return false;
    }
