...
public class ZipFileSystemProvider extends FileSystemProvider {
    private final Map<Path, jdk.nio.zipfs.ZipFileSystem> filesystems = new HashMap<>();
            ...
            throws IOException
    {
        ...
        synchronized(filesystems) {
            ...
            jdk.nio.zipfs.ZipFileSystem zipfs = getZipFileSystem(path, env);
    ...
    private jdk.nio.zipfs.ZipFileSystem getZipFileSystem(Path path, Map<String, ?> env) throws IOException {
        try {
            return new jdk.nio.zipfs.ZipFileSystem(this, path, env);
    ...
    public FileSystem getFileSystem(URI uri) {
        synchronized (filesystems) {
            jdk.nio.zipfs.ZipFileSystem zipfs = null;
            try {
    ...
    void removeFileSystem(Path zfpath, jdk.nio.zipfs.ZipFileSystem zfs) throws IOException {
        synchronized (filesystems) {
