...
public class ByteArrayChannel implements java.nio.channels.SeekableByteChannel {
    ...
    @Override
    public java.nio.channels.SeekableByteChannel position(long pos) throws IOException {
        beginWrite();
        try {
            ensureOpen();
