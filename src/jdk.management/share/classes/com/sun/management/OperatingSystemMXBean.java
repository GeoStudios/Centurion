...
public interface OperatingSystemMXBean extends
     ...
     */
    @Deprecated(since="14")
    default long getFreePhysicalMemorySize() { return getFreeMemorySize(); }
     ...
     */
    @Deprecated(since="14")
    default long getTotalPhysicalMemorySize() { return getTotalMemorySize(); }
     ...
     */
    @Deprecated(since="14")
    default double getSystemCpuLoad() { return getCpuLoad(); }
