...
public class EdDSAKeyFactory extends KeyFactorySpi {
    ...
    protected Key engineTranslateKey(Key key) throws InvalidKeyException {
        ...
        if (key instanceof EdECKey edKey) {
            ...
            if (edKey instanceof EdECPublicKey publicKey) {
                return new EdDSAPublicKeyImpl(params, publicKey.getPoint());
            } else if (edKey instanceof EdECPrivateKey privateKey) {
    ...
    private PublicKey generatePublicImpl(KeySpec keySpec)
        ...
        if (keySpec instanceof X509EncodedKeySpec x509Spec) {
            ...
            checkLockedParams(InvalidKeySpecException::new,
                result.getParams());
            return result;
        } else if (keySpec instanceof EdECPublicKeySpec publicKeySpec) {
            EdDSAParameters params = EdDSAParameters.get(
    ...
    private PrivateKey generatePrivateImpl(KeySpec keySpec)
        ...
        } else if (keySpec instanceof EdECPrivateKeySpec privateKeySpec) {
            EdDSAParameters params = EdDSAParameters.get(
