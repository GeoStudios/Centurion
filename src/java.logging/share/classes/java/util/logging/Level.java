...
public class Level implements java.io.Serializable {
    ...
    static final class KnownLevel extends WeakReference<Level> {
        private static final Map<String, List<KnownLevel>> nameToLevels = new HashMap<>();
        private static final Map<Integer, List<KnownLevel>> intToLevels = new HashMap<>();
            ...
            if (list != null) {
                for (KnownLevel ref : list) {
                    ...
                    if (l.value == other.value &&
                           (Objects.equals(l.resourceBundleName, other.resourceBundleName))) {
                        if (type == l.getClass()) {
