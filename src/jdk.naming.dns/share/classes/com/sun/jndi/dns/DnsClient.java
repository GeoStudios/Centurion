...
public class DnsClient {
    ...
    private final int timeout;                // initial timeout on UDP and TCP queries in ms
    ...
    // Requests sent
    private final Map<Integer, ResourceRecord> reqs;

    // Responses received
    private final Map<Integer, byte[]> resps;
