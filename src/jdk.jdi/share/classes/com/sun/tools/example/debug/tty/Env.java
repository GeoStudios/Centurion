...
class Env {
    ...
    private static final List<SourceCode> sourceCache = new LinkedList<SourceCode>();

    private static final HashMap<String, Value> savedValues = new HashMap<String, Value>();
