...
public class DiagramScene extends ObjectScene implements DiagramViewer {
    ...
    private final RectangularSelectDecorator rectangularSelectDecorator = new RectangularSelectDecorator() {
    ...
    private final RectangularSelectProvider rectangularSelectProvider = new RectangularSelectProvider() {
    ...
    private final ObjectSceneListener selectionChangedListener = new ObjectSceneListener() {
        ...
        public void selectionChanged(ObjectSceneEvent e, Set<Object> oldSet, Set<Object> newSet) {
            ...
            for (Object o : newSet) {
                if (o instanceof Properties.Provider provider) {
