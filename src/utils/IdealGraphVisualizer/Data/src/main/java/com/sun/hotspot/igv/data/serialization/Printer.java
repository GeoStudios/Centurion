...
public class Printer {
        ...
        for (InputBlock b : graph.getBlocks()) {
            ...
            writer.startTag(Parser.NODES_ELEMENT);
                for (InputNode n : b.getNodes()) {
                    writer.simpleTag(Parser.NODE_ELEMENT, new Properties(Parser.NODE_ID_PROPERTY, String.valueOf(n.getId())));
                }
                writer.endTag();
            }
    ...
    private void export(XMLWriter w, InputMethod method) throws IOException {
        ...
        w.startTag(Parser.METHOD_ELEMENT, new Properties(Parser.METHOD_BCI_PROPERTY, String.valueOf(method.getBci()), Parser.METHOD_NAME_PROPERTY, method.getName(), Parser.METHOD_SHORT_NAME_PROPERTY, method.getShortName()));
