...
//                    curX += n.width + xOffset;
    ...
    private static final Comparator<LayoutNode> crossingNodeComparator = new Comparator<LayoutNode>() {
    ...
    private final Comparator<Link> linkComparator = new Comparator<Link>() {
