...
public class Main {
    ...
    private static final List<Command> scripts;
    // the script engine manager
    private static ScriptEngineManager engineManager;
    // map of engines we loaded
    private static final Map<String, ScriptEngine> engines;
    // error messages resource
    private static final ResourceBundle msgRes;
    private static final String BUNDLE_NAME = "com.sun.tools.script.shell.messages";
    private static final String PROGRAM_NAME = "jrunscript";
