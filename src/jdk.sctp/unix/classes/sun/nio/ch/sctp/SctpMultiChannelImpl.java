    ...
    implements SelChImpl
{
    ...
    int port = -1;
    private final HashSet<InetSocketAddress> localAddresses = new HashSet<InetSocketAddress>();
    /* Has the channel been bound to the wildcard address */
    private boolean wildcard; /* false */

    /* Keeps a map of addresses to association, and visa versa */
    private final HashMap<SocketAddress, Association> addressMap =
                         new HashMap<SocketAddress, Association>();
    private final HashMap<Association, Set<SocketAddress>> associationMap =
    ...
    public <T> MessageInfo receive(ByteBuffer buffer,
        ...
        try {
            ...
            } while (handler == null || (invokeNotificationHandler(resultContainer, handler, attachment)
