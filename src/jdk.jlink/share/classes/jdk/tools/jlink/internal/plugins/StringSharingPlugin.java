        ...
        private static final class DescriptorsScanner {
            ...
            private void scanAttributes(Attributes attributes,
                ...
                for (Attribute a : attributes) {
                    if (a instanceof Signature_attribute sig) {
                    ...
                    } else if (a instanceof RuntimeParameterAnnotations_attribute rap) {
            ...
            private void scanConstantPool(Set<Integer> utf8Descriptors)
                ...
                for (int i = 1; i < cf.constant_pool.size(); i++) {
                    try {
                        ...
                        if (info instanceof ConstantPool.CONSTANT_NameAndType_info nameAndType) {
                            utf8Descriptors.add(nameAndType.type_index);
                        }
                        if (info instanceof ConstantPool.CONSTANT_MethodType_info mt) {
