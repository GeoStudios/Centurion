...
public interface ResourcePoolEntry {
     ...
     */
    default ResourcePoolEntry copyWithContent(byte[] content) {
     ...
     * @return A new ResourcePoolEntry.
     */
    default ResourcePoolEntry copyWithContent(Path file) {
     ...
     * @return A new ResourcePoolEntry.
     */
    static ResourcePoolEntry create(String path,
     ...
     * @return A new ResourcePoolEntry.
     */
    static ResourcePoolEntry create(String path, byte[] content) {
     ...
     * @return A new ResourcePoolEntry.
     */
    static ResourcePoolEntry create(String path, Path file) {
     ...
     * @return A new ResourcePoolEntry
     */
    static ResourcePoolEntry createSymLink(String path,
