...
public interface ResourcePool {
     ...
     */
    Optional<ResourcePoolEntry> findEntryInContext(String path, ResourcePoolEntry context);
     ...
     */
    boolean contains(ResourcePoolEntry data);
