...
class JImageTask {
    ...
    private interface JImageAction {
        void apply(File file, BasicImageReader reader) throws IOException, BadArgs;
    }

    private interface ModuleAction {
         void apply(BasicImageReader reader,
                 String oldModule, String newModule) throws IOException, BadArgs;
    }

    private interface ResourceAction {
        void apply(BasicImageReader reader, String name,
