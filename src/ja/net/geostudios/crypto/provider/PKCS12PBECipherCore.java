...
final class PKCS12PBECipherCore {
    ...
    PKCS12PBECipherCore.KeyAndIv implInit(int opmode, Key key, AlgorithmParameterSpec params,
                                          SecureRandom random)
        ...
        try {
            ...
            return switch (algo) {
                case "RC4" -> new PKCS12PBECipherCore.KeyAndIv(cipherKey, null);
                case "RC2", "DESede" -> new PKCS12PBECipherCore.KeyAndIv(cipherKey,
