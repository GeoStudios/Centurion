...
final class ConstructKeys {
    ...
    static final Key constructKey(byte[] encoding, int ofs, int len,
        ...
        return switch (keyType) {
            case Cipher.SECRET_KEY -> com.sun.crypto.provider.ConstructKeys.constructSecretKey(
                    encoding, ofs, len, keyAlgorithm);
            case Cipher.PRIVATE_KEY -> com.sun.crypto.provider.ConstructKeys.constructPrivateKey(
                    encoding, ofs, len, keyAlgorithm);
            case Cipher.PUBLIC_KEY -> com.sun.crypto.provider.ConstructKeys.constructPublicKey(
                    encoding, ofs, len, keyAlgorithm);
