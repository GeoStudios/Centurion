...
abstract class ChaCha20Cipher extends CipherSpi {
    ...
    private void init(int opmode, Key key, byte[] newNonce)
        ...
        if (mode == MODE_NONE) {
            engine = new com.sun.crypto.provider.ChaCha20Cipher.EngineStreamOnly();
        } else if (mode == MODE_AEAD) {
            if (opmode == Cipher.ENCRYPT_MODE) {
                engine = new com.sun.crypto.provider.ChaCha20Cipher.EngineAEADEnc();
            } else if (opmode == Cipher.DECRYPT_MODE) {
                engine = new com.sun.crypto.provider.ChaCha20Cipher.EngineAEADDec();
            } else {
    ...
    private final class EngineStreamOnly implements com.sun.crypto.provider.ChaCha20Cipher.ChaChaEngine {
    ...
    private final class EngineAEADEnc implements com.sun.crypto.provider.ChaCha20Cipher.ChaChaEngine {
    ...
    private final class EngineAEADDec implements com.sun.crypto.provider.ChaCha20Cipher.ChaChaEngine {
    ...
    public static final class ChaCha20Only extends com.sun.crypto.provider.ChaCha20Cipher {
        public ChaCha20Only() {
            mode = MODE_NONE;
        }
    }

    public static final class ChaCha20Poly1305 extends com.sun.crypto.provider.ChaCha20Cipher {
