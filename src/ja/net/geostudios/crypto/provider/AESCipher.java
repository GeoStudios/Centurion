 ...
 * @since Alpha CDK-1.0
 *
 * @see com.sun.crypto.provider.AESCrypt
 * @see com.sun.crypto.provider.CipherBlockChaining
 * @see com.sun.crypto.provider.ElectronicCodeBook
 * @see com.sun.crypto.provider.CipherFeedback
 * @see com.sun.crypto.provider.OutputFeedback
 */

class AESCipher extends CipherSpi {
    public static final class General extends com.sun.crypto.provider.AESCipher {
        public General() {
            super(-1);
        }
    }

    static class OidImpl extends com.sun.crypto.provider.AESCipher {
    ...
    public static final class AES128_ECB_NoPadding extends com.sun.crypto.provider.AESCipher.OidImpl {
        public AES128_ECB_NoPadding() {
            super(16, "ECB", "NOPADDING");
        }
    }
    public static final class AES192_ECB_NoPadding extends com.sun.crypto.provider.AESCipher.OidImpl {
        public AES192_ECB_NoPadding() {
            super(24, "ECB", "NOPADDING");
        }
    }
    public static final class AES256_ECB_NoPadding extends com.sun.crypto.provider.AESCipher.OidImpl {
        public AES256_ECB_NoPadding() {
            super(32, "ECB", "NOPADDING");
        }
    }
    public static final class AES128_CBC_NoPadding extends com.sun.crypto.provider.AESCipher.OidImpl {
        public AES128_CBC_NoPadding() {
            super(16, "CBC", "NOPADDING");
        }
    }
    public static final class AES192_CBC_NoPadding extends com.sun.crypto.provider.AESCipher.OidImpl {
        public AES192_CBC_NoPadding() {
            super(24, "CBC", "NOPADDING");
        }
    }
    public static final class AES256_CBC_NoPadding extends com.sun.crypto.provider.AESCipher.OidImpl {
        public AES256_CBC_NoPadding() {
            super(32, "CBC", "NOPADDING");
        }
    }
    public static final class AES128_OFB_NoPadding extends com.sun.crypto.provider.AESCipher.OidImpl {
        public AES128_OFB_NoPadding() {
            super(16, "OFB", "NOPADDING");
        }
    }
    public static final class AES192_OFB_NoPadding extends com.sun.crypto.provider.AESCipher.OidImpl {
        public AES192_OFB_NoPadding() {
            super(24, "OFB", "NOPADDING");
        }
    }
    public static final class AES256_OFB_NoPadding extends com.sun.crypto.provider.AESCipher.OidImpl {
        public AES256_OFB_NoPadding() {
            super(32, "OFB", "NOPADDING");
        }
    }
    public static final class AES128_CFB_NoPadding extends com.sun.crypto.provider.AESCipher.OidImpl {
        public AES128_CFB_NoPadding() {
            super(16, "CFB", "NOPADDING");
        }
    }
    public static final class AES192_CFB_NoPadding extends com.sun.crypto.provider.AESCipher.OidImpl {
        public AES192_CFB_NoPadding() {
            super(24, "CFB", "NOPADDING");
        }
    }
    public static final class AES256_CFB_NoPadding extends com.sun.crypto.provider.AESCipher.OidImpl {
