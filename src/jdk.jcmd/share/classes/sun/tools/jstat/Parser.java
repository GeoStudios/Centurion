...
public class Parser {
    ...
    private static final boolean pdebug = Boolean.getBoolean("jstat.parser.debug");
    private static final boolean ldebug = Boolean.getBoolean("jstat.lex.debug");
    ...
    private static final String[] otherKeyWords = {
        OPTION, COLUMN, DATA, HEADER, WIDTH, FORMAT, ALIGN, SCALE, REQUIRED
    };

    private static final char[] infixOps = {
    ...
    public Parser(Reader r) {
        ...
        Collections.addAll(reservedWords, otherKeyWords);
    ...
    private void match(char ttype) throws ParserException, IOException {
      if (lookahead.ttype == (int)ttype) {
          ...
          throw new SyntaxException(st.lineno(), new Token(ttype),
                                    lookahead);
      }
    }
