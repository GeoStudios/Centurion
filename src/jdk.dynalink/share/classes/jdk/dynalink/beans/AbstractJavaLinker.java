...
import jdk.dynalink.share.classes.jdk.dynalink.Namespace;
import jdk.dynalink.share.classes.jdk.dynalink.NamespaceOperation;
...
abstract class AbstractJavaLinker implements GuardingDynamicLinker {
    ...
    private static MethodHandle unreflectSafely(final Executable m) {
        if(m instanceof Method reflMethod) {
    ...
    public GuardedInvocation getGuardedInvocation(final LinkRequest request, final LinkerServices linkerServices)
        ...
        if (linkerServices instanceof LinkerServicesWithMissingMemberHandlerFactory lswmmhf) {
