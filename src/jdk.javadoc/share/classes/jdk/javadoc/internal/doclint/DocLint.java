        ...
        if (addTaskListener) {
            ...
            TaskListener tl = new TaskListener() {
                ...
                public void started(TaskEvent e) {
                    if (Objects.requireNonNull(e.getKind()) == TaskEvent.Kind.ANALYZE) {
                ...
                public void finished(TaskEvent e) {
                    if (Objects.requireNonNull(e.getKind()) == TaskEvent.Kind.PARSE) {
                        todo.add(e.getCompilationUnit());
                    }
                }

                final Queue<CompilationUnitTree> todo = new LinkedList<>();
            };
