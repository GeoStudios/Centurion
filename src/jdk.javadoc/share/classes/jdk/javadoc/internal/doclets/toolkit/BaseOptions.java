...
public abstract class BaseOptions {
     ...
     */
    private final String docFileDestDirName = "";
     ...
     */
    private final Set<String> excludedDocFileDirs;

    /**
     * Argument for command-line option {@code -noqualifier}.
     * The set of qualifiers to exclude.
     */
    private final Set<String> excludedQualifiers;

    /**
     * Arguments for command-line option {@code -group}
     */
    private final List<Utils.Pair<String, String>> groupPairs;
    ...
    protected boolean generalValidOptions() {
        ...
        if (docEncoding == null && (encoding != null && !encoding.isEmpty())) {
            return checkOutputFileEncoding(encoding);
        }
        return true;
    }
