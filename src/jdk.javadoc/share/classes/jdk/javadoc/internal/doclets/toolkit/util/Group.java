...
public class Group {
     ...
     */
    private final Map<String,String> regExpGroupMap = new HashMap<>();
     ...
     */
    private final List<String> sortedRegExpList = new ArrayList<>();
     ...
     */
    private final Map<String,String> elementNameGroupMap = new HashMap<>();
