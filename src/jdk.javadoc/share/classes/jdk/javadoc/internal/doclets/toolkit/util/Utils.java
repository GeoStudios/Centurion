...
import jdk.javadoc.share.classes.jdk.javadoc.internal.doclets.toolkit.CommentUtils.DocCommentInfo;
import jdk.javadoc.share.classes.jdk.javadoc.internal.doclets.toolkit.Resources;
import jdk.javadoc.share.classes.jdk.javadoc.internal.doclets.toolkit.taglets.BaseTaglet;
...
public class Utils {
    ...
    private final HashMap<String, TypeMirror> symtab = new HashMap<>();
    ...
    public boolean isOrdinaryClass(TypeElement te) {
        ...
        return !isError(te) && !isException(te);
    }
    ...
    private static class ConstantValueExpression extends TypeKindVisitor9<String, Object> {
        ...
        private String sourceForm(double v, char suffix) {
            ...
            if (v == Double.NEGATIVE_INFINITY)
                return "-1" + suffix + "/0" + suffix;
            return v + (suffix == 'f' || suffix == 'F' ? String.valueOf(suffix) : "");
        }
