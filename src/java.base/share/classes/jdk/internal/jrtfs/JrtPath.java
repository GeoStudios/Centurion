...
final class JrtPath implements Path {
    ...
    @Override
    public JrtPath relativize(Path other) {
    ...
    void move(JrtPath target, CopyOption... options) throws IOException {
    ...
    void copy(JrtPath target, CopyOption... options) throws IOException {
        if (this.jrtfs == target.jrtfs) {
