...
class UCharacterEnums {
    ...
    public interface ECharacterDirection {
         ...
         */
        @Deprecated
        byte DIRECTIONALITY_LEFT_TO_RIGHT = (byte)LEFT_TO_RIGHT;
         ...
         */
        @Deprecated
        byte DIRECTIONALITY_RIGHT_TO_LEFT = (byte)RIGHT_TO_LEFT;
         ...
         */
        @Deprecated
        byte DIRECTIONALITY_EUROPEAN_NUMBER = (byte)EUROPEAN_NUMBER;
         ...
         */
        @Deprecated
        byte DIRECTIONALITY_EUROPEAN_NUMBER_SEPARATOR = (byte)EUROPEAN_NUMBER_SEPARATOR;
         ...
         */
        @Deprecated
        byte DIRECTIONALITY_EUROPEAN_NUMBER_TERMINATOR = (byte)EUROPEAN_NUMBER_TERMINATOR;
         ...
         */
        @Deprecated
        byte DIRECTIONALITY_ARABIC_NUMBER = (byte)ARABIC_NUMBER;
         ...
         */
        @Deprecated
        byte DIRECTIONALITY_COMMON_NUMBER_SEPARATOR = (byte)COMMON_NUMBER_SEPARATOR;
         ...
         */
        @Deprecated
        byte DIRECTIONALITY_PARAGRAPH_SEPARATOR = (byte)BLOCK_SEPARATOR;
         ...
         */
        @Deprecated
        byte DIRECTIONALITY_SEGMENT_SEPARATOR = (byte)SEGMENT_SEPARATOR;
         ...
         */
        @Deprecated
        byte DIRECTIONALITY_WHITESPACE = (byte)WHITE_SPACE_NEUTRAL;
         ...
         */
        @Deprecated
        byte DIRECTIONALITY_OTHER_NEUTRALS = (byte)OTHER_NEUTRAL;
         ...
         */
        @Deprecated
        byte DIRECTIONALITY_LEFT_TO_RIGHT_EMBEDDING = (byte)LEFT_TO_RIGHT_EMBEDDING;
         ...
         */
        @Deprecated
        byte DIRECTIONALITY_LEFT_TO_RIGHT_OVERRIDE = (byte)LEFT_TO_RIGHT_OVERRIDE;
         ...
         */
        @Deprecated
        byte DIRECTIONALITY_RIGHT_TO_LEFT_ARABIC = (byte)RIGHT_TO_LEFT_ARABIC;
         ...
         */
        @Deprecated
        byte DIRECTIONALITY_RIGHT_TO_LEFT_EMBEDDING = (byte)RIGHT_TO_LEFT_EMBEDDING;
         ...
         */
        @Deprecated
        byte DIRECTIONALITY_RIGHT_TO_LEFT_OVERRIDE = (byte)RIGHT_TO_LEFT_OVERRIDE;
         ...
         */
        @Deprecated
        byte DIRECTIONALITY_POP_DIRECTIONAL_FORMAT = (byte)POP_DIRECTIONAL_FORMAT;
         ...
         */
        @Deprecated
        byte DIRECTIONALITY_NON_SPACING_MARK = (byte)DIR_NON_SPACING_MARK;
         ...
         */
        @Deprecated
        byte DIRECTIONALITY_BOUNDARY_NEUTRAL = (byte)BOUNDARY_NEUTRAL;
