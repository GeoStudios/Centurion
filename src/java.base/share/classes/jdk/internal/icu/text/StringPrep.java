...
public final class StringPrep {
    ...
    private StringBuffer map( UCharacterIterator iter, int options)
        ...
        while((ch=iter.nextCodePoint())!= UCharacterIterator.DONE){
            ...
            if(val.type == UNASSIGNED && !allowUnassigned){
