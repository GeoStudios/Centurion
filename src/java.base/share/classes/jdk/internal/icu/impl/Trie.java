...
public abstract class Trie
{
     ...
     */
    private final boolean m_isLatin1Linear_;
    ...
    private final boolean checkHeader(int signature)
    {
        ...
        return (m_options_ & HEADER_OPTIONS_SHIFT_MASK_) == INDEX_STAGE_1_SHIFT_ &&
                ((m_options_ >> HEADER_OPTIONS_INDEX_SHIFT_) &
                        HEADER_OPTIONS_SHIFT_MASK_) == INDEX_STAGE_2_SHIFT_;
    }
}
