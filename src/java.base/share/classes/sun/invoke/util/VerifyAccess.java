...
public class VerifyAccess {
    ...
    public static boolean isMemberAccessible(Class<?> refc,  // symbolic ref class
        ...
        case PROTECTED:
            ...
            if ((mods & STATIC) != 0 &&
                ...
                return false;
            return (allowedModes & PROTECTED) != 0 &&
    ...
    public static boolean isClassAccessible(Class<?> refc,
        ...
        if (isPublic(mods)) {
            ...
            return !jdk.internal.misc.VM.isModuleSystemInited();
    ...
    public static boolean isModuleAccessible(Class<?> refc,  Module m1, Module m2) {
        ...
        if (isPublic(mods)) {
            if (m1.canRead(refModule) && (m2 == null || m2.canRead(refModule))) {
                ...
                return refModule.isExported(pn, m1) && (m2 == null || refModule.isExported(pn, m2));
            }
        }
        return false;
    }
    ...
    public static boolean isSamePackageMember(Class<?> class1, Class<?> class2) {
        ...
        if (!isSamePackage(class1, class2))
            return false;
        return getOutermostEnclosingClass(class1) == getOutermostEnclosingClass(class2);
    }
