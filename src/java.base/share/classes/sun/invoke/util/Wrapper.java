...
public enum Wrapper {
    ...
    Wrapper(Class<?> wtype, String wtypeName, Class<?> ptype, String ptypeName, char tchar, Object emptyArray, int format) {
    ...
    private static final Object DOUBLE_ZERO = (double)0;
    private static final Object FLOAT_ZERO = (float)0;
