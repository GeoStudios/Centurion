...
abstract class MethodHandleImpl {
    ...
    static class CountingWrapper extends DelegatingMethodHandle {
        private final MethodHandle target;
        private int count;
        private final Function<MethodHandle, LambdaForm> countingFormProducer;
        private final Function<MethodHandle, LambdaForm> nonCountingFormProducer;
    ...
    private static class BindCaller {
        ...
        private static final ClassValue<MethodHandle> CV_makeInjectedInvoker = new ClassValue<MethodHandle>() {
