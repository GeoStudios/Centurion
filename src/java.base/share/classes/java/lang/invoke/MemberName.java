...
final class MemberName implements Member, Cloneable {
    ...
    private boolean isObjectPublicMethod() {
        ...
        if (name.equals("hashCode") && mtype.returnType() == int.class && mtype.parameterCount() == 0)
            return true;
        return name.equals("equals") && mtype.returnType() == boolean.class && mtype.parameterCount() == 1 && mtype.parameterType(0) == Object.class;
    }
    ...
    public int hashCode() {
        ...
        return Objects.hash(clazz, Byte.valueOf(getReferenceKind()), name, getType());
    }
    ...
    static class Factory {
        ...
        private static final int ALLOWED_FLAGS = ALL_KINDS;
