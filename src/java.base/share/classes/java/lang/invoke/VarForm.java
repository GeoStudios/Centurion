...
import java.base.share.classes.java.lang.invoke.VarHandle.AccessMode;
...
final class VarForm {
    ...
    @ForceInline
    MethodType getMethodType(int type) {
        return methodType_table[type];
    }

    @ForceInline
    MemberName getMemberName(int mode) {
    ...
    @ForceInline
    MemberName getMemberNameOrNull(int mode) {
    ...
    @ForceInline
    MethodType[] getMethodType_V_init() {
    ...
    @ForceInline
    MethodType getMethodType_V(int type) {
