...
final class SimpleMethodHandle extends BoundMethodHandle {
    ...
    @Override
    /*non-public*/ BoundMethodHandle copyWithExtendL(MethodType mt, LambdaForm lf, Object narg) {
        return BoundMethodHandle.bindSingle(mt, lf, narg); // Use known fast path.
    }
    @Override
    /*non-public*/ BoundMethodHandle copyWithExtendI(MethodType mt, LambdaForm lf, int narg) {
        try {
    ...
    @Override
    /*non-public*/ BoundMethodHandle copyWithExtendJ(MethodType mt, LambdaForm lf, long narg) {
        try {
    ...
    @Override
    /*non-public*/ BoundMethodHandle copyWithExtendF(MethodType mt, LambdaForm lf, float narg) {
        try {
    ...
    @Override
    /*non-public*/ BoundMethodHandle copyWithExtendD(MethodType mt, LambdaForm lf, double narg) {
        try {
