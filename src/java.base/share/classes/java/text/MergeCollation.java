...
final class MergeCollation {
    ...
    private final transient StringBuffer excess = new StringBuffer();
    ...
    //
    private final transient byte[] statusArray = new byte[8192];
    ...
    /*
      ...
      */
    private void fixEntry(PatternEntry newEntry) throws ParseException
    {
