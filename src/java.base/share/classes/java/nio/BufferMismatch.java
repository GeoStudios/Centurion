    ...
    static int mismatch(CharBuffer a, int aOff, CharBuffer b, int bOff, int length) {
        ...
        if (length > 3 && a.charRegionOrder() == b.charRegionOrder()
            ...
            if (a.get(aOff) != b.get(bOff))
                return 0;
            i = SCOPED_MEMORY_ACCESS.vectorizedMismatch(a.scope(), b.scope(),
                    a.base(), a.address + ((long) aOff << ArraysSupport.LOG2_ARRAY_CHAR_INDEX_SCALE),
                    b.base(), b.address + ((long) bOff << ArraysSupport.LOG2_ARRAY_CHAR_INDEX_SCALE),
                    length,
    ...
    static int mismatch(ShortBuffer a, int aOff, ShortBuffer b, int bOff, int length) {
        ...
        if (length > 3 && a.order() == b.order()) {
            if (a.get(aOff) != b.get(bOff))
                return 0;
            i = SCOPED_MEMORY_ACCESS.vectorizedMismatch(a.scope(), b.scope(),
                    a.base(), a.address + ((long) aOff << ArraysSupport.LOG2_ARRAY_SHORT_INDEX_SCALE),
                    b.base(), b.address + ((long) bOff << ArraysSupport.LOG2_ARRAY_SHORT_INDEX_SCALE),
                    length,
    ...
    static int mismatch(IntBuffer a, int aOff, IntBuffer b, int bOff, int length) {
        ...
        if (length > 1 && a.order() == b.order()) {
            if (a.get(aOff) != b.get(bOff))
                return 0;
            i = SCOPED_MEMORY_ACCESS.vectorizedMismatch(a.scope(), b.scope(),
                    a.base(), a.address + ((long) aOff << ArraysSupport.LOG2_ARRAY_INT_INDEX_SCALE),
                    b.base(), b.address + ((long) bOff << ArraysSupport.LOG2_ARRAY_INT_INDEX_SCALE),
                    length,
    ...
    static int mismatch(FloatBuffer a, int aOff, FloatBuffer b, int bOff, int length) {
        ...
        if (length > 1 && a.order() == b.order()) {
            if (Float.floatToRawIntBits(a.get(aOff)) == Float.floatToRawIntBits(b.get(bOff))) {
                i = SCOPED_MEMORY_ACCESS.vectorizedMismatch(a.scope(), b.scope(),
                        a.base(), a.address + ((long) aOff << ArraysSupport.LOG2_ARRAY_FLOAT_INDEX_SCALE),
                        b.base(), b.address + ((long) bOff << ArraysSupport.LOG2_ARRAY_FLOAT_INDEX_SCALE),
                        length,
    ...
    static int mismatch(LongBuffer a, int aOff, LongBuffer b, int bOff, int length) {
        ...
        if (length > 0 && a.order() == b.order()) {
            if (a.get(aOff) != b.get(bOff))
                return 0;
            i = SCOPED_MEMORY_ACCESS.vectorizedMismatch(a.scope(), b.scope(),
                    a.base(), a.address + ((long) aOff << ArraysSupport.LOG2_ARRAY_LONG_INDEX_SCALE),
                    b.base(), b.address + ((long) bOff << ArraysSupport.LOG2_ARRAY_LONG_INDEX_SCALE),
                    length,
    ...
    static int mismatch(DoubleBuffer a, int aOff, DoubleBuffer b, int bOff, int length) {
        ...
        if (length > 0 && a.order() == b.order()) {
            if (Double.doubleToRawLongBits(a.get(aOff)) == Double.doubleToRawLongBits(b.get(bOff))) {
                i = SCOPED_MEMORY_ACCESS.vectorizedMismatch(a.scope(), b.scope(),
                        a.base(), a.address + ((long) aOff << ArraysSupport.LOG2_ARRAY_DOUBLE_INDEX_SCALE),
                        b.base(), b.address + ((long) bOff << ArraysSupport.LOG2_ARRAY_DOUBLE_INDEX_SCALE),
                        length,
