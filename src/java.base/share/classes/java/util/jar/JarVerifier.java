...
class JarVerifier {
    ...
    private final Hashtable<String, CodeSigner[]> sigFileSigners;
    ...
    private final Object csdomain = new Object();

    /** collect -DIGEST-MANIFEST values for deny list */
    private final List<Object> manifestDigests;
    ...
    private final Map<URL, Map<CodeSigner[], CodeSource>> urlToCodeSourceMap = new HashMap<>();
    private final Map<CodeSigner[], CodeSource> signerToCodeSource = new HashMap<>();
    private URL lastURL;
    ...
    private final CodeSigner[] emptySigner = new CodeSigner[0];
