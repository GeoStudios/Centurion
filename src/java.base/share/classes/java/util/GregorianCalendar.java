...
/////////////////
        ...
        case WEEK_OF_YEAR:
            {
                ...
                if (!isCutoverYear(y)) {
                    ...
                    if (weekYear == y) {
                        ...
                        long day1 = fd - (7L * (woy - min));
                        if (calsys.getYearFromFixedDate(day1) != y) {
                            min++;
                        }

                        // Make sure the same thing for the max week
                        fd += 7L * (max - internalGet(WEEK_OF_YEAR));
                ...
                BaseCalendar.Date d = getCalendarDate(day1 + value * 7L);
    ...
    private long getYearOffsetInMillis() {
        long t = (internalGet(DAY_OF_YEAR) - 1) * 24L;
    ...
    protected void computeTime() {
        ...
        if (isFieldSet(fieldMask, HOUR_OF_DAY)) {
            ...
            if (isFieldSet(fieldMask, AM_PM)) {
                timeOfDay += 12L * internalGet(AM_PM);
            }
        }
        timeOfDay *= 60;
        timeOfDay += internalGet(MINUTE);
        ...
        if (isFieldSet(fieldMask, MONTH)) {
            ...
            if (isFieldSet(fieldMask, DAY_OF_MONTH)) {
                ...
                if (isFieldSet(fieldMask, WEEK_OF_MONTH)) {
                    ...
                    if (dowim >= 0) {
                        fixedDate = BaseCalendar.getDayOfWeekDateOnOrBefore(fixedDate + (7L * dowim) - 1,
                                                                            dayOfWeek);
                    } else {
