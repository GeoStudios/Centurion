        ...
        case WEEK_OF_YEAR:
            {
                ...
                d = getCalendarDate(day1 + value * 7L);
                set(MONTH, d.getMonth() - 1);
                set(DAY_OF_MONTH, d.getDayOfMonth());
                return;
            }
        ...
        if (isFieldSet(fieldMask, MONTH)) {
            ...
            if (isFieldSet(fieldMask, DAY_OF_MONTH)) {
                ...
                if (isFieldSet(fieldMask, WEEK_OF_MONTH)) {
                    ...
                    if (dowim >= 0) {
                        fixedDate = LocalGregorianCalendar.getDayOfWeekDateOnOrBefore(fixedDate + (7L * dowim) - 1,
                                                                                      dayOfWeek);
                    } else {
