...
public class ForkJoinPool extends AbstractExecutorService {
    ...
    static final class WorkQueue {
        ...
        static ForkJoinTask<?> getSlot(ForkJoinTask<?>[] a, int i) {
            return (ForkJoinTask<?>)QA.getAcquire(a, i);
        }
        static ForkJoinTask<?> getAndClearSlot(ForkJoinTask<?>[] a,
                                               int i) {
            return (ForkJoinTask<?>)QA.getAndSet(a, i, null);
        }
        static void setSlotVolatile(ForkJoinTask<?>[] a, int i,
                                    ForkJoinTask<?> v) {
         ...
         */
        boolean lockedPush(ForkJoinTask<?> task) {
            ForkJoinTask<?>[] a = array;
         ...
         */
        boolean externalTryUnpush(ForkJoinTask<?> task) {
            boolean taken = false;
            for (;;) {
         ...
         */
        boolean tryRemove(ForkJoinTask<?> task, boolean owned) {
            boolean taken = false;
         ...
         */
        ForkJoinTask<?> nextLocalTask(int cfg) {
            ForkJoinTask<?> t = null;
            int s = top, cap; ForkJoinTask<?>[] a;
            if ((a = array) != null && (cap = a.length) > 0) {
                for (int b, d;;) {
         ...
         */
        int helpComplete(ForkJoinTask<?> task, boolean owned, int limit) {
    ...
    static final class InvokeAnyRoot<E> extends ForkJoinTask<E> {
        ...
        void tryComplete(Callable<E> c) { // called by InvokeAnyTasks
            Throwable ex = null;
            boolean failed;
        ...
        public boolean exec()         { return false; } // never forked
        public E getRawResult()       { return result; }
        public void setRawResult(E v) { result = v; }
    }
    ...
    static final class InvokeAnyTask<E> extends ForkJoinTask<E> {
        ...
        public void setRawResult(E v) {} // unused
        public E getRawResult()       { return null; }
    }
