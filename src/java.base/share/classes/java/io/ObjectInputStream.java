    ...
    extends InputStream implements ObjectInput, ObjectStreamConstants
{
    ...
    private void filterCheck(Class<?> clazz, int arrayLength)
        ...
        if (serialFilter != null && (status == null || status == ObjectInputFilter.Status.REJECTED)) {
            InvalidClassException ice = new InvalidClassException("filter status: " + status, ex);
            throw ice;
        }
    }
        ...
        throws IOException
    {
        ...
        try {
            ...
            throw new InvalidClassException(
                "failed to read class descriptor", ex);
        }
    ...
    private Object readRecord(ObjectStreamClass desc) throws IOException {
        ...
        try {
            ...
            ObjectStreamException ose = new InvalidObjectException(
                    "ReflectiveOperationException during deserialization", t);
            throw ose;
        }
    }
