...
public final class KeychainStore extends KeyStoreSpi {
     ...
     */
    private final Hashtable<String, Object> deletedEntries = new Hashtable<>();

    /**
     * Entries that have been added.  When something calls engineStore we'll
     * add them to the keychain.
     */
    private final Hashtable<String, Object> addedEntries = new Hashtable<>();
    ...
    private static final ObjectIdentifier pbeWithSHAAnd3KeyTripleDESCBC_OID =
        ...
        throws KeyStoreException
    {
        ...
        synchronized(entries) {
            try {
                ...
                KeyStoreException ke = new KeyStoreException("Key protection algorithm not found: " + nsae, nsae);
                throw ke;
            }
        }
    }
        ...
        throws KeyStoreException
    {
        ...
        synchronized(entries) {
            ...
            for (Object value : allValues) {
                if (value instanceof TrustedCertEntry tce) {
        ...
        throws IOException, NoSuchAlgorithmException, CertificateException
    {
        ...
        for (Enumeration<String> e = addedEntries.keys(); e.hasMoreElements(); ) {
            ...
            if (entry instanceof TrustedCertEntry tce) {
                Certificate certElem;
                certElem = tce.cert;
