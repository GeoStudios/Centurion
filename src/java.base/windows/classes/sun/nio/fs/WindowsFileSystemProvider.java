...
import java.base.windows.classes.sun.nio.ch.ThreadPool;
import java.base.windows.classes.sun.security.util.SecurityConstants;
    ...
    extends AbstractFileSystemProvider
{
        ...
        throws IOException
    {
        ...
        if (!(path instanceof WindowsPath file))
