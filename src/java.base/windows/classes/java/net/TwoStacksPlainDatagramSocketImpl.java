...
final class TwoStacksPlainDatagramSocketImpl extends AbstractPlainDatagramSocketImpl
{
    ...
    private synchronized native void bind0(int lport, InetAddress laddr,
                                           boolean exclBind)
        throws SocketException;
    ...
    private native void socketNativeSetOption(int opt, Object val)
        throws SocketException;
    ...
    private native Object socketLocalAddress(int family) throws SocketException;
