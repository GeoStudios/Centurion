...
public class CodeWriter extends BasicWriter {
    ...
    private final LocalVariableTypeTableWriter localVariableTypeTableWriter;
    private final TypeAnnotationWriter typeAnnotationWriter;
    private final SourceWriter sourceWriter;
    private final StackMapWriter stackMapWriter;
    private final TryBlockWriter tryBlockWriter;
