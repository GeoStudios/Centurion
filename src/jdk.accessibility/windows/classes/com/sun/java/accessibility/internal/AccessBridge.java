...
final public class AccessBridge {
    ...
    private final ObjectReferences references;
    private final EventHandler eventHandler;

    // Maps AccessibleRoles strings to AccessibleRoles.
    private final ConcurrentHashMap<String,AccessibleRole> accessibleRoleMap = new ConcurrentHashMap<>();

    /**
       If the object's role is in the following array getVirtualAccessibleName
       will use the extended search algorithm.
    */
    private final ArrayList<AccessibleRole> extendedVirtualNameSearchRoles = new ArrayList<>();
    /**
    ...
    */
    ...
    private interface NativeWindowHandler {
        Accessible getAccessibleFromNativeWindowHandle(int nativeHandle);
    }

    // hash table of native window handle to AccessibleContext mappings
    static private final ConcurrentHashMap<Integer,AccessibleContext> windowHandleToContextMap = new ConcurrentHashMap<>();

    // hash table of AccessibleContext to native window handle mappings
    static private final ConcurrentHashMap<AccessibleContext,Integer> contextToWindowHandleMap = new ConcurrentHashMap<>();
    ...
    private static final Vector<NativeWindowHandler> nativeWindowHandlers = new Vector<>();
    ...
    */
            ...
            if ( extendedVirtualNameSearchRoles.contains (role) ) {
                ...
                if ( null != parentContext ) {
                    ...
                    if ( AccessibleRole.UNKNOWN != parentRole ) {
                        bExtendedSearch = !noExtendedVirtualNameSearchParentRoles.contains(parentRole);
                    }
                }
            }
        ...
        return InvocationUtils.invokeAndWait(new Callable<Rectangle>() {
            ...
            public Rectangle call() throws Exception {
                ...
                if (parent instanceof Accessible) {
                    ...
                    if (child instanceof JTextComponent text) {
                        try {
    ...
    private AccessibleContext getAccessibleTableCellAccessibleContext(final AccessibleTable at,
        ...
        return InvocationUtils.invokeAndWait(new Callable<AccessibleContext>() {
            @Override
            public AccessibleContext call() throws Exception {
                if (!(at instanceof AccessibleContext ac)) {
    ...
    private final Map<AccessibleHypertext, AccessibleContext> hyperTextContextMap = new WeakHashMap<>();
    private final Map<AccessibleHyperlink, AccessibleContext> hyperLinkContextMap = new WeakHashMap<>();
    ...
    private KeyStroke getMnemonic(final AccessibleContext ac) {
        ...
        return InvocationUtils.invokeAndWait(new Callable<KeyStroke>() {
            ...
            public KeyStroke call() throws Exception {
                ...
                if (!(comp instanceof AccessibleExtendedComponent aec)) {
                    return null;
                }
                if (aec != null) {
    ...
    */
    ...
    private class ObjectReferences {
        ...
        */
        private final ConcurrentHashMap<Object,Reference> refs;
   ...
   /**
    ...
    private class EventHandler implements PropertyChangeListener,
        ...
        private final AccessBridge accessBridge;
        ...
        *  ------- focus event glue
        */
        private final boolean stateChangeListenerAdded = false;
     ...
     ******************************************************
     */
    private final AccessibleRole [] allAccessibleRoles = {
    /**
