 ...
 * <p>The {@link java.core.java.util.List(Object...) List.of} and
 * {@link java.core.java.util.List List.copyOf} static factory methods
...
public interface List<E> extends Collection<E> {
    ...
    default void sort(Comparator<? super E> c) {
        java.lang.Object[] a = this.toArray();
        Arrays.sort(a, (Comparator) c);
        ListIterator<E> i = this.listIterator();
        for (java.lang.Object e : a) {
            i.next();
            i.set((E) e);
        }
    }
     ...
     * contract of {@link java.lang.Object#hashCode}.
     *
    ...
    static <E> java.util.List<E> of() {
        return (java.util.List<E>) ImmutableCollections.EMPTY_LIST;
    }
    ...
    static <E> java.util.List<E> of(E... elements) {
        switch (elements.length) { // implicit null check of elements
            case 0:
                @SuppressWarnings("unchecked")
                var list = (java.util.List<E>) ImmutableCollections.EMPTY_LIST;
                return list;
            case 1:
