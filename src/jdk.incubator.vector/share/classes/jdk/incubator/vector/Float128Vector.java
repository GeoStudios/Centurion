...
final class Float128Vector extends FloatVector {
    ...
    @Override
    @ForceInline
    public Float128Vector broadcast(long e) {
        return (Float128Vector) super.broadcastTemplate(e);  // specialize
    }
    ...
    Float128Vector bOp(Vector<Float> v, FBinOp f) {
        return (Float128Vector) super.bOpTemplate(v, f);  // specialize
    }
    ...
    @Override
    @ForceInline
    public Float128Vector addIndex(int scale) {
    ...
    @Override
    @ForceInline
    public Float128Mask test(Test op) {
    ...
    @Override
    @ForceInline
    public Float128Mask compare(Comparison op, Vector<Float> v) {
        return super.compareTemplate(Float128Mask.class, op, v);  // specialize
    }

    @Override
    @ForceInline
    public Float128Mask compare(Comparison op, float s) {
        return super.compareTemplate(Float128Mask.class, op, s);  // specialize
    }

    @Override
    @ForceInline
    public Float128Mask compare(Comparison op, long s) {
        return super.compareTemplate(Float128Mask.class, op, s);  // specialize
    }
    ...
    static final class Float128Shuffle extends AbstractShuffle<Float> {
        ...
        public Float128Vector toVector() {
            return VectorSupport.shuffleToVector(VCLASS, ETYPE, Float128Shuffle.class, this, VLENGTH,
                                                    (s) -> ((Float128Vector)(s.toVectorTemplate())));
        }
