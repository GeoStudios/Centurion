...
final class DoubleMaxVector extends DoubleVector {
    ...
    @Override
    @ForceInline
    public DoubleMaxVector broadcast(long e) {
        return (DoubleMaxVector) super.broadcastTemplate(e);  // specialize
    }
    ...
    DoubleMaxVector bOp(Vector<Double> v, FBinOp f) {
        return (DoubleMaxVector) super.bOpTemplate(v, f);  // specialize
    }
    ...
    @Override
    @ForceInline
    public DoubleMaxVector addIndex(int scale) {
    ...
    @Override
    @ForceInline
    public DoubleMaxMask test(Test op) {
    ...
    @Override
    @ForceInline
    public DoubleMaxMask compare(Comparison op, Vector<Double> v) {
        return super.compareTemplate(DoubleMaxMask.class, op, v);  // specialize
    }

    @Override
    @ForceInline
    public DoubleMaxMask compare(Comparison op, double s) {
        return super.compareTemplate(DoubleMaxMask.class, op, s);  // specialize
    }

    @Override
    @ForceInline
    public DoubleMaxMask compare(Comparison op, long s) {
        return super.compareTemplate(DoubleMaxMask.class, op, s);  // specialize
    }
    ...
    static final class DoubleMaxShuffle extends AbstractShuffle<Double> {
        ...
        public DoubleMaxVector toVector() {
            return VectorSupport.shuffleToVector(VCLASS, ETYPE, DoubleMaxShuffle.class, this, VLENGTH,
                                                    (s) -> ((DoubleMaxVector)(s.toVectorTemplate())));
        }
