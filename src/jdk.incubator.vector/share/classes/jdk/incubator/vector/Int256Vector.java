...
final class Int256Vector extends IntVector {
    ...
    @Override
    @ForceInline
    public Int256Vector broadcast(long e) {
        return (Int256Vector) super.broadcastTemplate(e);  // specialize
    }
    ...
    Int256Vector bOp(Vector<Integer> v, FBinOp f) {
        return (Int256Vector) super.bOpTemplate(v, f);  // specialize
    }
    ...
    @Override
    @ForceInline
    public Int256Vector addIndex(int scale) {
    ...
    @Override
    @ForceInline
    public Int256Mask test(Test op) {
    ...
    @Override
    @ForceInline
    public Int256Mask compare(Comparison op, Vector<Integer> v) {
        return super.compareTemplate(Int256Mask.class, op, v);  // specialize
    }

    @Override
    @ForceInline
    public Int256Mask compare(Comparison op, int s) {
        return super.compareTemplate(Int256Mask.class, op, s);  // specialize
    }

    @Override
    @ForceInline
    public Int256Mask compare(Comparison op, long s) {
        return super.compareTemplate(Int256Mask.class, op, s);  // specialize
    }
    ...
    static final class Int256Shuffle extends AbstractShuffle<Integer> {
        ...
        public Int256Vector toVector() {
            return VectorSupport.shuffleToVector(VCLASS, ETYPE, Int256Shuffle.class, this, VLENGTH,
                                                    (s) -> ((Int256Vector)(s.toVectorTemplate())));
        }
