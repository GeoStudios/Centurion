...
public abstract class DoubleVector extends AbstractVector<Double> {
        ...
        if (opKind(op, VO_SPECIAL )) {
            if (op == FIRST_NONZERO) {
                ...
                VectorMask<Long> thisNZ
                    = this.viewAsIntegralLanes().compare(NE, 0);
            ...
            BIN_IMPL.find(op, opc, (opc_) -> {
              switch (opc_) {
                ...
                case VECTOR_OP_MAX: return (v0, v1) ->
                        v0.bOp(v1, (i, a, b) -> Math.max(a, b));
                case VECTOR_OP_MIN: return (v0, v1) ->
                        v0.bOp(v1, (i, a, b) -> Math.min(a, b));
                case VECTOR_OP_ATAN2: return (v0, v1) ->
                        v0.bOp(v1, (i, a, b) -> Math.atan2(a, b));
                case VECTOR_OP_POW: return (v0, v1) ->
                        v0.bOp(v1, (i, a, b) -> Math.pow(a, b));
                case VECTOR_OP_HYPOT: return (v0, v1) ->
                        v0.bOp(v1, (i, a, b) -> Math.hypot(a, b));
                default: return null;
                }}));
    }
    private static final
   ...
   /**
    ...
    M testTemplate(Class<M> maskType, Test op) {
        ...
        if (opKind(op, VO_SPECIAL)) {
            ...
            if (op == IS_DEFAULT) {
                ...
                long infbits = toBits(Double.POSITIVE_INFINITY);
                // now compare:
                if (op == IS_FINITE) {
    ...
    static final class DoubleSpecies extends AbstractSpecies<Double> {
        ...
        @Override
        @ForceInline
        Class<Double> genericElementType() {
            return Double.class;
        }
        ...
        @Override
        @ForceInline
        public Class<? extends DoubleVector> vectorType() {
        ...
        @Override
        @ForceInline
        DoubleVector broadcastBits(long bits) {
            return (DoubleVector)
        ...
        @Override
        @ForceInline
        DoubleVector fromIntValues(int[] values) {
        ...
        @Override
        @ForceInline
        public VectorMask<Double> maskAll(boolean bit) {
            if (vectorType() == DoubleMaxVector.class)
