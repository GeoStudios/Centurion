...
final class Float512Vector extends FloatVector {
    ...
    @Override
    @ForceInline
    public Float512Vector broadcast(long e) {
        return (Float512Vector) super.broadcastTemplate(e);  // specialize
    }
    ...
    Float512Vector bOp(Vector<Float> v, FBinOp f) {
        return (Float512Vector) super.bOpTemplate(v, f);  // specialize
    }
    ...
    @Override
    @ForceInline
    public Float512Vector addIndex(int scale) {
    ...
    @Override
    @ForceInline
    public Float512Mask test(Test op) {
    ...
    @Override
    @ForceInline
    public Float512Mask compare(Comparison op, Vector<Float> v) {
        return super.compareTemplate(Float512Mask.class, op, v);  // specialize
    }

    @Override
    @ForceInline
    public Float512Mask compare(Comparison op, float s) {
        return super.compareTemplate(Float512Mask.class, op, s);  // specialize
    }

    @Override
    @ForceInline
    public Float512Mask compare(Comparison op, long s) {
        return super.compareTemplate(Float512Mask.class, op, s);  // specialize
    }
    ...
    static final class Float512Shuffle extends AbstractShuffle<Float> {
        ...
        public Float512Vector toVector() {
            return VectorSupport.shuffleToVector(VCLASS, ETYPE, Float512Shuffle.class, this, VLENGTH,
                                                    (s) -> ((Float512Vector)(s.toVectorTemplate())));
        }
