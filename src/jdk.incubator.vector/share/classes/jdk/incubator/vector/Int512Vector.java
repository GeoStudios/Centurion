...
final class Int512Vector extends IntVector {
    ...
    @Override
    @ForceInline
    public Int512Vector broadcast(long e) {
        return (Int512Vector) super.broadcastTemplate(e);  // specialize
    }
    ...
    Int512Vector bOp(Vector<Integer> v, FBinOp f) {
        return (Int512Vector) super.bOpTemplate(v, f);  // specialize
    }
    ...
    @Override
    @ForceInline
    public Int512Vector addIndex(int scale) {
    ...
    @Override
    @ForceInline
    public Int512Mask test(Test op) {
    ...
    @Override
    @ForceInline
    public Int512Mask compare(Comparison op, Vector<Integer> v) {
        return super.compareTemplate(Int512Mask.class, op, v);  // specialize
    }

    @Override
    @ForceInline
    public Int512Mask compare(Comparison op, int s) {
        return super.compareTemplate(Int512Mask.class, op, s);  // specialize
    }

    @Override
    @ForceInline
    public Int512Mask compare(Comparison op, long s) {
        return super.compareTemplate(Int512Mask.class, op, s);  // specialize
    }
    ...
    static final class Int512Shuffle extends AbstractShuffle<Integer> {
        ...
        public Int512Vector toVector() {
            return VectorSupport.shuffleToVector(VCLASS, ETYPE, Int512Shuffle.class, this, VLENGTH,
                                                    (s) -> ((Int512Vector)(s.toVectorTemplate())));
        }
