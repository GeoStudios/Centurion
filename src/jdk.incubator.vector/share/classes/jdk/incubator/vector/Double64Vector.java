...
final class Double64Vector extends DoubleVector {
    ...
    @Override
    @ForceInline
    public Double64Vector broadcast(long e) {
        return (Double64Vector) super.broadcastTemplate(e);  // specialize
    }
    ...
    Double64Vector bOp(Vector<Double> v, FBinOp f) {
        return (Double64Vector) super.bOpTemplate(v, f);  // specialize
    }
    ...
    @Override
    @ForceInline
    public Double64Vector addIndex(int scale) {
    ...
    @Override
    @ForceInline
    public Double64Mask test(Test op) {
    ...
    @Override
    @ForceInline
    public Double64Mask compare(Comparison op, Vector<Double> v) {
        return super.compareTemplate(Double64Mask.class, op, v);  // specialize
    }

    @Override
    @ForceInline
    public Double64Mask compare(Comparison op, double s) {
        return super.compareTemplate(Double64Mask.class, op, s);  // specialize
    }

    @Override
    @ForceInline
    public Double64Mask compare(Comparison op, long s) {
        return super.compareTemplate(Double64Mask.class, op, s);  // specialize
    }
    ...
    static final class Double64Shuffle extends AbstractShuffle<Double> {
        ...
        public Double64Vector toVector() {
            return VectorSupport.shuffleToVector(VCLASS, ETYPE, Double64Shuffle.class, this, VLENGTH,
                                                    (s) -> ((Double64Vector)(s.toVectorTemplate())));
        }
