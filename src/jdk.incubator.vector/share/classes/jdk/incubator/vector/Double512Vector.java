...
final class Double512Vector extends DoubleVector {
    ...
    @ForceInline
    @Override
    public Class<Double> elementType() { return double.class; }

    @ForceInline
    @Override
    public int elementSize() { return Double.SIZE; }
    ...
    @Override
    @ForceInline
    public Double512Vector broadcast(long e) {
        return (Double512Vector) super.broadcastTemplate(e);  // specialize
    }
    ...
    Double512Vector bOp(Vector<Double> v, FBinOp f) {
        return (Double512Vector) super.bOpTemplate(v, f);  // specialize
    }
    ...
    @Override
    @ForceInline
    public Double512Vector addIndex(int scale) {
    ...
    @Override
    @ForceInline
    public double reduceLanes(VectorOperators.Associative op) {
    ...
    @Override
    @ForceInline
    public Double512Mask test(Test op) {
    ...
    @Override
    @ForceInline
    public Double512Mask compare(Comparison op, Vector<Double> v) {
        return super.compareTemplate(Double512Mask.class, op, v);  // specialize
    }

    @Override
    @ForceInline
    public Double512Mask compare(Comparison op, double s) {
        return super.compareTemplate(Double512Mask.class, op, s);  // specialize
    }

    @Override
    @ForceInline
    public Double512Mask compare(Comparison op, long s) {
        return super.compareTemplate(Double512Mask.class, op, s);  // specialize
    }
    ...
    public long laneHelper(int i) {
        return VectorSupport.extract(
                     ...
                     return Double.doubleToLongBits(vecarr[ix]);
                     });
    }
    ...
    public Double512Vector withLaneHelper(int i, double e) {
        return VectorSupport.insert(
                                VCLASS, ETYPE, VLENGTH,
                                this, i, Double.doubleToLongBits(e),
                                (v, ix, bits) -> {
                                    double[] res = v.vec().clone();
                                    res[ix] = Double.longBitsToDouble(bits);
    ...
    static final class Double512Shuffle extends AbstractShuffle<Double> {
        ...
        public Double512Vector toVector() {
            return VectorSupport.shuffleToVector(VCLASS, ETYPE, Double512Shuffle.class, this, VLENGTH,
                                                    (s) -> ((Double512Vector)(s.toVectorTemplate())));
        }
