...
final class Float256Vector extends FloatVector {
    ...
    @ForceInline
    @Override
    public Class<Float> elementType() { return float.class; }

    @ForceInline
    @Override
    public int elementSize() { return Float.SIZE; }
    ...
    @Override
    @ForceInline
    public Float256Vector broadcast(long e) {
        return (Float256Vector) super.broadcastTemplate(e);  // specialize
    }
    ...
    Float256Vector bOp(Vector<Float> v, FBinOp f) {
        return (Float256Vector) super.bOpTemplate(v, f);  // specialize
    }
    ...
    @Override
    @ForceInline
    public Float256Vector addIndex(int scale) {
    ...
    @Override
    @ForceInline
    public float reduceLanes(VectorOperators.Associative op) {
    ...
    @Override
    @ForceInline
    public Float256Mask test(Test op) {
    ...
    @Override
    @ForceInline
    public Float256Mask compare(Comparison op, Vector<Float> v) {
        return super.compareTemplate(Float256Mask.class, op, v);  // specialize
    }

    @Override
    @ForceInline
    public Float256Mask compare(Comparison op, float s) {
        return super.compareTemplate(Float256Mask.class, op, s);  // specialize
    }

    @Override
    @ForceInline
    public Float256Mask compare(Comparison op, long s) {
        return super.compareTemplate(Float256Mask.class, op, s);  // specialize
    }
    ...
    public int laneHelper(int i) {
        return (int) VectorSupport.extract(
                     ...
                     return Float.floatToIntBits(vecarr[ix]);
                     });
    }
    ...
    static final class Float256Shuffle extends AbstractShuffle<Float> {
        ...
        public Float256Vector toVector() {
            return VectorSupport.shuffleToVector(VCLASS, ETYPE, Float256Shuffle.class, this, VLENGTH,
                                                    (s) -> ((Float256Vector)(s.toVectorTemplate())));
        }
