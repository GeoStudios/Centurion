...
final class Double128Vector extends DoubleVector {
    ...
    @Override
    @ForceInline
    public Double128Vector broadcast(long e) {
        return (Double128Vector) super.broadcastTemplate(e);  // specialize
    }
    ...
    Double128Vector bOp(Vector<Double> v, FBinOp f) {
        return (Double128Vector) super.bOpTemplate(v, f);  // specialize
    }
    ...
    @Override
    @ForceInline
    public Double128Vector addIndex(int scale) {
    ...
    @Override
    @ForceInline
    public Double128Mask test(Test op) {
    ...
    @Override
    @ForceInline
    public Double128Mask compare(Comparison op, Vector<Double> v) {
        return super.compareTemplate(Double128Mask.class, op, v);  // specialize
    }

    @Override
    @ForceInline
    public Double128Mask compare(Comparison op, double s) {
        return super.compareTemplate(Double128Mask.class, op, s);  // specialize
    }

    @Override
    @ForceInline
    public Double128Mask compare(Comparison op, long s) {
        return super.compareTemplate(Double128Mask.class, op, s);  // specialize
    }
    ...
    static final class Double128Shuffle extends AbstractShuffle<Double> {
        ...
        public Double128Vector toVector() {
            return VectorSupport.shuffleToVector(VCLASS, ETYPE, Double128Shuffle.class, this, VLENGTH,
                                                    (s) -> ((Double128Vector)(s.toVectorTemplate())));
        }
