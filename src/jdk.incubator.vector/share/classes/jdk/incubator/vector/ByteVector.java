...
public abstract class ByteVector extends AbstractVector<Byte> {
   ...
   /**
    ...
    static final class ByteSpecies extends AbstractSpecies<Byte> {
        ...
        @Override
        @ForceInline
        public Class<? extends ByteVector> vectorType() {
        ...
        @Override
        @ForceInline
        ByteVector broadcastBits(long bits) {
            return (ByteVector)
        ...
        @Override
        @ForceInline
        ByteVector fromIntValues(int[] values) {
        ...
        @Override
        @ForceInline
        public VectorMask<Byte> maskAll(boolean bit) {
            if (vectorType() == ByteMaxVector.class)
