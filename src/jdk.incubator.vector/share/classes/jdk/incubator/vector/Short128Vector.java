...
final class Short128Vector extends ShortVector {
    ...
    @ForceInline
    @Override
    public Class<Short> elementType() { return short.class; }

    @ForceInline
    @Override
    public int elementSize() { return Short.SIZE; }
    ...
    @Override
    @ForceInline
    public Short128Vector broadcast(long e) {
        return (Short128Vector) super.broadcastTemplate(e);  // specialize
    }
    ...
    Short128Vector bOp(Vector<Short> v, FBinOp f) {
        return (Short128Vector) super.bOpTemplate(v, f);  // specialize
    }
    ...
    @Override
    @ForceInline
    public Short128Vector addIndex(int scale) {
    ...
    @Override
    @ForceInline
    public short reduceLanes(VectorOperators.Associative op) {
    ...
    @Override
    @ForceInline
    public Short128Mask test(Test op) {
    ...
    @Override
    @ForceInline
    public Short128Mask compare(Comparison op, Vector<Short> v) {
        return super.compareTemplate(Short128Mask.class, op, v);  // specialize
    }

    @Override
    @ForceInline
    public Short128Mask compare(Comparison op, short s) {
        return super.compareTemplate(Short128Mask.class, op, s);  // specialize
    }

    @Override
    @ForceInline
    public Short128Mask compare(Comparison op, long s) {
        return super.compareTemplate(Short128Mask.class, op, s);  // specialize
    }
    ...
    static final class Short128Shuffle extends AbstractShuffle<Short> {
        ...
        public Short128Vector toVector() {
            return VectorSupport.shuffleToVector(VCLASS, ETYPE, Short128Shuffle.class, this, VLENGTH,
                                                    (s) -> ((Short128Vector)(s.toVectorTemplate())));
        }
