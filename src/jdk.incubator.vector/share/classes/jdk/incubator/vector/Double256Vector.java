...
final class Double256Vector extends DoubleVector {
    ...
    @Override
    @ForceInline
    public Double256Vector broadcast(long e) {
        return (Double256Vector) super.broadcastTemplate(e);  // specialize
    }
    ...
    Double256Vector bOp(Vector<Double> v, FBinOp f) {
        return (Double256Vector) super.bOpTemplate(v, f);  // specialize
    }
    ...
    @Override
    @ForceInline
    public Double256Vector addIndex(int scale) {
    ...
    @Override
    @ForceInline
    public Double256Mask test(Test op) {
    ...
    @Override
    @ForceInline
    public Double256Mask compare(Comparison op, Vector<Double> v) {
        return super.compareTemplate(Double256Mask.class, op, v);  // specialize
    }

    @Override
    @ForceInline
    public Double256Mask compare(Comparison op, double s) {
        return super.compareTemplate(Double256Mask.class, op, s);  // specialize
    }

    @Override
    @ForceInline
    public Double256Mask compare(Comparison op, long s) {
        return super.compareTemplate(Double256Mask.class, op, s);  // specialize
    }
    ...
    static final class Double256Shuffle extends AbstractShuffle<Double> {
        ...
        public Double256Vector toVector() {
            return VectorSupport.shuffleToVector(VCLASS, ETYPE, Double256Shuffle.class, this, VLENGTH,
                                                    (s) -> ((Double256Vector)(s.toVectorTemplate())));
        }
