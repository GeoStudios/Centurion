...
final class Short64Vector extends ShortVector {
    ...
    @Override
    @ForceInline
    public Short64Vector broadcast(long e) {
        return (Short64Vector) super.broadcastTemplate(e);  // specialize
    }
    ...
    Short64Vector bOp(Vector<Short> v, FBinOp f) {
        return (Short64Vector) super.bOpTemplate(v, f);  // specialize
    }
    ...
    @Override
    @ForceInline
    public Short64Vector addIndex(int scale) {
    ...
    @Override
    @ForceInline
    public Short64Mask test(Test op) {
    ...
    @Override
    @ForceInline
    public Short64Mask compare(Comparison op, Vector<Short> v) {
        return super.compareTemplate(Short64Mask.class, op, v);  // specialize
    }

    @Override
    @ForceInline
    public Short64Mask compare(Comparison op, short s) {
        return super.compareTemplate(Short64Mask.class, op, s);  // specialize
    }

    @Override
    @ForceInline
    public Short64Mask compare(Comparison op, long s) {
        return super.compareTemplate(Short64Mask.class, op, s);  // specialize
    }
    ...
    static final class Short64Shuffle extends AbstractShuffle<Short> {
        ...
        public Short64Vector toVector() {
            return VectorSupport.shuffleToVector(VCLASS, ETYPE, Short64Shuffle.class, this, VLENGTH,
                                                    (s) -> ((Short64Vector)(s.toVectorTemplate())));
        }
