...
final class LongMaxVector extends LongVector {
    ...
    LongMaxVector bOp(Vector<Long> v, FBinOp f) {
        return (LongMaxVector) super.bOpTemplate(v, f);  // specialize
    }
    ...
    @Override
    @ForceInline
    public LongMaxVector addIndex(int scale) {
    ...
    @Override
    @ForceInline
    public LongMaxMask test(Test op) {
    ...
    @Override
    @ForceInline
    public LongMaxMask compare(Comparison op, Vector<Long> v) {
        return super.compareTemplate(LongMaxMask.class, op, v);  // specialize
    }

    @Override
    @ForceInline
    public LongMaxMask compare(Comparison op, long s) {
    ...
    static final class LongMaxShuffle extends AbstractShuffle<Long> {
        ...
        public LongMaxVector toVector() {
            return VectorSupport.shuffleToVector(VCLASS, ETYPE, LongMaxShuffle.class, this, VLENGTH,
                                                    (s) -> ((LongMaxVector)(s.toVectorTemplate())));
        }
