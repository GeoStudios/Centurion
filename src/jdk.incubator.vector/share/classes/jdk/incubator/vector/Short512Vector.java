...
final class Short512Vector extends ShortVector {
    ...
    @Override
    @ForceInline
    public Short512Vector broadcast(long e) {
        return (Short512Vector) super.broadcastTemplate(e);  // specialize
    }
    ...
    Short512Vector bOp(Vector<Short> v, FBinOp f) {
        return (Short512Vector) super.bOpTemplate(v, f);  // specialize
    }
    ...
    @Override
    @ForceInline
    public Short512Vector addIndex(int scale) {
    ...
    @Override
    @ForceInline
    public Short512Mask test(Test op) {
    ...
    @Override
    @ForceInline
    public Short512Mask compare(Comparison op, Vector<Short> v) {
        return super.compareTemplate(Short512Mask.class, op, v);  // specialize
    }

    @Override
    @ForceInline
    public Short512Mask compare(Comparison op, short s) {
        return super.compareTemplate(Short512Mask.class, op, s);  // specialize
    }

    @Override
    @ForceInline
    public Short512Mask compare(Comparison op, long s) {
        return super.compareTemplate(Short512Mask.class, op, s);  // specialize
    }
    ...
    static final class Short512Shuffle extends AbstractShuffle<Short> {
        ...
        public Short512Vector toVector() {
            return VectorSupport.shuffleToVector(VCLASS, ETYPE, Short512Shuffle.class, this, VLENGTH,
                                                    (s) -> ((Short512Vector)(s.toVectorTemplate())));
        }
