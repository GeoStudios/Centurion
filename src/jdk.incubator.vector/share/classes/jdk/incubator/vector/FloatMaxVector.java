...
final class FloatMaxVector extends FloatVector {
    ...
    @Override
    @ForceInline
    public FloatMaxVector broadcast(long e) {
        return (FloatMaxVector) super.broadcastTemplate(e);  // specialize
    }
    ...
    FloatMaxVector bOp(Vector<Float> v, FBinOp f) {
        return (FloatMaxVector) super.bOpTemplate(v, f);  // specialize
    }
    ...
    @Override
    @ForceInline
    public FloatMaxVector addIndex(int scale) {
    ...
    @Override
    @ForceInline
    public FloatMaxMask test(Test op) {
    ...
    @Override
    @ForceInline
    public FloatMaxMask compare(Comparison op, Vector<Float> v) {
        return super.compareTemplate(FloatMaxMask.class, op, v);  // specialize
    }

    @Override
    @ForceInline
    public FloatMaxMask compare(Comparison op, float s) {
        return super.compareTemplate(FloatMaxMask.class, op, s);  // specialize
    }

    @Override
    @ForceInline
    public FloatMaxMask compare(Comparison op, long s) {
        return super.compareTemplate(FloatMaxMask.class, op, s);  // specialize
    }
    ...
    static final class FloatMaxShuffle extends AbstractShuffle<Float> {
        ...
        public FloatMaxVector toVector() {
            return VectorSupport.shuffleToVector(VCLASS, ETYPE, FloatMaxShuffle.class, this, VLENGTH,
                                                    (s) -> ((FloatMaxVector)(s.toVectorTemplate())));
        }
