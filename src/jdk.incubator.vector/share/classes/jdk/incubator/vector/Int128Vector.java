...
final class Int128Vector extends IntVector {
    ...
    @Override
    @ForceInline
    public Int128Vector broadcast(long e) {
        return (Int128Vector) super.broadcastTemplate(e);  // specialize
    }
    ...
    Int128Vector bOp(Vector<Integer> v, FBinOp f) {
        return (Int128Vector) super.bOpTemplate(v, f);  // specialize
    }
    ...
    @Override
    @ForceInline
    public Int128Vector addIndex(int scale) {
    ...
    @Override
    @ForceInline
    public Int128Mask test(Test op) {
    ...
    @Override
    @ForceInline
    public Int128Mask compare(Comparison op, Vector<Integer> v) {
        return super.compareTemplate(Int128Mask.class, op, v);  // specialize
    }

    @Override
    @ForceInline
    public Int128Mask compare(Comparison op, int s) {
        return super.compareTemplate(Int128Mask.class, op, s);  // specialize
    }

    @Override
    @ForceInline
    public Int128Mask compare(Comparison op, long s) {
        return super.compareTemplate(Int128Mask.class, op, s);  // specialize
    }
    ...
    static final class Int128Shuffle extends AbstractShuffle<Integer> {
        ...
        public Int128Vector toVector() {
            return VectorSupport.shuffleToVector(VCLASS, ETYPE, Int128Shuffle.class, this, VLENGTH,
                                                    (s) -> ((Int128Vector)(s.toVectorTemplate())));
        }
