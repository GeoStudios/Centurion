...
final class Byte256Vector extends ByteVector {
    ...
    @Override
    @ForceInline
    public Byte256Vector broadcast(long e) {
        return (Byte256Vector) super.broadcastTemplate(e);  // specialize
    }
    ...
    Byte256Vector bOp(Vector<Byte> v, FBinOp f) {
        return (Byte256Vector) super.bOpTemplate(v, f);  // specialize
    }
    ...
    @Override
    @ForceInline
    public Byte256Vector addIndex(int scale) {
    ...
    @Override
    @ForceInline
    public Byte256Mask test(Test op) {
    ...
    @Override
    @ForceInline
    public Byte256Mask compare(Comparison op, Vector<Byte> v) {
        return super.compareTemplate(Byte256Mask.class, op, v);  // specialize
    }

    @Override
    @ForceInline
    public Byte256Mask compare(Comparison op, byte s) {
        return super.compareTemplate(Byte256Mask.class, op, s);  // specialize
    }

    @Override
    @ForceInline
    public Byte256Mask compare(Comparison op, long s) {
        return super.compareTemplate(Byte256Mask.class, op, s);  // specialize
    }
    ...
    static final class Byte256Shuffle extends AbstractShuffle<Byte> {
        ...
        public Byte256Vector toVector() {
            return VectorSupport.shuffleToVector(VCLASS, ETYPE, Byte256Shuffle.class, this, VLENGTH,
                                                    (s) -> ((Byte256Vector)(s.toVectorTemplate())));
        }
