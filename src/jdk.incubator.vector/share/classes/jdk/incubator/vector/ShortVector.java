...
public abstract class ShortVector extends AbstractVector<Short> {
   ...
   /**
    ...
    static final class ShortSpecies extends AbstractSpecies<Short> {
        ...
        @Override
        @ForceInline
        Class<Short> genericElementType() {
            return Short.class;
        }
        ...
        @Override
        @ForceInline
        public Class<? extends ShortVector> vectorType() {
        ...
        @Override
        @ForceInline
        ShortVector broadcastBits(long bits) {
            return (ShortVector)
        ...
        @Override
        @ForceInline
        ShortVector fromIntValues(int[] values) {
        ...
        @Override
        @ForceInline
        public VectorMask<Short> maskAll(boolean bit) {
            if (vectorType() == ShortMaxVector.class)
    ...
    public static final VectorSpecies<Short> SPECIES_PREFERRED
        = VectorSpecies.ofPreferred(short.class);
}
