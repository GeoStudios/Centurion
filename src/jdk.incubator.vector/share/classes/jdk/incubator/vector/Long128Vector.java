...
final class Long128Vector extends LongVector {
    ...
    Long128Vector bOp(Vector<Long> v, FBinOp f) {
        return (Long128Vector) super.bOpTemplate(v, f);  // specialize
    }
    ...
    @Override
    @ForceInline
    public Long128Vector addIndex(int scale) {
    ...
    @Override
    @ForceInline
    public Long128Mask test(Test op) {
    ...
    @Override
    @ForceInline
    public Long128Mask compare(Comparison op, Vector<Long> v) {
        return super.compareTemplate(Long128Mask.class, op, v);  // specialize
    }

    @Override
    @ForceInline
    public Long128Mask compare(Comparison op, long s) {
    ...
    static final class Long128Shuffle extends AbstractShuffle<Long> {
        ...
        public Long128Vector toVector() {
            return VectorSupport.shuffleToVector(VCLASS, ETYPE, Long128Shuffle.class, this, VLENGTH,
                                                    (s) -> ((Long128Vector)(s.toVectorTemplate())));
        }
