...
final class Byte128Vector extends ByteVector {
    ...
    @Override
    @ForceInline
    public Byte128Vector broadcast(long e) {
        return (Byte128Vector) super.broadcastTemplate(e);  // specialize
    }
    ...
    Byte128Vector bOp(Vector<Byte> v, FBinOp f) {
        return (Byte128Vector) super.bOpTemplate(v, f);  // specialize
    }
    ...
    @Override
    @ForceInline
    public Byte128Vector addIndex(int scale) {
    ...
    @Override
    @ForceInline
    public Byte128Mask test(Test op) {
    ...
    @Override
    @ForceInline
    public Byte128Mask compare(Comparison op, Vector<Byte> v) {
        return super.compareTemplate(Byte128Mask.class, op, v);  // specialize
    }

    @Override
    @ForceInline
    public Byte128Mask compare(Comparison op, byte s) {
        return super.compareTemplate(Byte128Mask.class, op, s);  // specialize
    }

    @Override
    @ForceInline
    public Byte128Mask compare(Comparison op, long s) {
        return super.compareTemplate(Byte128Mask.class, op, s);  // specialize
    }
    ...
    static final class Byte128Shuffle extends AbstractShuffle<Byte> {
        ...
        public Byte128Vector toVector() {
            return VectorSupport.shuffleToVector(VCLASS, ETYPE, Byte128Shuffle.class, this, VLENGTH,
                                                    (s) -> ((Byte128Vector)(s.toVectorTemplate())));
        }
