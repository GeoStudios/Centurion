...
final class Float64Vector extends FloatVector {
    ...
    @Override
    @ForceInline
    public Float64Vector broadcast(long e) {
        return (Float64Vector) super.broadcastTemplate(e);  // specialize
    }
    ...
    Float64Vector bOp(Vector<Float> v, FBinOp f) {
        return (Float64Vector) super.bOpTemplate(v, f);  // specialize
    }
    ...
    @Override
    @ForceInline
    public Float64Vector addIndex(int scale) {
    ...
    @Override
    @ForceInline
    public Float64Mask test(Test op) {
    ...
    @Override
    @ForceInline
    public Float64Mask compare(Comparison op, Vector<Float> v) {
        return super.compareTemplate(Float64Mask.class, op, v);  // specialize
    }

    @Override
    @ForceInline
    public Float64Mask compare(Comparison op, float s) {
        return super.compareTemplate(Float64Mask.class, op, s);  // specialize
    }

    @Override
    @ForceInline
    public Float64Mask compare(Comparison op, long s) {
        return super.compareTemplate(Float64Mask.class, op, s);  // specialize
    }
    ...
    static final class Float64Shuffle extends AbstractShuffle<Float> {
        ...
        public Float64Vector toVector() {
            return VectorSupport.shuffleToVector(VCLASS, ETYPE, Float64Shuffle.class, this, VLENGTH,
                                                    (s) -> ((Float64Vector)(s.toVectorTemplate())));
        }
