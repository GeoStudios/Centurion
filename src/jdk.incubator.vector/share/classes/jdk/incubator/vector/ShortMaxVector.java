...
final class ShortMaxVector extends ShortVector {
    ...
    @Override
    @ForceInline
    public ShortMaxVector broadcast(long e) {
        return (ShortMaxVector) super.broadcastTemplate(e);  // specialize
    }
    ...
    ShortMaxVector bOp(Vector<Short> v, FBinOp f) {
        return (ShortMaxVector) super.bOpTemplate(v, f);  // specialize
    }
    ...
    @Override
    @ForceInline
    public ShortMaxVector addIndex(int scale) {
    ...
    @Override
    @ForceInline
    public ShortMaxMask test(Test op) {
    ...
    @Override
    @ForceInline
    public ShortMaxMask compare(Comparison op, Vector<Short> v) {
        return super.compareTemplate(ShortMaxMask.class, op, v);  // specialize
    }

    @Override
    @ForceInline
    public ShortMaxMask compare(Comparison op, short s) {
        return super.compareTemplate(ShortMaxMask.class, op, s);  // specialize
    }

    @Override
    @ForceInline
    public ShortMaxMask compare(Comparison op, long s) {
        return super.compareTemplate(ShortMaxMask.class, op, s);  // specialize
    }
    ...
    static final class ShortMaxShuffle extends AbstractShuffle<Short> {
        ...
        public ShortMaxVector toVector() {
            return VectorSupport.shuffleToVector(VCLASS, ETYPE, ShortMaxShuffle.class, this, VLENGTH,
                                                    (s) -> ((ShortMaxVector)(s.toVectorTemplate())));
        }
