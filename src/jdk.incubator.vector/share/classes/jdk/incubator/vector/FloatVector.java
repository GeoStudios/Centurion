...
public abstract class FloatVector extends AbstractVector<Float> {
   ...
   /**
        ...
        return fromBits(VectorSupport.reductionCoerced(
            ...
            REDUCE_IMPL.find(op, opc, (opc_) -> {
              ...
              case VECTOR_OP_ADD: return v ->
                      toBits(v.rOp((float)0, (i, a, b) -> a + b));
              case VECTOR_OP_MUL: return v ->
                      toBits(v.rOp((float)1, (i, a, b) -> a * b));
    ...
    static final class FloatSpecies extends AbstractSpecies<Float> {
        ...
        @Override
        @ForceInline
        Class<Float> genericElementType() {
            return Float.class;
        }
        ...
        @Override
        @ForceInline
        public Class<? extends FloatVector> vectorType() {
        ...
        @Override
        @ForceInline
        FloatVector broadcastBits(long bits) {
            return (FloatVector)
        ...
        @Override
        @ForceInline
        FloatVector fromIntValues(int[] values) {
        ...
        @Override
        @ForceInline
        public VectorMask<Float> maskAll(boolean bit) {
            if (vectorType() == FloatMaxVector.class)
    ...
    public static final VectorSpecies<Float> SPECIES_PREFERRED
        = VectorSpecies.ofPreferred(float.class);
}
