...
final class Long256Vector extends LongVector {
    ...
    Long256Vector bOp(Vector<Long> v, FBinOp f) {
        return (Long256Vector) super.bOpTemplate(v, f);  // specialize
    }
    ...
    @Override
    @ForceInline
    public Long256Vector addIndex(int scale) {
    ...
    @Override
    @ForceInline
    public Long256Mask test(Test op) {
    ...
    @Override
    @ForceInline
    public Long256Mask compare(Comparison op, Vector<Long> v) {
        return super.compareTemplate(Long256Mask.class, op, v);  // specialize
    }

    @Override
    @ForceInline
    public Long256Mask compare(Comparison op, long s) {
    ...
    static final class Long256Shuffle extends AbstractShuffle<Long> {
        ...
        public Long256Vector toVector() {
            return VectorSupport.shuffleToVector(VCLASS, ETYPE, Long256Shuffle.class, this, VLENGTH,
                                                    (s) -> ((Long256Vector)(s.toVectorTemplate())));
        }
