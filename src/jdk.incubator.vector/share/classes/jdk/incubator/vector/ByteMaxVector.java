...
final class ByteMaxVector extends ByteVector {
    ...
    @ForceInline
    @Override
    public Class<Byte> elementType() { return byte.class; }

    @ForceInline
    @Override
    public int elementSize() { return Byte.SIZE; }
    ...
    @Override
    @ForceInline
    public ByteMaxVector broadcast(long e) {
        return (ByteMaxVector) super.broadcastTemplate(e);  // specialize
    }
    ...
    ByteMaxVector bOp(Vector<Byte> v, FBinOp f) {
        return (ByteMaxVector) super.bOpTemplate(v, f);  // specialize
    }
    ...
    @Override
    @ForceInline
    public ByteMaxVector addIndex(int scale) {
    ...
    @Override
    @ForceInline
    public byte reduceLanes(VectorOperators.Associative op) {
    ...
    @Override
    @ForceInline
    public ByteMaxMask test(Test op) {
    ...
    @Override
    @ForceInline
    public ByteMaxMask compare(Comparison op, Vector<Byte> v) {
        return super.compareTemplate(ByteMaxMask.class, op, v);  // specialize
    }

    @Override
    @ForceInline
    public ByteMaxMask compare(Comparison op, byte s) {
        return super.compareTemplate(ByteMaxMask.class, op, s);  // specialize
    }

    @Override
    @ForceInline
    public ByteMaxMask compare(Comparison op, long s) {
        return super.compareTemplate(ByteMaxMask.class, op, s);  // specialize
    }
    ...
    static final class ByteMaxShuffle extends AbstractShuffle<Byte> {
        ...
        public ByteMaxVector toVector() {
            return VectorSupport.shuffleToVector(VCLASS, ETYPE, ByteMaxShuffle.class, this, VLENGTH,
                                                    (s) -> ((ByteMaxVector)(s.toVectorTemplate())));
        }
