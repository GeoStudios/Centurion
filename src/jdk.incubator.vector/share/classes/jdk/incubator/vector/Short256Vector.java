...
final class Short256Vector extends ShortVector {
    ...
    @Override
    @ForceInline
    public Short256Vector broadcast(long e) {
        return (Short256Vector) super.broadcastTemplate(e);  // specialize
    }
    ...
    Short256Vector bOp(Vector<Short> v, FBinOp f) {
        return (Short256Vector) super.bOpTemplate(v, f);  // specialize
    }
    ...
    @Override
    @ForceInline
    public Short256Vector addIndex(int scale) {
    ...
    @Override
    @ForceInline
    public Short256Mask test(Test op) {
    ...
    @Override
    @ForceInline
    public Short256Mask compare(Comparison op, Vector<Short> v) {
        return super.compareTemplate(Short256Mask.class, op, v);  // specialize
    }

    @Override
    @ForceInline
    public Short256Mask compare(Comparison op, short s) {
        return super.compareTemplate(Short256Mask.class, op, s);  // specialize
    }

    @Override
    @ForceInline
    public Short256Mask compare(Comparison op, long s) {
        return super.compareTemplate(Short256Mask.class, op, s);  // specialize
    }
    ...
    static final class Short256Shuffle extends AbstractShuffle<Short> {
        ...
        public Short256Vector toVector() {
            return VectorSupport.shuffleToVector(VCLASS, ETYPE, Short256Shuffle.class, this, VLENGTH,
                                                    (s) -> ((Short256Vector)(s.toVectorTemplate())));
        }
