...
public abstract class LongVector extends AbstractVector<Long> {
   ...
   /**
    ...
    LongVector sliceTemplate(int origin, Vector<Long> v1) {
        ...
        VectorMask<Long> blendMask = iota.toVector().compare(VectorOperators.LT, (broadcast(length() - origin)));
        ...
        return fromBits(VectorSupport.reductionCoerced(
            ...
            REDUCE_IMPL.find(op, opc, (opc_) -> {
              ...
              case VECTOR_OP_MUL: return v ->
                      toBits(v.rOp((long)1, (i, a, b) -> (long)((long) a * b)));
    ...
    static final class LongSpecies extends AbstractSpecies<Long> {
        ...
        @Override
        @ForceInline
        public Class<? extends LongVector> vectorType() {
        ...
        @Override
        @ForceInline
        LongVector broadcastBits(long bits) {
            return (LongVector)
        ...
        static long toIntegralChecked(long e, boolean convertToInt) {
            long value = convertToInt ? (int) e : e;
            if (value != e) {
        ...
        @Override
        @ForceInline
        LongVector fromIntValues(int[] values) {
        ...
        @Override
        @ForceInline
        public VectorMask<Long> maskAll(boolean bit) {
            if (vectorType() == LongMaxVector.class)
