...
final class Long512Vector extends LongVector {
    ...
    Long512Vector bOp(Vector<Long> v, FBinOp f) {
        return (Long512Vector) super.bOpTemplate(v, f);  // specialize
    }
    ...
    @Override
    @ForceInline
    public Long512Vector addIndex(int scale) {
    ...
    @Override
    @ForceInline
    public Long512Mask test(Test op) {
    ...
    @Override
    @ForceInline
    public Long512Mask compare(Comparison op, Vector<Long> v) {
        return super.compareTemplate(Long512Mask.class, op, v);  // specialize
    }

    @Override
    @ForceInline
    public Long512Mask compare(Comparison op, long s) {
    ...
    static final class Long512Shuffle extends AbstractShuffle<Long> {
        ...
        public Long512Vector toVector() {
            return VectorSupport.shuffleToVector(VCLASS, ETYPE, Long512Shuffle.class, this, VLENGTH,
                                                    (s) -> ((Long512Vector)(s.toVectorTemplate())));
        }
