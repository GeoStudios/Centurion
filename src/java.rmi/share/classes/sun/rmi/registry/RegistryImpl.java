        ...
        implements Registry
{
    ...
    private final Hashtable<String, Remote> bindings
        = new Hashtable<>(101);
    private static final Hashtable<InetAddress, InetAddress> allowedAccessCache
        = new Hashtable<>(3);
    private static RegistryImpl registry;
    private static final ObjID id = new ObjID(ObjID.REGISTRY_ID);
