...
final class DGCClient {
    ...
    private static class EndpointEntry {
        ...
        private final DGC dgc;

        /** table of refs held for endpoint: maps LiveRef to RefEntry */
        private final Map<LiveRef, RefEntry> refTable = new HashMap<>(5);
        ...
        private final ReferenceQueue<LiveRef> refQueue = new ReferenceQueue<>();
        /** set of clean calls that need to be made */
        private final Set<CleanRequest> pendingCleans = new HashSet<>(5);

        /** global endpoint table: maps Endpoint to EndpointEntry */
        private static final Map<Endpoint,EndpointEntry> endpointTable = new HashMap<>(5);
        ...
        private class RefEntry {
            ...
            private final LiveRef ref;
            /** set of phantom references to registered instances */
            private final Set<PhantomLiveRef> refSet = new HashSet<>(5);
